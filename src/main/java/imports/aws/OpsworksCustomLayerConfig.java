...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.736Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.OpsworksCustomLayerConfig")
...
public interface OpsworksCustomLayerConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     * ebs_volume block.
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.OpsworksCustomLayerEbsVolume> getEbsVolume() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<OpsworksCustomLayerConfig> {
        ...
        private java.util.List<imports.aws.OpsworksCustomLayerEbsVolume> ebsVolume;
         ...
         * @param shortName the value to be set. This parameter is required.
         * @return {@code this}
         */
        ...
        public Builder ebsVolume(java.util.List<? extends imports.aws.OpsworksCustomLayerEbsVolume> ebsVolume) {
            this.ebsVolume = (java.util.List<imports.aws.OpsworksCustomLayerEbsVolume>)ebsVolume;
            return this;
        }
        ...
        public OpsworksCustomLayerConfig build() {
            return new Jsii$Proxy(name, shortName, stackId, autoAssignElasticIps, autoAssignPublicIps, autoHealing, customConfigureRecipes, customDeployRecipes, customInstanceProfileArn, customJson, customSecurityGroupIds, customSetupRecipes, customShutdownRecipes, customUndeployRecipes, drainElbOnShutdown, ebsVolume, elasticLoadBalancer, installUpdatesOnBoot, instanceShutdownTimeout, systemPackages, tags, useEbsOptimizedInstances, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements OpsworksCustomLayerConfig {
        ...
        private final java.util.List<imports.aws.OpsworksCustomLayerEbsVolume> ebsVolume;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.ebsVolume = software.amazon.jsii.Kernel.get(this, "ebsVolume", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.OpsworksCustomLayerEbsVolume.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String name, final java.lang.String shortName, final java.lang.String stackId, final java.lang.Boolean autoAssignElasticIps, final java.lang.Boolean autoAssignPublicIps, final java.lang.Boolean autoHealing, final java.util.List<java.lang.String> customConfigureRecipes, final java.util.List<java.lang.String> customDeployRecipes, final java.lang.String customInstanceProfileArn, final java.lang.String customJson, final java.util.List<java.lang.String> customSecurityGroupIds, final java.util.List<java.lang.String> customSetupRecipes, final java.util.List<java.lang.String> customShutdownRecipes, final java.util.List<java.lang.String> customUndeployRecipes, final java.lang.Boolean drainElbOnShutdown, final java.util.List<? extends imports.aws.OpsworksCustomLayerEbsVolume> ebsVolume, final java.lang.String elasticLoadBalancer, final java.lang.Boolean installUpdatesOnBoot, final java.lang.Number instanceShutdownTimeout, final java.util.List<java.lang.String> systemPackages, final java.util.Map<java.lang.String, java.lang.String> tags, final java.lang.Boolean useEbsOptimizedInstances, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.name = java.util.Objects.requireNonNull(name, "name is required");
            this.shortName = java.util.Objects.requireNonNull(shortName, "shortName is required");
        ...
        @Override
        public final java.util.List<imports.aws.OpsworksCustomLayerEbsVolume> getEbsVolume() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.OpsworksCustomLayerConfig"));
