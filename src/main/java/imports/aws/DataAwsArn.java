...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.232Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsArn")
public class DataAwsArn extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    public DataAwsArn(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DataAwsArnConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DataAwsArn}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DataAwsArn> {
        /**
        ...
        private final imports.aws.DataAwsArnConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DataAwsArnConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DataAwsArn}.
         */
        @Override
        public imports.aws.DataAwsArn build() {
            return new imports.aws.DataAwsArn(
                this.scope,
                this.id,
                this.config.build()
            );
