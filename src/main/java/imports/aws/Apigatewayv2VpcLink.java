...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.Apigatewayv2VpcLink")
public class Apigatewayv2VpcLink extends com.hashicorp.cdktf.TerraformResource {
    ...
    public Apigatewayv2VpcLink(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.Apigatewayv2VpcLinkConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.Apigatewayv2VpcLink}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.Apigatewayv2VpcLink> {
        /**
        ...
        private final imports.aws.Apigatewayv2VpcLinkConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.Apigatewayv2VpcLinkConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.Apigatewayv2VpcLink}.
         */
        @Override
        public imports.aws.Apigatewayv2VpcLink build() {
            return new imports.aws.Apigatewayv2VpcLink(
                this.scope,
                this.id,
                this.config.build()
            );
