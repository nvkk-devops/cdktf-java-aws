...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.VpnGatewayAttachment")
public class VpnGatewayAttachment extends com.hashicorp.cdktf.TerraformResource {
    ...
    public VpnGatewayAttachment(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.VpnGatewayAttachmentConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.VpnGatewayAttachment}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.VpnGatewayAttachment> {
        /**
        ...
        private final imports.aws.VpnGatewayAttachmentConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.VpnGatewayAttachmentConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.VpnGatewayAttachment}.
         */
        @Override
        public imports.aws.VpnGatewayAttachment build() {
            return new imports.aws.VpnGatewayAttachment(
                this.scope,
                this.id,
                this.config.build()
            );
