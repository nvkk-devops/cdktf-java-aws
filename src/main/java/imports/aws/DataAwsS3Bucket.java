...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsS3Bucket")
public class DataAwsS3Bucket extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    public DataAwsS3Bucket(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DataAwsS3BucketConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DataAwsS3Bucket}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DataAwsS3Bucket> {
        /**
        ...
        private final imports.aws.DataAwsS3BucketConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DataAwsS3BucketConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DataAwsS3Bucket}.
         */
        @Override
        public imports.aws.DataAwsS3Bucket build() {
            return new imports.aws.DataAwsS3Bucket(
                this.scope,
                this.id,
                this.config.build()
            );
