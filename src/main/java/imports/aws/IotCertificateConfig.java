...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.636Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.IotCertificateConfig")
...
public interface IotCertificateConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
    ...
    @org.jetbrains.annotations.NotNull java.lang.Boolean getActive();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<IotCertificateConfig> {
         ...
         * @param active the value to be set. This parameter is required.
         * @return {@code this}
         */
        ...
        public IotCertificateConfig build() {
            return new Jsii$Proxy(active, csr, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements IotCertificateConfig {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.active = software.amazon.jsii.Kernel.get(this, "active", software.amazon.jsii.NativeType.forClass(java.lang.Boolean.class));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.Boolean active, final java.lang.String csr, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.IotCertificateConfig"));
