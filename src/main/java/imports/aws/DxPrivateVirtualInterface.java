...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DxPrivateVirtualInterface")
public class DxPrivateVirtualInterface extends com.hashicorp.cdktf.TerraformResource {
    ...
    public DxPrivateVirtualInterface(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DxPrivateVirtualInterfaceConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.DxPrivateVirtualInterfaceTimeouts getTimeoutsInput() {
        return software.amazon.jsii.Kernel.get(this, "timeoutsInput", software.amazon.jsii.NativeType.forClass(imports.aws.DxPrivateVirtualInterfaceTimeouts.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.DxPrivateVirtualInterfaceTimeouts getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.DxPrivateVirtualInterfaceTimeouts.class));
    }

    public void setTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.DxPrivateVirtualInterfaceTimeouts value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DxPrivateVirtualInterface}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DxPrivateVirtualInterface> {
        /**
        ...
        private final imports.aws.DxPrivateVirtualInterfaceConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DxPrivateVirtualInterfaceConfig.Builder();
        }
         ...
         */
        public Builder timeouts(final imports.aws.DxPrivateVirtualInterfaceTimeouts timeouts) {
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DxPrivateVirtualInterface}.
         */
        @Override
        public imports.aws.DxPrivateVirtualInterface build() {
            return new imports.aws.DxPrivateVirtualInterface(
                this.scope,
                this.id,
                this.config.build()
            );
