...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.IamRolePolicy")
public class IamRolePolicy extends com.hashicorp.cdktf.TerraformResource {
    ...
    public IamRolePolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.IamRolePolicyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.IamRolePolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.IamRolePolicy> {
        /**
        ...
        private final imports.aws.IamRolePolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.IamRolePolicyConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.IamRolePolicy}.
         */
        @Override
        public imports.aws.IamRolePolicy build() {
            return new imports.aws.IamRolePolicy(
                this.scope,
                this.id,
                this.config.build()
            );
