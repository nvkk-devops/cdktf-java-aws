...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.S3BucketNotificationTopic")
...
public interface S3BucketNotificationTopic extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<S3BucketNotificationTopic> {
        ...
        public S3BucketNotificationTopic build() {
            return new Jsii$Proxy(events, topicArn, filterPrefix, filterSuffix, id);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements S3BucketNotificationTopic {
         ...
         */
        protected Jsii$Proxy(final java.util.List<java.lang.String> events, final java.lang.String topicArn, final java.lang.String filterPrefix, final java.lang.String filterSuffix, final java.lang.String id) {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.S3BucketNotificationTopic"));
