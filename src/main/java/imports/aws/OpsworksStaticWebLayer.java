...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.OpsworksStaticWebLayer")
public class OpsworksStaticWebLayer extends com.hashicorp.cdktf.TerraformResource {
    ...
    public OpsworksStaticWebLayer(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.OpsworksStaticWebLayerConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.OpsworksStaticWebLayerEbsVolume> getEbsVolumeInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.OpsworksStaticWebLayerEbsVolume>)(software.amazon.jsii.Kernel.get(this, "ebsVolumeInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.OpsworksStaticWebLayerEbsVolume.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.OpsworksStaticWebLayerEbsVolume> getEbsVolume() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "ebsVolume", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.OpsworksStaticWebLayerEbsVolume.class))));
    }

    public void setEbsVolume(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.OpsworksStaticWebLayerEbsVolume> value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.OpsworksStaticWebLayer}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.OpsworksStaticWebLayer> {
        /**
        ...
        private final imports.aws.OpsworksStaticWebLayerConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.OpsworksStaticWebLayerConfig.Builder();
        }
         ...
         */
        public Builder ebsVolume(final java.util.List<? extends imports.aws.OpsworksStaticWebLayerEbsVolume> ebsVolume) {
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.OpsworksStaticWebLayer}.
         */
        @Override
        public imports.aws.OpsworksStaticWebLayer build() {
            return new imports.aws.OpsworksStaticWebLayer(
                this.scope,
                this.id,
                this.config.build()
            );
