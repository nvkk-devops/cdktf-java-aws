...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.MqBrokerInstances")
public class MqBrokerInstances extends com.hashicorp.cdktf.ComplexComputedList {

    protected MqBrokerInstances(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected MqBrokerInstances(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public MqBrokerInstances(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
