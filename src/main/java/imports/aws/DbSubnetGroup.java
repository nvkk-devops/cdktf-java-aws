...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DbSubnetGroup")
public class DbSubnetGroup extends com.hashicorp.cdktf.TerraformResource {
    ...
    public DbSubnetGroup(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DbSubnetGroupConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DbSubnetGroup}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DbSubnetGroup> {
        /**
        ...
        private final imports.aws.DbSubnetGroupConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DbSubnetGroupConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DbSubnetGroup}.
         */
        @Override
        public imports.aws.DbSubnetGroup build() {
            return new imports.aws.DbSubnetGroup(
                this.scope,
                this.id,
                this.config.build()
            );
