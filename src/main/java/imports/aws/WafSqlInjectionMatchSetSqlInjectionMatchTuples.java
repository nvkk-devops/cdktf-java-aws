...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.WafSqlInjectionMatchSetSqlInjectionMatchTuples")
...
public interface WafSqlInjectionMatchSetSqlInjectionMatchTuples extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull java.util.List<imports.aws.WafSqlInjectionMatchSetSqlInjectionMatchTuplesFieldToMatch> getFieldToMatch();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<WafSqlInjectionMatchSetSqlInjectionMatchTuples> {
        private java.util.List<imports.aws.WafSqlInjectionMatchSetSqlInjectionMatchTuplesFieldToMatch> fieldToMatch;
        ...
        public Builder fieldToMatch(java.util.List<? extends imports.aws.WafSqlInjectionMatchSetSqlInjectionMatchTuplesFieldToMatch> fieldToMatch) {
            this.fieldToMatch = (java.util.List<imports.aws.WafSqlInjectionMatchSetSqlInjectionMatchTuplesFieldToMatch>)fieldToMatch;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements WafSqlInjectionMatchSetSqlInjectionMatchTuples {
        private final java.util.List<imports.aws.WafSqlInjectionMatchSetSqlInjectionMatchTuplesFieldToMatch> fieldToMatch;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.fieldToMatch = software.amazon.jsii.Kernel.get(this, "fieldToMatch", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.WafSqlInjectionMatchSetSqlInjectionMatchTuplesFieldToMatch.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.aws.WafSqlInjectionMatchSetSqlInjectionMatchTuplesFieldToMatch> fieldToMatch, final java.lang.String textTransformation) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.fieldToMatch = (java.util.List<imports.aws.WafSqlInjectionMatchSetSqlInjectionMatchTuplesFieldToMatch>)java.util.Objects.requireNonNull(fieldToMatch, "fieldToMatch is required");
            this.textTransformation = java.util.Objects.requireNonNull(textTransformation, "textTransformation is required");
        }

        @Override
        public final java.util.List<imports.aws.WafSqlInjectionMatchSetSqlInjectionMatchTuplesFieldToMatch> getFieldToMatch() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.WafSqlInjectionMatchSetSqlInjectionMatchTuples"));
