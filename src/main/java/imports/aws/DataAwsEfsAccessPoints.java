...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsEfsAccessPoints")
public class DataAwsEfsAccessPoints extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    public DataAwsEfsAccessPoints(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DataAwsEfsAccessPointsConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DataAwsEfsAccessPoints}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DataAwsEfsAccessPoints> {
        /**
        ...
        private final imports.aws.DataAwsEfsAccessPointsConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DataAwsEfsAccessPointsConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DataAwsEfsAccessPoints}.
         */
        @Override
        public imports.aws.DataAwsEfsAccessPoints build() {
            return new imports.aws.DataAwsEfsAccessPoints(
                this.scope,
                this.id,
                this.config.build()
            );
