...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.AmiLaunchPermission")
public class AmiLaunchPermission extends com.hashicorp.cdktf.TerraformResource {
    ...
    public AmiLaunchPermission(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.AmiLaunchPermissionConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.AmiLaunchPermission}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.AmiLaunchPermission> {
        /**
        ...
        private final imports.aws.AmiLaunchPermissionConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.AmiLaunchPermissionConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.AmiLaunchPermission}.
         */
        @Override
        public imports.aws.AmiLaunchPermission build() {
            return new imports.aws.AmiLaunchPermission(
                this.scope,
                this.id,
                this.config.build()
            );
