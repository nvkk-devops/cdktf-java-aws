...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.494Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.Ec2TrafficMirrorSessionConfig")
...
public interface Ec2TrafficMirrorSessionConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<Ec2TrafficMirrorSessionConfig> {
         ...
         * @param sessionNumber the value to be set. This parameter is required.
         * @return {@code this}
         */
        ...
        public Ec2TrafficMirrorSessionConfig build() {
            return new Jsii$Proxy(networkInterfaceId, sessionNumber, trafficMirrorFilterId, trafficMirrorTargetId, description, packetLength, tags, virtualNetworkId, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements Ec2TrafficMirrorSessionConfig {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String networkInterfaceId, final java.lang.Number sessionNumber, final java.lang.String trafficMirrorFilterId, final java.lang.String trafficMirrorTargetId, final java.lang.String description, final java.lang.Number packetLength, final java.util.Map<java.lang.String, java.lang.String> tags, final java.lang.Number virtualNetworkId, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.Ec2TrafficMirrorSessionConfig"));
