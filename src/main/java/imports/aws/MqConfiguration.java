...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.MqConfiguration")
public class MqConfiguration extends com.hashicorp.cdktf.TerraformResource {
    ...
    public MqConfiguration(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.MqConfigurationConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getDataInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.MqConfiguration}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.MqConfiguration> {
        /**
        ...
        private final imports.aws.MqConfigurationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.MqConfigurationConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.MqConfiguration}.
         */
        @Override
        public imports.aws.MqConfiguration build() {
            return new imports.aws.MqConfiguration(
                this.scope,
                this.id,
                this.config.build()
            );
