...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.LbTargetGroupAttachment")
public class LbTargetGroupAttachment extends com.hashicorp.cdktf.TerraformResource {
    ...
    public LbTargetGroupAttachment(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.LbTargetGroupAttachmentConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.LbTargetGroupAttachment}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.LbTargetGroupAttachment> {
        /**
        ...
        private final imports.aws.LbTargetGroupAttachmentConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.LbTargetGroupAttachmentConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.LbTargetGroupAttachment}.
         */
        @Override
        public imports.aws.LbTargetGroupAttachment build() {
            return new imports.aws.LbTargetGroupAttachment(
                this.scope,
                this.id,
                this.config.build()
            );
