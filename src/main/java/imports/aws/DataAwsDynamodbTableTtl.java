...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsDynamodbTableTtl")
public class DataAwsDynamodbTableTtl extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataAwsDynamodbTableTtl(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsDynamodbTableTtl(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DataAwsDynamodbTableTtl(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
