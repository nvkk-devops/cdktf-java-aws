...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.KinesisAnalyticsApplicationCloudwatchLoggingOptions")
...
public interface KinesisAnalyticsApplicationCloudwatchLoggingOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<KinesisAnalyticsApplicationCloudwatchLoggingOptions> {
        private java.lang.String logStreamArn;
        private java.lang.String roleArn;

        /**
         * Sets the value of {@link KinesisAnalyticsApplicationCloudwatchLoggingOptions#getLogStreamArn}
         * @param logStreamArn the value to be set. This parameter is required.
         * @return {@code this}
         */
        ...
        public KinesisAnalyticsApplicationCloudwatchLoggingOptions build() {
            return new Jsii$Proxy(logStreamArn, roleArn);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements KinesisAnalyticsApplicationCloudwatchLoggingOptions {
         ...
         */
        protected Jsii$Proxy(final java.lang.String logStreamArn, final java.lang.String roleArn) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.logStreamArn = java.util.Objects.requireNonNull(logStreamArn, "logStreamArn is required");
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.KinesisAnalyticsApplicationCloudwatchLoggingOptions"));
