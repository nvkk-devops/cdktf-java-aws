...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.S3BucketPolicy")
public class S3BucketPolicy extends com.hashicorp.cdktf.TerraformResource {
    ...
    public S3BucketPolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.S3BucketPolicyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.S3BucketPolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.S3BucketPolicy> {
        /**
        ...
        private final imports.aws.S3BucketPolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.S3BucketPolicyConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.S3BucketPolicy}.
         */
        @Override
        public imports.aws.S3BucketPolicy build() {
            return new imports.aws.S3BucketPolicy(
                this.scope,
                this.id,
                this.config.build()
            );
