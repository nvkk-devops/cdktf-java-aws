...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.ElasticBeanstalkApplicationVersion")
public class ElasticBeanstalkApplicationVersion extends com.hashicorp.cdktf.TerraformResource {
    ...
    public ElasticBeanstalkApplicationVersion(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.ElasticBeanstalkApplicationVersionConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.ElasticBeanstalkApplicationVersion}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ElasticBeanstalkApplicationVersion> {
        /**
        ...
        private final imports.aws.ElasticBeanstalkApplicationVersionConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.ElasticBeanstalkApplicationVersionConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ElasticBeanstalkApplicationVersion}.
         */
        @Override
        public imports.aws.ElasticBeanstalkApplicationVersion build() {
            return new imports.aws.ElasticBeanstalkApplicationVersion(
                this.scope,
                this.id,
                this.config.build()
            );
