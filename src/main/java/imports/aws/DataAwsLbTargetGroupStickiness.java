...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsLbTargetGroupStickiness")
public class DataAwsLbTargetGroupStickiness extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataAwsLbTargetGroupStickiness(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsLbTargetGroupStickiness(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DataAwsLbTargetGroupStickiness(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
