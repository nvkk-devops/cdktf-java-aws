...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.Apigatewayv2Deployment")
public class Apigatewayv2Deployment extends com.hashicorp.cdktf.TerraformResource {
    ...
    public Apigatewayv2Deployment(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.Apigatewayv2DeploymentConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.Boolean getAutoDeployed() {
        return software.amazon.jsii.Kernel.get(this, "autoDeployed", software.amazon.jsii.NativeType.forClass(java.lang.Boolean.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.Apigatewayv2Deployment}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.Apigatewayv2Deployment> {
        /**
        ...
        private final imports.aws.Apigatewayv2DeploymentConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.Apigatewayv2DeploymentConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.Apigatewayv2Deployment}.
         */
        @Override
        public imports.aws.Apigatewayv2Deployment build() {
            return new imports.aws.Apigatewayv2Deployment(
                this.scope,
                this.id,
                this.config.build()
            );
