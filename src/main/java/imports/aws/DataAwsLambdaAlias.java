...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsLambdaAlias")
public class DataAwsLambdaAlias extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    public DataAwsLambdaAlias(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DataAwsLambdaAliasConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DataAwsLambdaAlias}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DataAwsLambdaAlias> {
        /**
        ...
        private final imports.aws.DataAwsLambdaAliasConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DataAwsLambdaAliasConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DataAwsLambdaAlias}.
         */
        @Override
        public imports.aws.DataAwsLambdaAlias build() {
            return new imports.aws.DataAwsLambdaAlias(
                this.scope,
                this.id,
                this.config.build()
            );
