...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.WafregionalRegexPatternSet")
public class WafregionalRegexPatternSet extends com.hashicorp.cdktf.TerraformResource {
    ...
    public WafregionalRegexPatternSet(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.WafregionalRegexPatternSetConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.WafregionalRegexPatternSet}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.WafregionalRegexPatternSet> {
        /**
        ...
        private final imports.aws.WafregionalRegexPatternSetConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.WafregionalRegexPatternSetConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param regexPatternStrings This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.WafregionalRegexPatternSet}.
         */
        @Override
        public imports.aws.WafregionalRegexPatternSet build() {
            return new imports.aws.WafregionalRegexPatternSet(
                this.scope,
                this.id,
                this.config.build()
            );
