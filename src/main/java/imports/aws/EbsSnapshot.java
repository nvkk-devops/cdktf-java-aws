...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.EbsSnapshot")
public class EbsSnapshot extends com.hashicorp.cdktf.TerraformResource {
    ...
    public EbsSnapshot(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.EbsSnapshotConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.EbsSnapshotTimeouts getTimeoutsInput() {
        return software.amazon.jsii.Kernel.get(this, "timeoutsInput", software.amazon.jsii.NativeType.forClass(imports.aws.EbsSnapshotTimeouts.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.EbsSnapshotTimeouts getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.EbsSnapshotTimeouts.class));
    }

    public void setTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.EbsSnapshotTimeouts value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.EbsSnapshot}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.EbsSnapshot> {
        /**
        ...
        private final imports.aws.EbsSnapshotConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.EbsSnapshotConfig.Builder();
        }
         ...
         */
        public Builder timeouts(final imports.aws.EbsSnapshotTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.EbsSnapshot}.
         */
        @Override
        public imports.aws.EbsSnapshot build() {
            return new imports.aws.EbsSnapshot(
                this.scope,
                this.id,
                this.config.build()
            );
