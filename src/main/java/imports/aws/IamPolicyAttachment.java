...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.IamPolicyAttachment")
public class IamPolicyAttachment extends com.hashicorp.cdktf.TerraformResource {
    ...
    public IamPolicyAttachment(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.IamPolicyAttachmentConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.IamPolicyAttachment}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.IamPolicyAttachment> {
        /**
        ...
        private final imports.aws.IamPolicyAttachmentConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.IamPolicyAttachmentConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.IamPolicyAttachment}.
         */
        @Override
        public imports.aws.IamPolicyAttachment build() {
            return new imports.aws.IamPolicyAttachment(
                this.scope,
                this.id,
                this.config.build()
            );
