...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:01.946Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.AlbTargetGroup")
public class AlbTargetGroup extends com.hashicorp.cdktf.TerraformResource {
    ...
    public AlbTargetGroup(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.AlbTargetGroupConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.AlbTargetGroupHealthCheck> getHealthCheckInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.AlbTargetGroupHealthCheck>)(software.amazon.jsii.Kernel.get(this, "healthCheckInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.AlbTargetGroupHealthCheck.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.AlbTargetGroupStickiness> getStickinessInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.AlbTargetGroupStickiness>)(software.amazon.jsii.Kernel.get(this, "stickinessInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.AlbTargetGroupStickiness.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.AlbTargetGroupHealthCheck> getHealthCheck() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "healthCheck", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.AlbTargetGroupHealthCheck.class))));
    }

    public void setHealthCheck(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.AlbTargetGroupHealthCheck> value) {
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.AlbTargetGroupStickiness> getStickiness() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "stickiness", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.AlbTargetGroupStickiness.class))));
    }

    public void setStickiness(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.AlbTargetGroupStickiness> value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.AlbTargetGroup}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.AlbTargetGroup> {
        /**
        ...
        private imports.aws.AlbTargetGroupConfig.Builder config;
         ...
         */
        public Builder healthCheck(final java.util.List<? extends imports.aws.AlbTargetGroupHealthCheck> healthCheck) {
         ...
         */
        public Builder stickiness(final java.util.List<? extends imports.aws.AlbTargetGroupStickiness> stickiness) {
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.AlbTargetGroup}.
         */
        @Override
        public imports.aws.AlbTargetGroup build() {
            return new imports.aws.AlbTargetGroup(
                this.scope,
                this.id,
        ...
        private imports.aws.AlbTargetGroupConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.AlbTargetGroupConfig.Builder();
            }
            return this.config;
        }
    }
