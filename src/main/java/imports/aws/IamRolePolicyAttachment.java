...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.IamRolePolicyAttachment")
public class IamRolePolicyAttachment extends com.hashicorp.cdktf.TerraformResource {
    ...
    public IamRolePolicyAttachment(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.IamRolePolicyAttachmentConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.IamRolePolicyAttachment}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.IamRolePolicyAttachment> {
        /**
        ...
        private final imports.aws.IamRolePolicyAttachmentConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.IamRolePolicyAttachmentConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.IamRolePolicyAttachment}.
         */
        @Override
        public imports.aws.IamRolePolicyAttachment build() {
            return new imports.aws.IamRolePolicyAttachment(
                this.scope,
                this.id,
                this.config.build()
            );
