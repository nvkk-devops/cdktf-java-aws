...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:01.947Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.AlbTargetGroupAttachment")
public class AlbTargetGroupAttachment extends com.hashicorp.cdktf.TerraformResource {
    ...
    public AlbTargetGroupAttachment(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.AlbTargetGroupAttachmentConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getTargetGroupArnInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.AlbTargetGroupAttachment}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.AlbTargetGroupAttachment> {
        /**
        ...
        private final imports.aws.AlbTargetGroupAttachmentConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.AlbTargetGroupAttachmentConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param targetGroupArn This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.AlbTargetGroupAttachment}.
         */
        @Override
        public imports.aws.AlbTargetGroupAttachment build() {
            return new imports.aws.AlbTargetGroupAttachment(
                this.scope,
                this.id,
                this.config.build()
            );
