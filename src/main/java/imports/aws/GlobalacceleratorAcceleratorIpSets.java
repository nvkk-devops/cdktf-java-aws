...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.GlobalacceleratorAcceleratorIpSets")
public class GlobalacceleratorAcceleratorIpSets extends com.hashicorp.cdktf.ComplexComputedList {

    protected GlobalacceleratorAcceleratorIpSets(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected GlobalacceleratorAcceleratorIpSets(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public GlobalacceleratorAcceleratorIpSets(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
