...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsVpnGateway")
public class DataAwsVpnGateway extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    public DataAwsVpnGateway(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.DataAwsVpnGatewayConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.DataAwsVpnGatewayFilter> getFilterInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.DataAwsVpnGatewayFilter>)(software.amazon.jsii.Kernel.get(this, "filterInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.DataAwsVpnGatewayFilter.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.DataAwsVpnGatewayFilter> getFilter() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "filter", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.DataAwsVpnGatewayFilter.class))));
    }

    public void setFilter(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.DataAwsVpnGatewayFilter> value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DataAwsVpnGateway}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DataAwsVpnGateway> {
        /**
        ...
        private imports.aws.DataAwsVpnGatewayConfig.Builder config;
        ...
        /**
         * @return {@code this}
         * @param attachedVpcId This parameter is required.
         */
         ...
         */
        public Builder filter(final java.util.List<? extends imports.aws.DataAwsVpnGatewayFilter> filter) {
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DataAwsVpnGateway}.
         */
        @Override
        public imports.aws.DataAwsVpnGateway build() {
            return new imports.aws.DataAwsVpnGateway(
                this.scope,
                this.id,
        ...
        private imports.aws.DataAwsVpnGatewayConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.DataAwsVpnGatewayConfig.Builder();
            }
            return this.config;
        }
    }
