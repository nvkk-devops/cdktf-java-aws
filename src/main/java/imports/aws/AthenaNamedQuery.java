...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.AthenaNamedQuery")
public class AthenaNamedQuery extends com.hashicorp.cdktf.TerraformResource {
    ...
    public AthenaNamedQuery(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.AthenaNamedQueryConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getDatabaseInput() {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getQueryInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.AthenaNamedQuery}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.AthenaNamedQuery> {
        /**
        ...
        private final imports.aws.AthenaNamedQueryConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.AthenaNamedQueryConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param database This parameter is required.
         */
        ...
        /**
         * @return {@code this}
         * @param workgroup This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.AthenaNamedQuery}.
         */
        @Override
        public imports.aws.AthenaNamedQuery build() {
            return new imports.aws.AthenaNamedQuery(
                this.scope,
                this.id,
                this.config.build()
            );
