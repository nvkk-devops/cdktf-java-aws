...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.CloudhsmV2Hsm")
public class CloudhsmV2Hsm extends com.hashicorp.cdktf.TerraformResource {
    ...
    public CloudhsmV2Hsm(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.CloudhsmV2HsmConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.CloudhsmV2HsmTimeouts getTimeoutsInput() {
        return software.amazon.jsii.Kernel.get(this, "timeoutsInput", software.amazon.jsii.NativeType.forClass(imports.aws.CloudhsmV2HsmTimeouts.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.CloudhsmV2HsmTimeouts getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.CloudhsmV2HsmTimeouts.class));
    }

    public void setTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.CloudhsmV2HsmTimeouts value) {
        software.amazon.jsii.Kernel.set(this, "timeouts", java.util.Objects.requireNonNull(value, "timeouts is required"));
    }

    /**
     * A fluent builder for {@link imports.aws.CloudhsmV2Hsm}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.CloudhsmV2Hsm> {
        /**
        ...
        private final imports.aws.CloudhsmV2HsmConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.CloudhsmV2HsmConfig.Builder();
        }
         ...
         */
        public Builder timeouts(final imports.aws.CloudhsmV2HsmTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.CloudhsmV2Hsm}.
         */
        @Override
        public imports.aws.CloudhsmV2Hsm build() {
            return new imports.aws.CloudhsmV2Hsm(
                this.scope,
                this.id,
                this.config.build()
            );
