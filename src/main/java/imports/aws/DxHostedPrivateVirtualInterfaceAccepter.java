...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.458Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DxHostedPrivateVirtualInterfaceAccepter")
public class DxHostedPrivateVirtualInterfaceAccepter extends com.hashicorp.cdktf.TerraformResource {
    ...
    public DxHostedPrivateVirtualInterfaceAccepter(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DxHostedPrivateVirtualInterfaceAccepterConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.DxHostedPrivateVirtualInterfaceAccepterTimeouts getTimeoutsInput() {
        return software.amazon.jsii.Kernel.get(this, "timeoutsInput", software.amazon.jsii.NativeType.forClass(imports.aws.DxHostedPrivateVirtualInterfaceAccepterTimeouts.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.DxHostedPrivateVirtualInterfaceAccepterTimeouts getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.DxHostedPrivateVirtualInterfaceAccepterTimeouts.class));
    }

    public void setTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.DxHostedPrivateVirtualInterfaceAccepterTimeouts value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DxHostedPrivateVirtualInterfaceAccepter}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DxHostedPrivateVirtualInterfaceAccepter> {
        /**
        ...
        private final imports.aws.DxHostedPrivateVirtualInterfaceAccepterConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DxHostedPrivateVirtualInterfaceAccepterConfig.Builder();
        }
         ...
         */
        public Builder timeouts(final imports.aws.DxHostedPrivateVirtualInterfaceAccepterTimeouts timeouts) {
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DxHostedPrivateVirtualInterfaceAccepter}.
         */
        @Override
        public imports.aws.DxHostedPrivateVirtualInterfaceAccepter build() {
            return new imports.aws.DxHostedPrivateVirtualInterfaceAccepter(
                this.scope,
                this.id,
                this.config.build()
            );
