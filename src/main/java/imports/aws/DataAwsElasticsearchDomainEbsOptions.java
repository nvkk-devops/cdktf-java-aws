...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsElasticsearchDomainEbsOptions")
public class DataAwsElasticsearchDomainEbsOptions extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataAwsElasticsearchDomainEbsOptions(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsElasticsearchDomainEbsOptions(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DataAwsElasticsearchDomainEbsOptions(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.Boolean getEbsEnabled() {
        return software.amazon.jsii.Kernel.get(this, "ebsEnabled", software.amazon.jsii.NativeType.forClass(java.lang.Boolean.class));
    }
