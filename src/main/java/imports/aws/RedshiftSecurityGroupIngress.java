...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.RedshiftSecurityGroupIngress")
...
public interface RedshiftSecurityGroupIngress extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<RedshiftSecurityGroupIngress> {
        ...
        public RedshiftSecurityGroupIngress build() {
            return new Jsii$Proxy(cidr, securityGroupName, securityGroupOwnerId);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements RedshiftSecurityGroupIngress {
         ...
         */
        protected Jsii$Proxy(final java.lang.String cidr, final java.lang.String securityGroupName, final java.lang.String securityGroupOwnerId) {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.RedshiftSecurityGroupIngress"));
