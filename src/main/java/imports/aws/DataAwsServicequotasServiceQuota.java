...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.369Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsServicequotasServiceQuota")
public class DataAwsServicequotasServiceQuota extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    public DataAwsServicequotasServiceQuota(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DataAwsServicequotasServiceQuotaConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.Boolean getGlobalQuota() {
        return software.amazon.jsii.Kernel.get(this, "globalQuota", software.amazon.jsii.NativeType.forClass(java.lang.Boolean.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.DataAwsServicequotasServiceQuota}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DataAwsServicequotasServiceQuota> {
        /**
        ...
        private final imports.aws.DataAwsServicequotasServiceQuotaConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DataAwsServicequotasServiceQuotaConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DataAwsServicequotasServiceQuota}.
         */
        @Override
        public imports.aws.DataAwsServicequotasServiceQuota build() {
            return new imports.aws.DataAwsServicequotasServiceQuota(
                this.scope,
                this.id,
                this.config.build()
            );
