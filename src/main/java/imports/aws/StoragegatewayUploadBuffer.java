...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.StoragegatewayUploadBuffer")
public class StoragegatewayUploadBuffer extends com.hashicorp.cdktf.TerraformResource {
    ...
    public StoragegatewayUploadBuffer(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.StoragegatewayUploadBufferConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.StoragegatewayUploadBuffer}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.StoragegatewayUploadBuffer> {
        /**
        ...
        private final imports.aws.StoragegatewayUploadBufferConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.StoragegatewayUploadBufferConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.StoragegatewayUploadBuffer}.
         */
        @Override
        public imports.aws.StoragegatewayUploadBuffer build() {
            return new imports.aws.StoragegatewayUploadBuffer(
                this.scope,
                this.id,
                this.config.build()
            );
