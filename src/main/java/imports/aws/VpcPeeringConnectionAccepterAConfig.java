...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.VpcPeeringConnectionAccepterAConfig")
...
public interface VpcPeeringConnectionAccepterAConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     * accepter block.
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.VpcPeeringConnectionAccepterAccepter> getAccepter() {
        return null;
    }
     ...
     * requester block.
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.VpcPeeringConnectionAccepterRequester> getRequester() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<VpcPeeringConnectionAccepterAConfig> {
        ...
        private java.util.List<imports.aws.VpcPeeringConnectionAccepterAccepter> accepter;
        private java.lang.Boolean autoAccept;
        private java.util.List<imports.aws.VpcPeeringConnectionAccepterRequester> requester;
        ...
        public Builder accepter(java.util.List<? extends imports.aws.VpcPeeringConnectionAccepterAccepter> accepter) {
            this.accepter = (java.util.List<imports.aws.VpcPeeringConnectionAccepterAccepter>)accepter;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder requester(java.util.List<? extends imports.aws.VpcPeeringConnectionAccepterRequester> requester) {
            this.requester = (java.util.List<imports.aws.VpcPeeringConnectionAccepterRequester>)requester;
            return this;
        }
        ...
        public VpcPeeringConnectionAccepterAConfig build() {
            return new Jsii$Proxy(vpcPeeringConnectionId, accepter, autoAccept, requester, tags, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements VpcPeeringConnectionAccepterAConfig {
        ...
        private final java.util.List<imports.aws.VpcPeeringConnectionAccepterAccepter> accepter;
        private final java.lang.Boolean autoAccept;
        private final java.util.List<imports.aws.VpcPeeringConnectionAccepterRequester> requester;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.accepter = software.amazon.jsii.Kernel.get(this, "accepter", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.VpcPeeringConnectionAccepterAccepter.class)));
            ...
            this.requester = software.amazon.jsii.Kernel.get(this, "requester", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.VpcPeeringConnectionAccepterRequester.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String vpcPeeringConnectionId, final java.util.List<? extends imports.aws.VpcPeeringConnectionAccepterAccepter> accepter, final java.lang.Boolean autoAccept, final java.util.List<? extends imports.aws.VpcPeeringConnectionAccepterRequester> requester, final java.util.Map<java.lang.String, java.lang.String> tags, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
        ...
        @Override
        public final java.util.List<imports.aws.VpcPeeringConnectionAccepterAccepter> getAccepter() {
        ...
        @Override
        public final java.util.List<imports.aws.VpcPeeringConnectionAccepterRequester> getRequester() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.VpcPeeringConnectionAccepterAConfig"));
