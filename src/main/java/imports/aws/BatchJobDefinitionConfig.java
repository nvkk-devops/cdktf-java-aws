...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.BatchJobDefinitionConfig")
...
public interface BatchJobDefinitionConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.BatchJobDefinitionRetryStrategy> getRetryStrategy() {
        return null;
    }
     ...
     * timeout block.
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.BatchJobDefinitionTimeout> getTimeout() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<BatchJobDefinitionConfig> {
        ...
        private java.lang.String containerProperties;
        private java.util.Map<java.lang.String, java.lang.String> parameters;
        private java.util.List<imports.aws.BatchJobDefinitionRetryStrategy> retryStrategy;
        private java.util.List<imports.aws.BatchJobDefinitionTimeout> timeout;
         ...
         * @param containerProperties the value to be set.
         * @return {@code this}
         */
        ...
        public Builder retryStrategy(java.util.List<? extends imports.aws.BatchJobDefinitionRetryStrategy> retryStrategy) {
            this.retryStrategy = (java.util.List<imports.aws.BatchJobDefinitionRetryStrategy>)retryStrategy;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder timeout(java.util.List<? extends imports.aws.BatchJobDefinitionTimeout> timeout) {
            this.timeout = (java.util.List<imports.aws.BatchJobDefinitionTimeout>)timeout;
            return this;
        }
        ...
        public BatchJobDefinitionConfig build() {
            return new Jsii$Proxy(name, type, containerProperties, parameters, retryStrategy, timeout, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements BatchJobDefinitionConfig {
        ...
        private final java.util.List<imports.aws.BatchJobDefinitionRetryStrategy> retryStrategy;
        private final java.util.List<imports.aws.BatchJobDefinitionTimeout> timeout;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.retryStrategy = software.amazon.jsii.Kernel.get(this, "retryStrategy", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.BatchJobDefinitionRetryStrategy.class)));
            this.timeout = software.amazon.jsii.Kernel.get(this, "timeout", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.BatchJobDefinitionTimeout.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String name, final java.lang.String type, final java.lang.String containerProperties, final java.util.Map<java.lang.String, java.lang.String> parameters, final java.util.List<? extends imports.aws.BatchJobDefinitionRetryStrategy> retryStrategy, final java.util.List<? extends imports.aws.BatchJobDefinitionTimeout> timeout, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
        ...
        @Override
        public final java.util.List<imports.aws.BatchJobDefinitionRetryStrategy> getRetryStrategy() {
            return this.retryStrategy;
        }

        @Override
        public final java.util.List<imports.aws.BatchJobDefinitionTimeout> getTimeout() {
            return this.timeout;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.BatchJobDefinitionConfig"));
