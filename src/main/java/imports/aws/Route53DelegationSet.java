...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.Route53DelegationSet")
public class Route53DelegationSet extends com.hashicorp.cdktf.TerraformResource {
    ...
    public Route53DelegationSet(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.Route53DelegationSetConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.Route53DelegationSet}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.Route53DelegationSet> {
        /**
        ...
        private imports.aws.Route53DelegationSetConfig.Builder config;
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.Route53DelegationSet}.
         */
        @Override
        public imports.aws.Route53DelegationSet build() {
            return new imports.aws.Route53DelegationSet(
                this.scope,
                this.id,
        ...
        private imports.aws.Route53DelegationSetConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.Route53DelegationSetConfig.Builder();
            }
            return this.config;
        }
    }
