...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.PinpointGcmChannel")
public class PinpointGcmChannel extends com.hashicorp.cdktf.TerraformResource {
    ...
    public PinpointGcmChannel(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.PinpointGcmChannelConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.PinpointGcmChannel}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.PinpointGcmChannel> {
        /**
        ...
        private final imports.aws.PinpointGcmChannelConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.PinpointGcmChannelConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.PinpointGcmChannel}.
         */
        @Override
        public imports.aws.PinpointGcmChannel build() {
            return new imports.aws.PinpointGcmChannel(
                this.scope,
                this.id,
                this.config.build()
            );
