...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DatasyncLocationS3S3Config")
...
public interface DatasyncLocationS3S3Config extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DatasyncLocationS3S3Config> {
        private java.lang.String bucketAccessRoleArn;

        /**
         * Sets the value of {@link DatasyncLocationS3S3Config#getBucketAccessRoleArn}
         * @param bucketAccessRoleArn the value to be set. This parameter is required.
         * @return {@code this}
         */
        ...
        public DatasyncLocationS3S3Config build() {
            return new Jsii$Proxy(bucketAccessRoleArn);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DatasyncLocationS3S3Config {
         ...
         */
        protected Jsii$Proxy(final java.lang.String bucketAccessRoleArn) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.bucketAccessRoleArn = java.util.Objects.requireNonNull(bucketAccessRoleArn, "bucketAccessRoleArn is required");
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.DatasyncLocationS3S3Config"));
