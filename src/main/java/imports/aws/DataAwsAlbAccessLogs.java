...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsAlbAccessLogs")
public class DataAwsAlbAccessLogs extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataAwsAlbAccessLogs(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsAlbAccessLogs(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DataAwsAlbAccessLogs(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
