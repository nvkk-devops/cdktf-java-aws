...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.CloudformationStackSetInstanceConfig")
...
public interface CloudformationStackSetInstanceConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
    ...
    default @org.jetbrains.annotations.Nullable java.lang.Boolean getRetainStack() {
        return null;
    }
     ...
     * timeouts block.
     */
    default @org.jetbrains.annotations.Nullable imports.aws.CloudformationStackSetInstanceTimeouts getTimeouts() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<CloudformationStackSetInstanceConfig> {
        private java.lang.String stackSetName;
        private java.lang.String accountId;
        private java.util.Map<java.lang.String, java.lang.String> parameterOverrides;
        private java.lang.String region;
        private java.lang.Boolean retainStack;
        private imports.aws.CloudformationStackSetInstanceTimeouts timeouts;
         ...
         * @param stackSetName the value to be set. This parameter is required.
         * @return {@code this}
         */
         ...
         * @param retainStack the value to be set.
         * @return {@code this}
         */
         ...
         * @return {@code this}
         */
        public Builder timeouts(imports.aws.CloudformationStackSetInstanceTimeouts timeouts) {
        ...
        public CloudformationStackSetInstanceConfig build() {
            return new Jsii$Proxy(stackSetName, accountId, parameterOverrides, region, retainStack, timeouts, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CloudformationStackSetInstanceConfig {
        ...
        private final java.lang.Boolean retainStack;
        private final imports.aws.CloudformationStackSetInstanceTimeouts timeouts;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.retainStack = software.amazon.jsii.Kernel.get(this, "retainStack", software.amazon.jsii.NativeType.forClass(java.lang.Boolean.class));
            this.timeouts = software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.CloudformationStackSetInstanceTimeouts.class));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String stackSetName, final java.lang.String accountId, final java.util.Map<java.lang.String, java.lang.String> parameterOverrides, final java.lang.String region, final java.lang.Boolean retainStack, final imports.aws.CloudformationStackSetInstanceTimeouts timeouts, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.stackSetName = java.util.Objects.requireNonNull(stackSetName, "stackSetName is required");
            this.accountId = accountId;
            this.parameterOverrides = parameterOverrides;
            this.region = region;
            this.retainStack = retainStack;
        ...
        @Override
        public final java.lang.Boolean getRetainStack() {
            return this.retainStack;
        }

        @Override
        public final imports.aws.CloudformationStackSetInstanceTimeouts getTimeouts() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.CloudformationStackSetInstanceConfig"));
