...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsLbTargetGroupHealthCheck")
public class DataAwsLbTargetGroupHealthCheck extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataAwsLbTargetGroupHealthCheck(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsLbTargetGroupHealthCheck(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DataAwsLbTargetGroupHealthCheck(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
