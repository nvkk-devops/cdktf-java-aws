...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.SesReceiptFilter")
public class SesReceiptFilter extends com.hashicorp.cdktf.TerraformResource {
    ...
    public SesReceiptFilter(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.SesReceiptFilterConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getCidrInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.SesReceiptFilter}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.SesReceiptFilter> {
        /**
        ...
        private final imports.aws.SesReceiptFilterConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.SesReceiptFilterConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.SesReceiptFilter}.
         */
        @Override
        public imports.aws.SesReceiptFilter build() {
            return new imports.aws.SesReceiptFilter(
                this.scope,
                this.id,
                this.config.build()
            );
