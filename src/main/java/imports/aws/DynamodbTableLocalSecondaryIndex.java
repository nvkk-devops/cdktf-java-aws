...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DynamodbTableLocalSecondaryIndex")
...
public interface DynamodbTableLocalSecondaryIndex extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DynamodbTableLocalSecondaryIndex> {
         ...
         * @param rangeKey the value to be set. This parameter is required.
         * @return {@code this}
         */
        ...
        public DynamodbTableLocalSecondaryIndex build() {
            return new Jsii$Proxy(name, projectionType, rangeKey, nonKeyAttributes);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DynamodbTableLocalSecondaryIndex {
         ...
         */
        protected Jsii$Proxy(final java.lang.String name, final java.lang.String projectionType, final java.lang.String rangeKey, final java.util.List<java.lang.String> nonKeyAttributes) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.name = java.util.Objects.requireNonNull(name, "name is required");
            this.projectionType = java.util.Objects.requireNonNull(projectionType, "projectionType is required");
            this.rangeKey = java.util.Objects.requireNonNull(rangeKey, "rangeKey is required");
            this.nonKeyAttributes = nonKeyAttributes;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.DynamodbTableLocalSecondaryIndex"));
