...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.IotPolicyAttachment")
public class IotPolicyAttachment extends com.hashicorp.cdktf.TerraformResource {
    ...
    public IotPolicyAttachment(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.IotPolicyAttachmentConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getTargetInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.IotPolicyAttachment}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.IotPolicyAttachment> {
        /**
        ...
        private final imports.aws.IotPolicyAttachmentConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.IotPolicyAttachmentConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.IotPolicyAttachment}.
         */
        @Override
        public imports.aws.IotPolicyAttachment build() {
            return new imports.aws.IotPolicyAttachment(
                this.scope,
                this.id,
                this.config.build()
            );
