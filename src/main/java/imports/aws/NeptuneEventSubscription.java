...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.NeptuneEventSubscription")
public class NeptuneEventSubscription extends com.hashicorp.cdktf.TerraformResource {
    ...
    public NeptuneEventSubscription(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.NeptuneEventSubscriptionConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.NeptuneEventSubscriptionTimeouts getTimeoutsInput() {
        return software.amazon.jsii.Kernel.get(this, "timeoutsInput", software.amazon.jsii.NativeType.forClass(imports.aws.NeptuneEventSubscriptionTimeouts.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.NeptuneEventSubscriptionTimeouts getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.NeptuneEventSubscriptionTimeouts.class));
    }

    public void setTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.NeptuneEventSubscriptionTimeouts value) {
        software.amazon.jsii.Kernel.set(this, "timeouts", java.util.Objects.requireNonNull(value, "timeouts is required"));
    }

    /**
     * A fluent builder for {@link imports.aws.NeptuneEventSubscription}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.NeptuneEventSubscription> {
        /**
        ...
        private final imports.aws.NeptuneEventSubscriptionConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.NeptuneEventSubscriptionConfig.Builder();
        }
         ...
         */
        public Builder timeouts(final imports.aws.NeptuneEventSubscriptionTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.NeptuneEventSubscription}.
         */
        @Override
        public imports.aws.NeptuneEventSubscription build() {
            return new imports.aws.NeptuneEventSubscription(
                this.scope,
                this.id,
                this.config.build()
            );
