...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.WafRateBasedRule")
public class WafRateBasedRule extends com.hashicorp.cdktf.TerraformResource {
    ...
    public WafRateBasedRule(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.WafRateBasedRuleConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.WafRateBasedRulePredicates> getPredicatesInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.WafRateBasedRulePredicates>)(software.amazon.jsii.Kernel.get(this, "predicatesInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.WafRateBasedRulePredicates.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.WafRateBasedRulePredicates> getPredicates() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "predicates", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.WafRateBasedRulePredicates.class))));
    }

    public void setPredicates(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.WafRateBasedRulePredicates> value) {
        software.amazon.jsii.Kernel.set(this, "predicates", java.util.Objects.requireNonNull(value, "predicates is required"));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.WafRateBasedRule}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.WafRateBasedRule> {
        /**
        ...
        private final imports.aws.WafRateBasedRuleConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.WafRateBasedRuleConfig.Builder();
        }
         ...
         */
        public Builder predicates(final java.util.List<? extends imports.aws.WafRateBasedRulePredicates> predicates) {
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.WafRateBasedRule}.
         */
        @Override
        public imports.aws.WafRateBasedRule build() {
            return new imports.aws.WafRateBasedRule(
                this.scope,
                this.id,
                this.config.build()
            );
