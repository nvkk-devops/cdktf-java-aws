...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.PinpointBaiduChannelConfig")
...
public interface PinpointBaiduChannelConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PinpointBaiduChannelConfig> {
         ...
         * @param secretKey the value to be set. This parameter is required.
         * @return {@code this}
         */
        ...
        public PinpointBaiduChannelConfig build() {
            return new Jsii$Proxy(apiKey, applicationId, secretKey, enabled, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PinpointBaiduChannelConfig {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String apiKey, final java.lang.String applicationId, final java.lang.String secretKey, final java.lang.Boolean enabled, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.apiKey = java.util.Objects.requireNonNull(apiKey, "apiKey is required");
            this.applicationId = java.util.Objects.requireNonNull(applicationId, "applicationId is required");
            this.secretKey = java.util.Objects.requireNonNull(secretKey, "secretKey is required");
            this.enabled = enabled;
            this.count = count;
            this.dependsOn = (java.util.List<com.hashicorp.cdktf.ITerraformDependable>)dependsOn;
            this.lifecycle = lifecycle;
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.PinpointBaiduChannelConfig"));
