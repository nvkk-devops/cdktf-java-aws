...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsStoragegatewayLocalDisk")
public class DataAwsStoragegatewayLocalDisk extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    public DataAwsStoragegatewayLocalDisk(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DataAwsStoragegatewayLocalDiskConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DataAwsStoragegatewayLocalDisk}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DataAwsStoragegatewayLocalDisk> {
        /**
        ...
        private final imports.aws.DataAwsStoragegatewayLocalDiskConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DataAwsStoragegatewayLocalDiskConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param diskNode This parameter is required.
         */
        ...
        /**
         * @return {@code this}
         * @param diskPath This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DataAwsStoragegatewayLocalDisk}.
         */
        @Override
        public imports.aws.DataAwsStoragegatewayLocalDisk build() {
            return new imports.aws.DataAwsStoragegatewayLocalDisk(
                this.scope,
                this.id,
                this.config.build()
            );
