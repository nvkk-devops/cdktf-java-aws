...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.S3BucketPublicAccessBlockConfig")
...
public interface S3BucketPublicAccessBlockConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<S3BucketPublicAccessBlockConfig> {
        ...
        public S3BucketPublicAccessBlockConfig build() {
            return new Jsii$Proxy(bucket, blockPublicAcls, blockPublicPolicy, ignorePublicAcls, restrictPublicBuckets, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements S3BucketPublicAccessBlockConfig {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String bucket, final java.lang.Boolean blockPublicAcls, final java.lang.Boolean blockPublicPolicy, final java.lang.Boolean ignorePublicAcls, final java.lang.Boolean restrictPublicBuckets, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.S3BucketPublicAccessBlockConfig"));
