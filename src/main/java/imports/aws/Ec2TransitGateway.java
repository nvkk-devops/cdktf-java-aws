...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.Ec2TransitGateway")
public class Ec2TransitGateway extends com.hashicorp.cdktf.TerraformResource {
    ...
    public Ec2TransitGateway(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.Ec2TransitGatewayConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.Ec2TransitGateway}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.Ec2TransitGateway> {
        /**
        ...
        private imports.aws.Ec2TransitGatewayConfig.Builder config;
        ...
        /**
         * @return {@code this}
         * @param autoAcceptSharedAttachments This parameter is required.
         */
        ...
        /**
         * @return {@code this}
         * @param defaultRouteTableAssociation This parameter is required.
         */
        ...
        /**
         * @return {@code this}
         * @param defaultRouteTablePropagation This parameter is required.
         */
        ...
        /**
         * @return {@code this}
         * @param vpnEcmpSupport This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.Ec2TransitGateway}.
         */
        @Override
        public imports.aws.Ec2TransitGateway build() {
            return new imports.aws.Ec2TransitGateway(
                this.scope,
                this.id,
        ...
        private imports.aws.Ec2TransitGatewayConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.Ec2TransitGatewayConfig.Builder();
            }
            return this.config;
        }
    }
