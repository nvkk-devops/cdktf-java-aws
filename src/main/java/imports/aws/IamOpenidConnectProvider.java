...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.IamOpenidConnectProvider")
public class IamOpenidConnectProvider extends com.hashicorp.cdktf.TerraformResource {
    ...
    public IamOpenidConnectProvider(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.IamOpenidConnectProviderConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<java.lang.String> getClientIdListInput() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "clientIdListInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(java.lang.String.class))));
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<java.lang.String> getThumbprintListInput() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "thumbprintListInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(java.lang.String.class))));
    }

    public @org.jetbrains.annotations.NotNull java.lang.String getUrlInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.IamOpenidConnectProvider}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.IamOpenidConnectProvider> {
        /**
        ...
        private final imports.aws.IamOpenidConnectProviderConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.IamOpenidConnectProviderConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param clientIdList This parameter is required.
         */
        ...
        /**
         * @return {@code this}
         * @param thumbprintList This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.IamOpenidConnectProvider}.
         */
        @Override
        public imports.aws.IamOpenidConnectProvider build() {
            return new imports.aws.IamOpenidConnectProvider(
                this.scope,
                this.id,
                this.config.build()
            );
