...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsEc2LocalGatewayRouteTableConfig")
...
public interface DataAwsEc2LocalGatewayRouteTableConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     * filter block.
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.DataAwsEc2LocalGatewayRouteTableFilter> getFilter() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DataAwsEc2LocalGatewayRouteTableConfig> {
        private java.util.List<imports.aws.DataAwsEc2LocalGatewayRouteTableFilter> filter;
        private java.lang.String localGatewayId;
        ...
        public Builder filter(java.util.List<? extends imports.aws.DataAwsEc2LocalGatewayRouteTableFilter> filter) {
            this.filter = (java.util.List<imports.aws.DataAwsEc2LocalGatewayRouteTableFilter>)filter;
            return this;
        }

        /**
         * Sets the value of {@link DataAwsEc2LocalGatewayRouteTableConfig#getLocalGatewayId}
         * @param localGatewayId the value to be set.
         * @return {@code this}
         */
         ...
         * @param localGatewayRouteTableId the value to be set.
         * @return {@code this}
         */
        ...
        public DataAwsEc2LocalGatewayRouteTableConfig build() {
            return new Jsii$Proxy(filter, localGatewayId, localGatewayRouteTableId, outpostArn, state, tags, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DataAwsEc2LocalGatewayRouteTableConfig {
        private final java.util.List<imports.aws.DataAwsEc2LocalGatewayRouteTableFilter> filter;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.filter = software.amazon.jsii.Kernel.get(this, "filter", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.DataAwsEc2LocalGatewayRouteTableFilter.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.aws.DataAwsEc2LocalGatewayRouteTableFilter> filter, final java.lang.String localGatewayId, final java.lang.String localGatewayRouteTableId, final java.lang.String outpostArn, final java.lang.String state, final java.util.Map<java.lang.String, java.lang.String> tags, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
        ...
        @Override
        public final java.util.List<imports.aws.DataAwsEc2LocalGatewayRouteTableFilter> getFilter() {
            return this.filter;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.DataAwsEc2LocalGatewayRouteTableConfig"));
