...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.AlbListenerRuleConditionHttpHeader")
...
public interface AlbListenerRuleConditionHttpHeader extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<AlbListenerRuleConditionHttpHeader> {
         ...
         * @param httpHeaderName the value to be set. This parameter is required.
         * @return {@code this}
         */
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements AlbListenerRuleConditionHttpHeader {
         ...
         */
        protected Jsii$Proxy(final java.lang.String httpHeaderName, final java.util.List<java.lang.String> values) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.httpHeaderName = java.util.Objects.requireNonNull(httpHeaderName, "httpHeaderName is required");
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.AlbListenerRuleConditionHttpHeader"));
