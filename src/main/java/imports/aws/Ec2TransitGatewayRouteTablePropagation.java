...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.Ec2TransitGatewayRouteTablePropagation")
public class Ec2TransitGatewayRouteTablePropagation extends com.hashicorp.cdktf.TerraformResource {
    ...
    public Ec2TransitGatewayRouteTablePropagation(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.Ec2TransitGatewayRouteTablePropagationConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.Ec2TransitGatewayRouteTablePropagation}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.Ec2TransitGatewayRouteTablePropagation> {
        /**
        ...
        private final imports.aws.Ec2TransitGatewayRouteTablePropagationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.Ec2TransitGatewayRouteTablePropagationConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.Ec2TransitGatewayRouteTablePropagation}.
         */
        @Override
        public imports.aws.Ec2TransitGatewayRouteTablePropagation build() {
            return new imports.aws.Ec2TransitGatewayRouteTablePropagation(
                this.scope,
                this.id,
                this.config.build()
            );
