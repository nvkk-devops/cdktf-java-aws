...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.GuarddutyIpset")
public class GuarddutyIpset extends com.hashicorp.cdktf.TerraformResource {
    ...
    public GuarddutyIpset(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.GuarddutyIpsetConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.Boolean getActivateInput() {
        return software.amazon.jsii.Kernel.get(this, "activateInput", software.amazon.jsii.NativeType.forClass(java.lang.Boolean.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getLocationInput() {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.Boolean getActivate() {
        return software.amazon.jsii.Kernel.get(this, "activate", software.amazon.jsii.NativeType.forClass(java.lang.Boolean.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.GuarddutyIpset}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.GuarddutyIpset> {
        /**
        ...
        private final imports.aws.GuarddutyIpsetConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.GuarddutyIpsetConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.GuarddutyIpset}.
         */
        @Override
        public imports.aws.GuarddutyIpset build() {
            return new imports.aws.GuarddutyIpset(
                this.scope,
                this.id,
                this.config.build()
            );
