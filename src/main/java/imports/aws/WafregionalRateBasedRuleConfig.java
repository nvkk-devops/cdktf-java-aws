...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.WafregionalRateBasedRuleConfig")
...
public interface WafregionalRateBasedRuleConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     * predicate block.
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.WafregionalRateBasedRulePredicate> getPredicate() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<WafregionalRateBasedRuleConfig> {
        ...
        private java.util.List<imports.aws.WafregionalRateBasedRulePredicate> predicate;
        ...
        public Builder predicate(java.util.List<? extends imports.aws.WafregionalRateBasedRulePredicate> predicate) {
            this.predicate = (java.util.List<imports.aws.WafregionalRateBasedRulePredicate>)predicate;
            return this;
        }
        ...
        public WafregionalRateBasedRuleConfig build() {
            return new Jsii$Proxy(metricName, name, rateKey, rateLimit, predicate, tags, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements WafregionalRateBasedRuleConfig {
        ...
        private final java.util.List<imports.aws.WafregionalRateBasedRulePredicate> predicate;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.predicate = software.amazon.jsii.Kernel.get(this, "predicate", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.WafregionalRateBasedRulePredicate.class)));
        ...
        @Override
        public final java.util.List<imports.aws.WafregionalRateBasedRulePredicate> getPredicate() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.WafregionalRateBasedRuleConfig"));
