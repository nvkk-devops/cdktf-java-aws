...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsElbAccessLogs")
public class DataAwsElbAccessLogs extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataAwsElbAccessLogs(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsElbAccessLogs(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DataAwsElbAccessLogs(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
