...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.MediaStoreContainerPolicy")
public class MediaStoreContainerPolicy extends com.hashicorp.cdktf.TerraformResource {
    ...
    public MediaStoreContainerPolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.MediaStoreContainerPolicyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.MediaStoreContainerPolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.MediaStoreContainerPolicy> {
        /**
        ...
        private final imports.aws.MediaStoreContainerPolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.MediaStoreContainerPolicyConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.MediaStoreContainerPolicy}.
         */
        @Override
        public imports.aws.MediaStoreContainerPolicy build() {
            return new imports.aws.MediaStoreContainerPolicy(
                this.scope,
                this.id,
                this.config.build()
            );
