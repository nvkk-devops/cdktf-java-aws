...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.057Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.AthenaWorkgroup")
public class AthenaWorkgroup extends com.hashicorp.cdktf.TerraformResource {
    ...
    public AthenaWorkgroup(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.AthenaWorkgroupConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.AthenaWorkgroupConfiguration> getConfigurationInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.AthenaWorkgroupConfiguration>)(software.amazon.jsii.Kernel.get(this, "configurationInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.AthenaWorkgroupConfiguration.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.AthenaWorkgroupConfiguration> getConfiguration() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "configuration", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.AthenaWorkgroupConfiguration.class))));
    }

    public void setConfiguration(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.AthenaWorkgroupConfiguration> value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.AthenaWorkgroup}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.AthenaWorkgroup> {
        /**
        ...
        private final imports.aws.AthenaWorkgroupConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.AthenaWorkgroupConfig.Builder();
        }
         ...
         */
        public Builder configuration(final java.util.List<? extends imports.aws.AthenaWorkgroupConfiguration> configuration) {
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.AthenaWorkgroup}.
         */
        @Override
        public imports.aws.AthenaWorkgroup build() {
            return new imports.aws.AthenaWorkgroup(
                this.scope,
                this.id,
                this.config.build()
            );
