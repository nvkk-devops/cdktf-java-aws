...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsAlbListenerDefaultActionRedirect")
public class DataAwsAlbListenerDefaultActionRedirect extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataAwsAlbListenerDefaultActionRedirect(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsAlbListenerDefaultActionRedirect(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DataAwsAlbListenerDefaultActionRedirect(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
