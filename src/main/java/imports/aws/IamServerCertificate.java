...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.IamServerCertificate")
public class IamServerCertificate extends com.hashicorp.cdktf.TerraformResource {
    ...
    public IamServerCertificate(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.IamServerCertificateConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getCertificateBodyInput() {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getPrivateKeyInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.IamServerCertificate}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.IamServerCertificate> {
        /**
        ...
        private final imports.aws.IamServerCertificateConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.IamServerCertificateConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.IamServerCertificate}.
         */
        @Override
        public imports.aws.IamServerCertificate build() {
            return new imports.aws.IamServerCertificate(
                this.scope,
                this.id,
                this.config.build()
            );
