...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.Route53ZoneConfig")
...
public interface Route53ZoneConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     * vpc block.
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.Route53ZoneVpc> getVpc() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<Route53ZoneConfig> {
        ...
        private java.util.List<imports.aws.Route53ZoneVpc> vpc;
         ...
         * @param delegationSetId the value to be set.
         * @return {@code this}
         */
        ...
        public Builder vpc(java.util.List<? extends imports.aws.Route53ZoneVpc> vpc) {
            this.vpc = (java.util.List<imports.aws.Route53ZoneVpc>)vpc;
            return this;
        }

        /**
         * Sets the value of {@link Route53ZoneConfig#getVpcId}
        ...
        /**
         * Sets the value of {@link Route53ZoneConfig#getVpcRegion}
        ...
        public Route53ZoneConfig build() {
            return new Jsii$Proxy(name, comment, delegationSetId, forceDestroy, tags, vpc, vpcId, vpcRegion, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements Route53ZoneConfig {
        ...
        private final java.util.List<imports.aws.Route53ZoneVpc> vpc;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.vpc = software.amazon.jsii.Kernel.get(this, "vpc", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.Route53ZoneVpc.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String name, final java.lang.String comment, final java.lang.String delegationSetId, final java.lang.Boolean forceDestroy, final java.util.Map<java.lang.String, java.lang.String> tags, final java.util.List<? extends imports.aws.Route53ZoneVpc> vpc, final java.lang.String vpcId, final java.lang.String vpcRegion, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
        ...
        @Override
        public final java.util.List<imports.aws.Route53ZoneVpc> getVpc() {
            return this.vpc;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.Route53ZoneConfig"));
