...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:01.937Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.AlbListenerConfig")
...
public interface AlbListenerConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     */
    @org.jetbrains.annotations.NotNull java.util.List<imports.aws.AlbListenerDefaultAction> getDefaultAction();
     ...
     * timeouts block.
     */
    default @org.jetbrains.annotations.Nullable imports.aws.AlbListenerTimeouts getTimeouts() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<AlbListenerConfig> {
        private java.util.List<imports.aws.AlbListenerDefaultAction> defaultAction;
        ...
        private imports.aws.AlbListenerTimeouts timeouts;
        ...
        public Builder defaultAction(java.util.List<? extends imports.aws.AlbListenerDefaultAction> defaultAction) {
            this.defaultAction = (java.util.List<imports.aws.AlbListenerDefaultAction>)defaultAction;
            return this;
        }
         ...
         * @return {@code this}
         */
        public Builder timeouts(imports.aws.AlbListenerTimeouts timeouts) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements AlbListenerConfig {
        private final java.util.List<imports.aws.AlbListenerDefaultAction> defaultAction;
        ...
        private final imports.aws.AlbListenerTimeouts timeouts;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.defaultAction = software.amazon.jsii.Kernel.get(this, "defaultAction", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.AlbListenerDefaultAction.class)));
            ...
            this.timeouts = software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.AlbListenerTimeouts.class));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.aws.AlbListenerDefaultAction> defaultAction, final java.lang.String loadBalancerArn, final java.lang.Number port, final java.lang.String certificateArn, final java.lang.String protocol, final java.lang.String sslPolicy, final imports.aws.AlbListenerTimeouts timeouts, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.defaultAction = (java.util.List<imports.aws.AlbListenerDefaultAction>)java.util.Objects.requireNonNull(defaultAction, "defaultAction is required");
        ...
        @Override
        public final java.util.List<imports.aws.AlbListenerDefaultAction> getDefaultAction() {
        ...
        @Override
        public final imports.aws.AlbListenerTimeouts getTimeouts() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.AlbListenerConfig"));
