...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.SsmParameter")
public class SsmParameter extends com.hashicorp.cdktf.TerraformResource {
    ...
    public SsmParameter(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.SsmParameterConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.lang.Boolean getOverwriteInput() {
        return software.amazon.jsii.Kernel.get(this, "overwriteInput", software.amazon.jsii.NativeType.forClass(java.lang.Boolean.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull java.lang.Boolean getOverwrite() {
        return software.amazon.jsii.Kernel.get(this, "overwrite", software.amazon.jsii.NativeType.forClass(java.lang.Boolean.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.SsmParameter}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.SsmParameter> {
        /**
        ...
        private final imports.aws.SsmParameterConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.SsmParameterConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.SsmParameter}.
         */
        @Override
        public imports.aws.SsmParameter build() {
            return new imports.aws.SsmParameter(
                this.scope,
                this.id,
                this.config.build()
            );
