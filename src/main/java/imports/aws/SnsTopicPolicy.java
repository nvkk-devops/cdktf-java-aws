...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.SnsTopicPolicy")
public class SnsTopicPolicy extends com.hashicorp.cdktf.TerraformResource {
    ...
    public SnsTopicPolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.SnsTopicPolicyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.SnsTopicPolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.SnsTopicPolicy> {
        /**
        ...
        private final imports.aws.SnsTopicPolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.SnsTopicPolicyConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.SnsTopicPolicy}.
         */
        @Override
        public imports.aws.SnsTopicPolicy build() {
            return new imports.aws.SnsTopicPolicy(
                this.scope,
                this.id,
                this.config.build()
            );
