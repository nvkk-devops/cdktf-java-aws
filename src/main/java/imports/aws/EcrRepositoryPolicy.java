...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.EcrRepositoryPolicy")
public class EcrRepositoryPolicy extends com.hashicorp.cdktf.TerraformResource {
    ...
    public EcrRepositoryPolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.EcrRepositoryPolicyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.EcrRepositoryPolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.EcrRepositoryPolicy> {
        /**
        ...
        private final imports.aws.EcrRepositoryPolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.EcrRepositoryPolicyConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.EcrRepositoryPolicy}.
         */
        @Override
        public imports.aws.EcrRepositoryPolicy build() {
            return new imports.aws.EcrRepositoryPolicy(
                this.scope,
                this.id,
                this.config.build()
            );
