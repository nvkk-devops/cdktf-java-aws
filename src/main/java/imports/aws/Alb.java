...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:01.932Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.Alb")
public class Alb extends com.hashicorp.cdktf.TerraformResource {
    ...
    public Alb(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.AlbConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.AlbAccessLogs> getAccessLogsInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.AlbAccessLogs>)(software.amazon.jsii.Kernel.get(this, "accessLogsInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.AlbAccessLogs.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.AlbSubnetMapping> getSubnetMappingInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.AlbSubnetMapping>)(software.amazon.jsii.Kernel.get(this, "subnetMappingInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.AlbSubnetMapping.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.AlbTimeouts getTimeoutsInput() {
        return software.amazon.jsii.Kernel.get(this, "timeoutsInput", software.amazon.jsii.NativeType.forClass(imports.aws.AlbTimeouts.class));
    }

    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.AlbAccessLogs> getAccessLogs() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "accessLogs", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.AlbAccessLogs.class))));
    }

    public void setAccessLogs(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.AlbAccessLogs> value) {
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.AlbSubnetMapping> getSubnetMapping() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "subnetMapping", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.AlbSubnetMapping.class))));
    }

    public void setSubnetMapping(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.AlbSubnetMapping> value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.AlbTimeouts getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.AlbTimeouts.class));
    }

    public void setTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.AlbTimeouts value) {
        software.amazon.jsii.Kernel.set(this, "timeouts", java.util.Objects.requireNonNull(value, "timeouts is required"));
    }

    /**
     * A fluent builder for {@link imports.aws.Alb}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.Alb> {
        /**
        ...
        private imports.aws.AlbConfig.Builder config;
         ...
         */
        public Builder accessLogs(final java.util.List<? extends imports.aws.AlbAccessLogs> accessLogs) {
         ...
         */
        public Builder subnetMapping(final java.util.List<? extends imports.aws.AlbSubnetMapping> subnetMapping) {
         ...
         */
        public Builder timeouts(final imports.aws.AlbTimeouts timeouts) {
            this.config().timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.Alb}.
         */
        @Override
        public imports.aws.Alb build() {
            return new imports.aws.Alb(
                this.scope,
                this.id,
        ...
        private imports.aws.AlbConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.AlbConfig.Builder();
            }
            return this.config;
        }
    }
