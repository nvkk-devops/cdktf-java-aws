...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.RedshiftEventSubscription")
public class RedshiftEventSubscription extends com.hashicorp.cdktf.TerraformResource {
    ...
    public RedshiftEventSubscription(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.RedshiftEventSubscriptionConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.RedshiftEventSubscriptionTimeouts getTimeoutsInput() {
        return software.amazon.jsii.Kernel.get(this, "timeoutsInput", software.amazon.jsii.NativeType.forClass(imports.aws.RedshiftEventSubscriptionTimeouts.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.RedshiftEventSubscriptionTimeouts getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.RedshiftEventSubscriptionTimeouts.class));
    }

    public void setTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.RedshiftEventSubscriptionTimeouts value) {
        software.amazon.jsii.Kernel.set(this, "timeouts", java.util.Objects.requireNonNull(value, "timeouts is required"));
    }

    /**
     * A fluent builder for {@link imports.aws.RedshiftEventSubscription}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.RedshiftEventSubscription> {
        /**
        ...
        private final imports.aws.RedshiftEventSubscriptionConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.RedshiftEventSubscriptionConfig.Builder();
        }
         ...
         */
        public Builder timeouts(final imports.aws.RedshiftEventSubscriptionTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.RedshiftEventSubscription}.
         */
        @Override
        public imports.aws.RedshiftEventSubscription build() {
            return new imports.aws.RedshiftEventSubscription(
                this.scope,
                this.id,
                this.config.build()
            );
