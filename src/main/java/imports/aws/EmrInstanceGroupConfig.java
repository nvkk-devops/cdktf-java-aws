...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.575Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.EmrInstanceGroupConfig")
...
public interface EmrInstanceGroupConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     * ebs_config block.
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.EmrInstanceGroupEbsConfig> getEbsConfig() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<EmrInstanceGroupConfig> {
        ...
        private java.util.List<imports.aws.EmrInstanceGroupEbsConfig> ebsConfig;
        ...
        public Builder ebsConfig(java.util.List<? extends imports.aws.EmrInstanceGroupEbsConfig> ebsConfig) {
            this.ebsConfig = (java.util.List<imports.aws.EmrInstanceGroupEbsConfig>)ebsConfig;
            return this;
        }
        ...
        public EmrInstanceGroupConfig build() {
            return new Jsii$Proxy(clusterId, instanceType, autoscalingPolicy, bidPrice, configurationsJson, ebsConfig, ebsOptimized, instanceCount, name, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements EmrInstanceGroupConfig {
        ...
        private final java.util.List<imports.aws.EmrInstanceGroupEbsConfig> ebsConfig;
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String clusterId, final java.lang.String instanceType, final java.lang.String autoscalingPolicy, final java.lang.String bidPrice, final java.lang.String configurationsJson, final java.util.List<? extends imports.aws.EmrInstanceGroupEbsConfig> ebsConfig, final java.lang.Boolean ebsOptimized, final java.lang.Number instanceCount, final java.lang.String name, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
        ...
        @Override
        public final java.util.List<imports.aws.EmrInstanceGroupEbsConfig> getEbsConfig() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.EmrInstanceGroupConfig"));
