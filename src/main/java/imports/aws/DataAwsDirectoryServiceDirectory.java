...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsDirectoryServiceDirectory")
public class DataAwsDirectoryServiceDirectory extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    public DataAwsDirectoryServiceDirectory(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DataAwsDirectoryServiceDirectoryConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public @org.jetbrains.annotations.NotNull imports.aws.DataAwsDirectoryServiceDirectoryConnectSettings connectSettings(final @org.jetbrains.annotations.NotNull java.lang.String index) {
        return software.amazon.jsii.Kernel.call(this, "connectSettings", software.amazon.jsii.NativeType.forClass(imports.aws.DataAwsDirectoryServiceDirectoryConnectSettings.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.DataAwsDirectoryServiceDirectoryVpcSettings vpcSettings(final @org.jetbrains.annotations.NotNull java.lang.String index) {
        return software.amazon.jsii.Kernel.call(this, "vpcSettings", software.amazon.jsii.NativeType.forClass(imports.aws.DataAwsDirectoryServiceDirectoryVpcSettings.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.DataAwsDirectoryServiceDirectory}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DataAwsDirectoryServiceDirectory> {
        /**
        ...
        private final imports.aws.DataAwsDirectoryServiceDirectoryConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DataAwsDirectoryServiceDirectoryConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DataAwsDirectoryServiceDirectory}.
         */
        @Override
        public imports.aws.DataAwsDirectoryServiceDirectory build() {
            return new imports.aws.DataAwsDirectoryServiceDirectory(
                this.scope,
                this.id,
                this.config.build()
            );
