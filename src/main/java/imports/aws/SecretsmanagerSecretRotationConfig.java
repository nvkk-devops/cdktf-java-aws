...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.850Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.SecretsmanagerSecretRotationConfig")
...
public interface SecretsmanagerSecretRotationConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     */
    @org.jetbrains.annotations.NotNull java.util.List<imports.aws.SecretsmanagerSecretRotationRotationRules> getRotationRules();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<SecretsmanagerSecretRotationConfig> {
        ...
        private java.util.List<imports.aws.SecretsmanagerSecretRotationRotationRules> rotationRules;
         ...
         * @param rotationLambdaArn the value to be set. This parameter is required.
         * @return {@code this}
         */
        ...
        public Builder rotationRules(java.util.List<? extends imports.aws.SecretsmanagerSecretRotationRotationRules> rotationRules) {
            this.rotationRules = (java.util.List<imports.aws.SecretsmanagerSecretRotationRotationRules>)rotationRules;
            return this;
        }
        ...
        public SecretsmanagerSecretRotationConfig build() {
            return new Jsii$Proxy(rotationLambdaArn, rotationRules, secretId, tags, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecretsmanagerSecretRotationConfig {
        ...
        private final java.util.List<imports.aws.SecretsmanagerSecretRotationRotationRules> rotationRules;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.rotationRules = software.amazon.jsii.Kernel.get(this, "rotationRules", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.SecretsmanagerSecretRotationRotationRules.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String rotationLambdaArn, final java.util.List<? extends imports.aws.SecretsmanagerSecretRotationRotationRules> rotationRules, final java.lang.String secretId, final java.util.Map<java.lang.String, java.lang.String> tags, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.rotationLambdaArn = java.util.Objects.requireNonNull(rotationLambdaArn, "rotationLambdaArn is required");
            this.rotationRules = (java.util.List<imports.aws.SecretsmanagerSecretRotationRotationRules>)java.util.Objects.requireNonNull(rotationRules, "rotationRules is required");
        ...
        @Override
        public final java.util.List<imports.aws.SecretsmanagerSecretRotationRotationRules> getRotationRules() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.SecretsmanagerSecretRotationConfig"));
