...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsInstanceEbsBlockDevice")
public class DataAwsInstanceEbsBlockDevice extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataAwsInstanceEbsBlockDevice(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsInstanceEbsBlockDevice(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DataAwsInstanceEbsBlockDevice(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
