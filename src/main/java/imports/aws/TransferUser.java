...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.TransferUser")
public class TransferUser extends com.hashicorp.cdktf.TerraformResource {
    ...
    public TransferUser(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.TransferUserConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.TransferUser}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.TransferUser> {
        /**
        ...
        private final imports.aws.TransferUserConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.TransferUserConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param homeDirectory This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.TransferUser}.
         */
        @Override
        public imports.aws.TransferUser build() {
            return new imports.aws.TransferUser(
                this.scope,
                this.id,
                this.config.build()
            );
