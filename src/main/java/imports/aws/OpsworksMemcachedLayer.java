...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.751Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.OpsworksMemcachedLayer")
public class OpsworksMemcachedLayer extends com.hashicorp.cdktf.TerraformResource {
    ...
    public OpsworksMemcachedLayer(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.OpsworksMemcachedLayerConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.OpsworksMemcachedLayerEbsVolume> getEbsVolumeInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.OpsworksMemcachedLayerEbsVolume>)(software.amazon.jsii.Kernel.get(this, "ebsVolumeInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.OpsworksMemcachedLayerEbsVolume.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.OpsworksMemcachedLayerEbsVolume> getEbsVolume() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "ebsVolume", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.OpsworksMemcachedLayerEbsVolume.class))));
    }

    public void setEbsVolume(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.OpsworksMemcachedLayerEbsVolume> value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.OpsworksMemcachedLayer}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.OpsworksMemcachedLayer> {
        /**
        ...
        private final imports.aws.OpsworksMemcachedLayerConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.OpsworksMemcachedLayerConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param allocatedMemory This parameter is required.
         */
         ...
         */
        public Builder ebsVolume(final java.util.List<? extends imports.aws.OpsworksMemcachedLayerEbsVolume> ebsVolume) {
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.OpsworksMemcachedLayer}.
         */
        @Override
        public imports.aws.OpsworksMemcachedLayer build() {
            return new imports.aws.OpsworksMemcachedLayer(
                this.scope,
                this.id,
                this.config.build()
            );
