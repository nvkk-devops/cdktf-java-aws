...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.CloudfrontDistributionCacheBehavior")
@software.amazon.jsii.Jsii.Proxy(CloudfrontDistributionCacheBehavior.Jsii$Proxy.class)
public interface CloudfrontDistributionCacheBehavior extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull java.util.List<imports.aws.CloudfrontDistributionCacheBehaviorForwardedValues> getForwardedValues();
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation> getLambdaFunctionAssociation() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link CloudfrontDistributionCacheBehavior}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link CloudfrontDistributionCacheBehavior}
     */
    public static final class Builder implements software.amazon.jsii.Builder<CloudfrontDistributionCacheBehavior> {
        private java.util.List<java.lang.String> allowedMethods;
        private java.util.List<java.lang.String> cachedMethods;
        private java.util.List<imports.aws.CloudfrontDistributionCacheBehaviorForwardedValues> forwardedValues;
        ...
        private java.util.List<imports.aws.CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation> lambdaFunctionAssociation;
        ...
        /**
         * Sets the value of {@link CloudfrontDistributionCacheBehavior#getAllowedMethods}
        ...
        /**
         * Sets the value of {@link CloudfrontDistributionCacheBehavior#getCachedMethods}
        ...
        /**
         * Sets the value of {@link CloudfrontDistributionCacheBehavior#getForwardedValues}
         * @param forwardedValues forwarded_values block. This parameter is required.
         * @return {@code this}
         */
        @SuppressWarnings("unchecked")
        public Builder forwardedValues(java.util.List<? extends imports.aws.CloudfrontDistributionCacheBehaviorForwardedValues> forwardedValues) {
            this.forwardedValues = (java.util.List<imports.aws.CloudfrontDistributionCacheBehaviorForwardedValues>)forwardedValues;
            return this;
        }

        /**
         * Sets the value of {@link CloudfrontDistributionCacheBehavior#getPathPattern}
         * @param pathPattern the value to be set. This parameter is required.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link CloudfrontDistributionCacheBehavior#getTargetOriginId}
        ...
        /**
         * Sets the value of {@link CloudfrontDistributionCacheBehavior#getViewerProtocolPolicy}
        ...
        /**
         * Sets the value of {@link CloudfrontDistributionCacheBehavior#getCompress}
        ...
        /**
         * Sets the value of {@link CloudfrontDistributionCacheBehavior#getDefaultTtl}
        ...
        /**
         * Sets the value of {@link CloudfrontDistributionCacheBehavior#getFieldLevelEncryptionId}
        ...
        /**
         * Sets the value of {@link CloudfrontDistributionCacheBehavior#getLambdaFunctionAssociation}
         * @param lambdaFunctionAssociation lambda_function_association block.
         * @return {@code this}
         */
        @SuppressWarnings("unchecked")
        public Builder lambdaFunctionAssociation(java.util.List<? extends imports.aws.CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation> lambdaFunctionAssociation) {
            this.lambdaFunctionAssociation = (java.util.List<imports.aws.CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation>)lambdaFunctionAssociation;
            return this;
        }

        /**
         * Sets the value of {@link CloudfrontDistributionCacheBehavior#getMaxTtl}
        ...
        /**
         * Sets the value of {@link CloudfrontDistributionCacheBehavior#getMinTtl}
        ...
        /**
         * Sets the value of {@link CloudfrontDistributionCacheBehavior#getSmoothStreaming}
        ...
        /**
         * Sets the value of {@link CloudfrontDistributionCacheBehavior#getTrustedSigners}
         ...
         * @return a new instance of {@link CloudfrontDistributionCacheBehavior}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public CloudfrontDistributionCacheBehavior build() {
            return new Jsii$Proxy(allowedMethods, cachedMethods, forwardedValues, pathPattern, targetOriginId, viewerProtocolPolicy, compress, defaultTtl, fieldLevelEncryptionId, lambdaFunctionAssociation, maxTtl, minTtl, smoothStreaming, trustedSigners);
        }
    }

    /**
     * An implementation for {@link CloudfrontDistributionCacheBehavior}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CloudfrontDistributionCacheBehavior {
        private final java.util.List<java.lang.String> allowedMethods;
        private final java.util.List<java.lang.String> cachedMethods;
        private final java.util.List<imports.aws.CloudfrontDistributionCacheBehaviorForwardedValues> forwardedValues;
        ...
        private final java.util.List<imports.aws.CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation> lambdaFunctionAssociation;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.forwardedValues = software.amazon.jsii.Kernel.get(this, "forwardedValues", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.CloudfrontDistributionCacheBehaviorForwardedValues.class)));
            ...
            this.lambdaFunctionAssociation = software.amazon.jsii.Kernel.get(this, "lambdaFunctionAssociation", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<java.lang.String> allowedMethods, final java.util.List<java.lang.String> cachedMethods, final java.util.List<? extends imports.aws.CloudfrontDistributionCacheBehaviorForwardedValues> forwardedValues, final java.lang.String pathPattern, final java.lang.String targetOriginId, final java.lang.String viewerProtocolPolicy, final java.lang.Boolean compress, final java.lang.Number defaultTtl, final java.lang.String fieldLevelEncryptionId, final java.util.List<? extends imports.aws.CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation> lambdaFunctionAssociation, final java.lang.Number maxTtl, final java.lang.Number minTtl, final java.lang.Boolean smoothStreaming, final java.util.List<java.lang.String> trustedSigners) {
            ...
            this.forwardedValues = (java.util.List<imports.aws.CloudfrontDistributionCacheBehaviorForwardedValues>)java.util.Objects.requireNonNull(forwardedValues, "forwardedValues is required");
        ...
        @Override
        public final java.util.List<imports.aws.CloudfrontDistributionCacheBehaviorForwardedValues> getForwardedValues() {
        ...
        @Override
        public final java.util.List<imports.aws.CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation> getLambdaFunctionAssociation() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.CloudfrontDistributionCacheBehavior"));
        ...
        public final boolean equals(final Object o) {
            ...
            CloudfrontDistributionCacheBehavior.Jsii$Proxy that = (CloudfrontDistributionCacheBehavior.Jsii$Proxy) o;
