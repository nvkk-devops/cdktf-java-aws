...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.PinpointApnsChannel")
public class PinpointApnsChannel extends com.hashicorp.cdktf.TerraformResource {
    ...
    public PinpointApnsChannel(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.PinpointApnsChannelConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.PinpointApnsChannel}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.PinpointApnsChannel> {
        /**
        ...
        private final imports.aws.PinpointApnsChannelConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.PinpointApnsChannelConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.PinpointApnsChannel}.
         */
        @Override
        public imports.aws.PinpointApnsChannel build() {
            return new imports.aws.PinpointApnsChannel(
                this.scope,
                this.id,
                this.config.build()
            );
