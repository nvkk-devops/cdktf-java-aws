...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DefaultVpcDhcpOptionsConfig")
...
public interface DefaultVpcDhcpOptionsConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DefaultVpcDhcpOptionsConfig> {
        ...
        public DefaultVpcDhcpOptionsConfig build() {
            return new Jsii$Proxy(netbiosNameServers, netbiosNodeType, tags, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DefaultVpcDhcpOptionsConfig {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<java.lang.String> netbiosNameServers, final java.lang.String netbiosNodeType, final java.util.Map<java.lang.String, java.lang.String> tags, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.DefaultVpcDhcpOptionsConfig"));
        ...
        public final int hashCode() {
            int result = this.netbiosNameServers != null ? this.netbiosNameServers.hashCode() : 0;
