...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.452Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DocdbClusterSnapshot")
public class DocdbClusterSnapshot extends com.hashicorp.cdktf.TerraformResource {
    ...
    public DocdbClusterSnapshot(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DocdbClusterSnapshotConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.DocdbClusterSnapshotTimeouts getTimeoutsInput() {
        return software.amazon.jsii.Kernel.get(this, "timeoutsInput", software.amazon.jsii.NativeType.forClass(imports.aws.DocdbClusterSnapshotTimeouts.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.DocdbClusterSnapshotTimeouts getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.DocdbClusterSnapshotTimeouts.class));
    }

    public void setTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.DocdbClusterSnapshotTimeouts value) {
        software.amazon.jsii.Kernel.set(this, "timeouts", java.util.Objects.requireNonNull(value, "timeouts is required"));
    }

    /**
     * A fluent builder for {@link imports.aws.DocdbClusterSnapshot}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DocdbClusterSnapshot> {
        /**
        ...
        private final imports.aws.DocdbClusterSnapshotConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DocdbClusterSnapshotConfig.Builder();
        }
         ...
         */
        public Builder timeouts(final imports.aws.DocdbClusterSnapshotTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.DocdbClusterSnapshot}.
         */
        @Override
        public imports.aws.DocdbClusterSnapshot build() {
            return new imports.aws.DocdbClusterSnapshot(
                this.scope,
                this.id,
                this.config.build()
            );
