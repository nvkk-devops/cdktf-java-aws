...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsVpcEndpoint")
public class DataAwsVpcEndpoint extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    public DataAwsVpcEndpoint(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.DataAwsVpcEndpointConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.DataAwsVpcEndpointDnsEntry dnsEntry(final @org.jetbrains.annotations.NotNull java.lang.String index) {
        return software.amazon.jsii.Kernel.call(this, "dnsEntry", software.amazon.jsii.NativeType.forClass(imports.aws.DataAwsVpcEndpointDnsEntry.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.DataAwsVpcEndpointFilter> getFilterInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.DataAwsVpcEndpointFilter>)(software.amazon.jsii.Kernel.get(this, "filterInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.DataAwsVpcEndpointFilter.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.DataAwsVpcEndpointFilter> getFilter() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "filter", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.DataAwsVpcEndpointFilter.class))));
    }

    public void setFilter(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.DataAwsVpcEndpointFilter> value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DataAwsVpcEndpoint}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DataAwsVpcEndpoint> {
        /**
        ...
        private imports.aws.DataAwsVpcEndpointConfig.Builder config;
         ...
         */
        public Builder filter(final java.util.List<? extends imports.aws.DataAwsVpcEndpointFilter> filter) {
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DataAwsVpcEndpoint}.
         */
        @Override
        public imports.aws.DataAwsVpcEndpoint build() {
            return new imports.aws.DataAwsVpcEndpoint(
                this.scope,
                this.id,
        ...
        private imports.aws.DataAwsVpcEndpointConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.DataAwsVpcEndpointConfig.Builder();
            }
            return this.config;
        }
    }
