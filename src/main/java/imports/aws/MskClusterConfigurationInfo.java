...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.MskClusterConfigurationInfo")
...
public interface MskClusterConfigurationInfo extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<MskClusterConfigurationInfo> {
         ...
         * @param revision the value to be set. This parameter is required.
         * @return {@code this}
         */
        ...
        public MskClusterConfigurationInfo build() {
            return new Jsii$Proxy(arn, revision);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements MskClusterConfigurationInfo {
         ...
         */
        protected Jsii$Proxy(final java.lang.String arn, final java.lang.Number revision) {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.MskClusterConfigurationInfo"));
