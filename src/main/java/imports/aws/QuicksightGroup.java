...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.QuicksightGroup")
public class QuicksightGroup extends com.hashicorp.cdktf.TerraformResource {
    ...
    public QuicksightGroup(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.QuicksightGroupConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.QuicksightGroup}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.QuicksightGroup> {
        /**
        ...
        private final imports.aws.QuicksightGroupConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.QuicksightGroupConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.QuicksightGroup}.
         */
        @Override
        public imports.aws.QuicksightGroup build() {
            return new imports.aws.QuicksightGroup(
                this.scope,
                this.id,
                this.config.build()
            );
