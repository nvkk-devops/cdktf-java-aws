...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DxHostedTransitVirtualInterface")
public class DxHostedTransitVirtualInterface extends com.hashicorp.cdktf.TerraformResource {
    ...
    public DxHostedTransitVirtualInterface(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DxHostedTransitVirtualInterfaceConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.DxHostedTransitVirtualInterfaceTimeouts getTimeoutsInput() {
        return software.amazon.jsii.Kernel.get(this, "timeoutsInput", software.amazon.jsii.NativeType.forClass(imports.aws.DxHostedTransitVirtualInterfaceTimeouts.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.DxHostedTransitVirtualInterfaceTimeouts getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.DxHostedTransitVirtualInterfaceTimeouts.class));
    }

    public void setTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.DxHostedTransitVirtualInterfaceTimeouts value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DxHostedTransitVirtualInterface}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DxHostedTransitVirtualInterface> {
        /**
        ...
        private final imports.aws.DxHostedTransitVirtualInterfaceConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DxHostedTransitVirtualInterfaceConfig.Builder();
        }
         ...
         */
        public Builder timeouts(final imports.aws.DxHostedTransitVirtualInterfaceTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.DxHostedTransitVirtualInterface}.
         */
        @Override
        public imports.aws.DxHostedTransitVirtualInterface build() {
            return new imports.aws.DxHostedTransitVirtualInterface(
                this.scope,
                this.id,
                this.config.build()
            );
