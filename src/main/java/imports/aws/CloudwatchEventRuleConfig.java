...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.138Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.CloudwatchEventRuleConfig")
...
public interface CloudwatchEventRuleConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<CloudwatchEventRuleConfig> {
         ...
         * @param eventPattern the value to be set.
         * @return {@code this}
         */
        ...
        public CloudwatchEventRuleConfig build() {
            return new Jsii$Proxy(description, eventPattern, isEnabled, name, namePrefix, roleArn, scheduleExpression, tags, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CloudwatchEventRuleConfig {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String description, final java.lang.String eventPattern, final java.lang.Boolean isEnabled, final java.lang.String name, final java.lang.String namePrefix, final java.lang.String roleArn, final java.lang.String scheduleExpression, final java.util.Map<java.lang.String, java.lang.String> tags, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.CloudwatchEventRuleConfig"));
