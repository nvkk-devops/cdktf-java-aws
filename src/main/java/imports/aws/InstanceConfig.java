...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.632Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.InstanceConfig")
...
public interface InstanceConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.InstanceCreditSpecification> getCreditSpecification() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.InstanceEbsBlockDevice> getEbsBlockDevice() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.InstanceEphemeralBlockDevice> getEphemeralBlockDevice() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.InstanceMetadataOptions> getMetadataOptions() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.InstanceNetworkInterface> getNetworkInterface() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.InstanceRootBlockDevice> getRootBlockDevice() {
        return null;
    }
     ...
     * timeouts block.
     */
    default @org.jetbrains.annotations.Nullable imports.aws.InstanceTimeouts getTimeouts() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<InstanceConfig> {
        ...
        private java.util.List<imports.aws.InstanceCreditSpecification> creditSpecification;
        private java.lang.Boolean disableApiTermination;
        private java.util.List<imports.aws.InstanceEbsBlockDevice> ebsBlockDevice;
        private java.lang.Boolean ebsOptimized;
        private java.util.List<imports.aws.InstanceEphemeralBlockDevice> ephemeralBlockDevice;
        ...
        private java.util.List<imports.aws.InstanceMetadataOptions> metadataOptions;
        private java.lang.Boolean monitoring;
        private java.util.List<imports.aws.InstanceNetworkInterface> networkInterface;
        private java.lang.String placementGroup;
        private java.lang.String privateIp;
        private java.util.List<imports.aws.InstanceRootBlockDevice> rootBlockDevice;
        ...
        private imports.aws.InstanceTimeouts timeouts;
        ...
        public Builder creditSpecification(java.util.List<? extends imports.aws.InstanceCreditSpecification> creditSpecification) {
            this.creditSpecification = (java.util.List<imports.aws.InstanceCreditSpecification>)creditSpecification;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder ebsBlockDevice(java.util.List<? extends imports.aws.InstanceEbsBlockDevice> ebsBlockDevice) {
            this.ebsBlockDevice = (java.util.List<imports.aws.InstanceEbsBlockDevice>)ebsBlockDevice;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder ephemeralBlockDevice(java.util.List<? extends imports.aws.InstanceEphemeralBlockDevice> ephemeralBlockDevice) {
            this.ephemeralBlockDevice = (java.util.List<imports.aws.InstanceEphemeralBlockDevice>)ephemeralBlockDevice;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder metadataOptions(java.util.List<? extends imports.aws.InstanceMetadataOptions> metadataOptions) {
            this.metadataOptions = (java.util.List<imports.aws.InstanceMetadataOptions>)metadataOptions;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder networkInterface(java.util.List<? extends imports.aws.InstanceNetworkInterface> networkInterface) {
            this.networkInterface = (java.util.List<imports.aws.InstanceNetworkInterface>)networkInterface;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder rootBlockDevice(java.util.List<? extends imports.aws.InstanceRootBlockDevice> rootBlockDevice) {
            this.rootBlockDevice = (java.util.List<imports.aws.InstanceRootBlockDevice>)rootBlockDevice;
            return this;
        }
         ...
         * @return {@code this}
         */
        public Builder timeouts(imports.aws.InstanceTimeouts timeouts) {
        ...
        public InstanceConfig build() {
            return new Jsii$Proxy(ami, instanceType, associatePublicIpAddress, availabilityZone, cpuCoreCount, cpuThreadsPerCore, creditSpecification, disableApiTermination, ebsBlockDevice, ebsOptimized, ephemeralBlockDevice, fetchPasswordData, hibernation, hostId, iamInstanceProfile, instanceInitiatedShutdownBehavior, ipv6AddressCount, ipv6Addresses, keyName, metadataOptions, monitoring, networkInterface, placementGroup, privateIp, rootBlockDevice, securityGroups, sourceDestCheck, subnetId, tags, tenancy, timeouts, userData, userDataBase64, volumeTags, vpcSecurityGroupIds, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements InstanceConfig {
        ...
        private final java.util.List<imports.aws.InstanceCreditSpecification> creditSpecification;
        private final java.lang.Boolean disableApiTermination;
        private final java.util.List<imports.aws.InstanceEbsBlockDevice> ebsBlockDevice;
        private final java.lang.Boolean ebsOptimized;
        private final java.util.List<imports.aws.InstanceEphemeralBlockDevice> ephemeralBlockDevice;
        ...
        private final java.util.List<imports.aws.InstanceMetadataOptions> metadataOptions;
        private final java.lang.Boolean monitoring;
        private final java.util.List<imports.aws.InstanceNetworkInterface> networkInterface;
        private final java.lang.String placementGroup;
        private final java.lang.String privateIp;
        private final java.util.List<imports.aws.InstanceRootBlockDevice> rootBlockDevice;
        ...
        private final imports.aws.InstanceTimeouts timeouts;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.creditSpecification = software.amazon.jsii.Kernel.get(this, "creditSpecification", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.InstanceCreditSpecification.class)));
            ...
            this.ebsBlockDevice = software.amazon.jsii.Kernel.get(this, "ebsBlockDevice", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.InstanceEbsBlockDevice.class)));
            ...
            this.ephemeralBlockDevice = software.amazon.jsii.Kernel.get(this, "ephemeralBlockDevice", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.InstanceEphemeralBlockDevice.class)));
            ...
            this.metadataOptions = software.amazon.jsii.Kernel.get(this, "metadataOptions", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.InstanceMetadataOptions.class)));
            ...
            this.networkInterface = software.amazon.jsii.Kernel.get(this, "networkInterface", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.InstanceNetworkInterface.class)));
            ...
            this.rootBlockDevice = software.amazon.jsii.Kernel.get(this, "rootBlockDevice", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.InstanceRootBlockDevice.class)));
            ...
            this.timeouts = software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.InstanceTimeouts.class));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String ami, final java.lang.String instanceType, final java.lang.Boolean associatePublicIpAddress, final java.lang.String availabilityZone, final java.lang.Number cpuCoreCount, final java.lang.Number cpuThreadsPerCore, final java.util.List<? extends imports.aws.InstanceCreditSpecification> creditSpecification, final java.lang.Boolean disableApiTermination, final java.util.List<? extends imports.aws.InstanceEbsBlockDevice> ebsBlockDevice, final java.lang.Boolean ebsOptimized, final java.util.List<? extends imports.aws.InstanceEphemeralBlockDevice> ephemeralBlockDevice, final java.lang.Boolean fetchPasswordData, final java.lang.Boolean hibernation, final java.lang.String hostId, final java.lang.String iamInstanceProfile, final java.lang.String instanceInitiatedShutdownBehavior, final java.lang.Number ipv6AddressCount, final java.util.List<java.lang.String> ipv6Addresses, final java.lang.String keyName, final java.util.List<? extends imports.aws.InstanceMetadataOptions> metadataOptions, final java.lang.Boolean monitoring, final java.util.List<? extends imports.aws.InstanceNetworkInterface> networkInterface, final java.lang.String placementGroup, final java.lang.String privateIp, final java.util.List<? extends imports.aws.InstanceRootBlockDevice> rootBlockDevice, final java.util.List<java.lang.String> securityGroups, final java.lang.Boolean sourceDestCheck, final java.lang.String subnetId, final java.util.Map<java.lang.String, java.lang.String> tags, final java.lang.String tenancy, final imports.aws.InstanceTimeouts timeouts, final java.lang.String userData, final java.lang.String userDataBase64, final java.util.Map<java.lang.String, java.lang.String> volumeTags, final java.util.List<java.lang.String> vpcSecurityGroupIds, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
        ...
        @Override
        public final java.util.List<imports.aws.InstanceCreditSpecification> getCreditSpecification() {
        ...
        @Override
        public final java.util.List<imports.aws.InstanceEbsBlockDevice> getEbsBlockDevice() {
        ...
        @Override
        public final java.util.List<imports.aws.InstanceEphemeralBlockDevice> getEphemeralBlockDevice() {
        ...
        @Override
        public final java.util.List<imports.aws.InstanceMetadataOptions> getMetadataOptions() {
        ...
        @Override
        public final java.util.List<imports.aws.InstanceNetworkInterface> getNetworkInterface() {
        ...
        @Override
        public final java.util.List<imports.aws.InstanceRootBlockDevice> getRootBlockDevice() {
        ...
        @Override
        public final imports.aws.InstanceTimeouts getTimeouts() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.InstanceConfig"));
