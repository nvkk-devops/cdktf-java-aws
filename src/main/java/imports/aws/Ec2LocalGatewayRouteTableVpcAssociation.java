...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.Ec2LocalGatewayRouteTableVpcAssociation")
public class Ec2LocalGatewayRouteTableVpcAssociation extends com.hashicorp.cdktf.TerraformResource {
    ...
    public Ec2LocalGatewayRouteTableVpcAssociation(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.Ec2LocalGatewayRouteTableVpcAssociationConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.Ec2LocalGatewayRouteTableVpcAssociation}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.Ec2LocalGatewayRouteTableVpcAssociation> {
        /**
        ...
        private final imports.aws.Ec2LocalGatewayRouteTableVpcAssociationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.Ec2LocalGatewayRouteTableVpcAssociationConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.Ec2LocalGatewayRouteTableVpcAssociation}.
         */
        @Override
        public imports.aws.Ec2LocalGatewayRouteTableVpcAssociation build() {
            return new imports.aws.Ec2LocalGatewayRouteTableVpcAssociation(
                this.scope,
                this.id,
                this.config.build()
            );
