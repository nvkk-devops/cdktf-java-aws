...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.SesReceiptRuleSet")
public class SesReceiptRuleSet extends com.hashicorp.cdktf.TerraformResource {
    ...
    public SesReceiptRuleSet(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.SesReceiptRuleSetConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.SesReceiptRuleSet}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.SesReceiptRuleSet> {
        /**
        ...
        private final imports.aws.SesReceiptRuleSetConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.SesReceiptRuleSetConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.SesReceiptRuleSet}.
         */
        @Override
        public imports.aws.SesReceiptRuleSet build() {
