...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.758Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.OpsworksPhpAppLayer")
public class OpsworksPhpAppLayer extends com.hashicorp.cdktf.TerraformResource {
    ...
    public OpsworksPhpAppLayer(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.OpsworksPhpAppLayerConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.OpsworksPhpAppLayerEbsVolume> getEbsVolumeInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.OpsworksPhpAppLayerEbsVolume>)(software.amazon.jsii.Kernel.get(this, "ebsVolumeInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.OpsworksPhpAppLayerEbsVolume.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.OpsworksPhpAppLayerEbsVolume> getEbsVolume() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "ebsVolume", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.OpsworksPhpAppLayerEbsVolume.class))));
    }

    public void setEbsVolume(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.OpsworksPhpAppLayerEbsVolume> value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.OpsworksPhpAppLayer}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.OpsworksPhpAppLayer> {
        /**
        ...
        private final imports.aws.OpsworksPhpAppLayerConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.OpsworksPhpAppLayerConfig.Builder();
        }
         ...
         */
        public Builder ebsVolume(final java.util.List<? extends imports.aws.OpsworksPhpAppLayerEbsVolume> ebsVolume) {
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.OpsworksPhpAppLayer}.
         */
        @Override
        public imports.aws.OpsworksPhpAppLayer build() {
            return new imports.aws.OpsworksPhpAppLayer(
                this.scope,
                this.id,
                this.config.build()
            );
