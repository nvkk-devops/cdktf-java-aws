...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.SagemakerEndpointConfigurationConfig")
...
public interface SagemakerEndpointConfigurationConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     */
    @org.jetbrains.annotations.NotNull java.util.List<imports.aws.SagemakerEndpointConfigurationProductionVariants> getProductionVariants();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<SagemakerEndpointConfigurationConfig> {
        private java.util.List<imports.aws.SagemakerEndpointConfigurationProductionVariants> productionVariants;
        ...
        public Builder productionVariants(java.util.List<? extends imports.aws.SagemakerEndpointConfigurationProductionVariants> productionVariants) {
            this.productionVariants = (java.util.List<imports.aws.SagemakerEndpointConfigurationProductionVariants>)productionVariants;
            return this;
        }
        ...
        public SagemakerEndpointConfigurationConfig build() {
            return new Jsii$Proxy(productionVariants, kmsKeyArn, name, tags, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SagemakerEndpointConfigurationConfig {
        private final java.util.List<imports.aws.SagemakerEndpointConfigurationProductionVariants> productionVariants;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.productionVariants = software.amazon.jsii.Kernel.get(this, "productionVariants", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.SagemakerEndpointConfigurationProductionVariants.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.aws.SagemakerEndpointConfigurationProductionVariants> productionVariants, final java.lang.String kmsKeyArn, final java.lang.String name, final java.util.Map<java.lang.String, java.lang.String> tags, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.productionVariants = (java.util.List<imports.aws.SagemakerEndpointConfigurationProductionVariants>)java.util.Objects.requireNonNull(productionVariants, "productionVariants is required");
            this.kmsKeyArn = kmsKeyArn;
            this.name = name;
            this.tags = tags;
            this.count = count;
        ...
        @Override
        public final java.util.List<imports.aws.SagemakerEndpointConfigurationProductionVariants> getProductionVariants() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.SagemakerEndpointConfigurationConfig"));
