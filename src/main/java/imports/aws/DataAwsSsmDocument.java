...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsSsmDocument")
public class DataAwsSsmDocument extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    public DataAwsSsmDocument(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DataAwsSsmDocumentConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DataAwsSsmDocument}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DataAwsSsmDocument> {
        /**
        ...
        private final imports.aws.DataAwsSsmDocumentConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DataAwsSsmDocumentConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DataAwsSsmDocument}.
         */
        @Override
        public imports.aws.DataAwsSsmDocument build() {
            return new imports.aws.DataAwsSsmDocument(
                this.scope,
                this.id,
                this.config.build()
            );
