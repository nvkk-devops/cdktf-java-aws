...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsLaunchTemplateBlockDeviceMappingsEbs")
public class DataAwsLaunchTemplateBlockDeviceMappingsEbs extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataAwsLaunchTemplateBlockDeviceMappingsEbs(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsLaunchTemplateBlockDeviceMappingsEbs(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DataAwsLaunchTemplateBlockDeviceMappingsEbs(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
