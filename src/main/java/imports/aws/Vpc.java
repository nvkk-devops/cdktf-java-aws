...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.Vpc")
public class Vpc extends com.hashicorp.cdktf.TerraformResource {
    ...
    public Vpc(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.VpcConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.lang.Boolean getAssignGeneratedIpv6CidrBlockInput() {
        return software.amazon.jsii.Kernel.get(this, "assignGeneratedIpv6CidrBlockInput", software.amazon.jsii.NativeType.forClass(java.lang.Boolean.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.Vpc}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.Vpc> {
        /**
        ...
        private final imports.aws.VpcConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.VpcConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param assignGeneratedIpv6CidrBlock This parameter is required.
         */
        ...
        /**
         * @return {@code this}
         * @param instanceTenancy This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.Vpc}.
         */
        @Override
        public imports.aws.Vpc build() {
            return new imports.aws.Vpc(
                this.scope,
                this.id,
                this.config.build()
            );
