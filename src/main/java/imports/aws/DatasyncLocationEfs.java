...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.395Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DatasyncLocationEfs")
public class DatasyncLocationEfs extends com.hashicorp.cdktf.TerraformResource {
    ...
    public DatasyncLocationEfs(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DatasyncLocationEfsConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.DatasyncLocationEfsEc2Config> getEc2ConfigInput() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "ec2ConfigInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.DatasyncLocationEfsEc2Config.class))));
    }

    public @org.jetbrains.annotations.NotNull java.lang.String getEfsFileSystemArnInput() {
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.DatasyncLocationEfsEc2Config> getEc2Config() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "ec2Config", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.DatasyncLocationEfsEc2Config.class))));
    }

    public void setEc2Config(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.DatasyncLocationEfsEc2Config> value) {
        software.amazon.jsii.Kernel.set(this, "ec2Config", java.util.Objects.requireNonNull(value, "ec2Config is required"));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.DatasyncLocationEfs}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DatasyncLocationEfs> {
        /**
        ...
        private final imports.aws.DatasyncLocationEfsConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DatasyncLocationEfsConfig.Builder();
        }
         ...
         */
        public Builder ec2Config(final java.util.List<? extends imports.aws.DatasyncLocationEfsEc2Config> ec2Config) {
        ...
        /**
         * @return {@code this}
         * @param efsFileSystemArn This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DatasyncLocationEfs}.
         */
        @Override
        public imports.aws.DatasyncLocationEfs build() {
            return new imports.aws.DatasyncLocationEfs(
                this.scope,
                this.id,
                this.config.build()
            );
