...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.753Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.OpsworksMysqlLayer")
public class OpsworksMysqlLayer extends com.hashicorp.cdktf.TerraformResource {
    ...
    public OpsworksMysqlLayer(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.OpsworksMysqlLayerConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.OpsworksMysqlLayerEbsVolume> getEbsVolumeInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.OpsworksMysqlLayerEbsVolume>)(software.amazon.jsii.Kernel.get(this, "ebsVolumeInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.OpsworksMysqlLayerEbsVolume.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.Nullable java.lang.Boolean getRootPasswordOnAllInstancesInput() {
        return software.amazon.jsii.Kernel.get(this, "rootPasswordOnAllInstancesInput", software.amazon.jsii.NativeType.forClass(java.lang.Boolean.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.OpsworksMysqlLayerEbsVolume> getEbsVolume() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "ebsVolume", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.OpsworksMysqlLayerEbsVolume.class))));
    }

    public void setEbsVolume(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.OpsworksMysqlLayerEbsVolume> value) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.Boolean getRootPasswordOnAllInstances() {
        return software.amazon.jsii.Kernel.get(this, "rootPasswordOnAllInstances", software.amazon.jsii.NativeType.forClass(java.lang.Boolean.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.OpsworksMysqlLayer}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.OpsworksMysqlLayer> {
        /**
        ...
        private final imports.aws.OpsworksMysqlLayerConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.OpsworksMysqlLayerConfig.Builder();
        }
         ...
         */
        public Builder ebsVolume(final java.util.List<? extends imports.aws.OpsworksMysqlLayerEbsVolume> ebsVolume) {
        ...
        /**
         * @return {@code this}
         * @param rootPassword This parameter is required.
         */
        ...
        /**
         * @return {@code this}
         * @param rootPasswordOnAllInstances This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.OpsworksMysqlLayer}.
         */
        @Override
        public imports.aws.OpsworksMysqlLayer build() {
            return new imports.aws.OpsworksMysqlLayer(
                this.scope,
                this.id,
                this.config.build()
            );
