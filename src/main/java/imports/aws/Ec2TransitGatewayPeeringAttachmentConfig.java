...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.Ec2TransitGatewayPeeringAttachmentConfig")
...
public interface Ec2TransitGatewayPeeringAttachmentConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<Ec2TransitGatewayPeeringAttachmentConfig> {
        ...
        private java.lang.String peerTransitGatewayId;
        private java.lang.String transitGatewayId;
        private java.lang.String peerAccountId;
         ...
         * @param peerRegion the value to be set. This parameter is required.
         * @return {@code this}
         */
         ...
         * @param peerTransitGatewayId the value to be set. This parameter is required.
         * @return {@code this}
         */
         ...
         * @param peerAccountId the value to be set.
         * @return {@code this}
         */
        ...
        public Ec2TransitGatewayPeeringAttachmentConfig build() {
            return new Jsii$Proxy(peerRegion, peerTransitGatewayId, transitGatewayId, peerAccountId, tags, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements Ec2TransitGatewayPeeringAttachmentConfig {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String peerRegion, final java.lang.String peerTransitGatewayId, final java.lang.String transitGatewayId, final java.lang.String peerAccountId, final java.util.Map<java.lang.String, java.lang.String> tags, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.peerRegion = java.util.Objects.requireNonNull(peerRegion, "peerRegion is required");
            this.peerTransitGatewayId = java.util.Objects.requireNonNull(peerTransitGatewayId, "peerTransitGatewayId is required");
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.Ec2TransitGatewayPeeringAttachmentConfig"));
