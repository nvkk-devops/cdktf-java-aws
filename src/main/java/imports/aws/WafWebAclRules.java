...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.WafWebAclRules")
...
public interface WafWebAclRules extends software.amazon.jsii.JsiiSerializable {
     ...
     * action block.
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.WafWebAclRulesAction> getAction() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.WafWebAclRulesOverrideAction> getOverrideAction() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<WafWebAclRules> {
        ...
        private java.util.List<imports.aws.WafWebAclRulesAction> action;
        private java.util.List<imports.aws.WafWebAclRulesOverrideAction> overrideAction;
        ...
        public Builder action(java.util.List<? extends imports.aws.WafWebAclRulesAction> action) {
            this.action = (java.util.List<imports.aws.WafWebAclRulesAction>)action;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder overrideAction(java.util.List<? extends imports.aws.WafWebAclRulesOverrideAction> overrideAction) {
            this.overrideAction = (java.util.List<imports.aws.WafWebAclRulesOverrideAction>)overrideAction;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements WafWebAclRules {
        ...
        private final java.util.List<imports.aws.WafWebAclRulesAction> action;
        private final java.util.List<imports.aws.WafWebAclRulesOverrideAction> overrideAction;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.action = software.amazon.jsii.Kernel.get(this, "action", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.WafWebAclRulesAction.class)));
            this.overrideAction = software.amazon.jsii.Kernel.get(this, "overrideAction", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.WafWebAclRulesOverrideAction.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.Number priority, final java.lang.String ruleId, final java.util.List<? extends imports.aws.WafWebAclRulesAction> action, final java.util.List<? extends imports.aws.WafWebAclRulesOverrideAction> overrideAction, final java.lang.String type) {
        ...
        @Override
        public final java.util.List<imports.aws.WafWebAclRulesAction> getAction() {
            return this.action;
        }

        @Override
        public final java.util.List<imports.aws.WafWebAclRulesOverrideAction> getOverrideAction() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.WafWebAclRules"));
