...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.IotPolicy")
public class IotPolicy extends com.hashicorp.cdktf.TerraformResource {
    ...
    public IotPolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.IotPolicyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.IotPolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.IotPolicy> {
        /**
        ...
        private final imports.aws.IotPolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.IotPolicyConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.IotPolicy}.
         */
        @Override
        public imports.aws.IotPolicy build() {
            return new imports.aws.IotPolicy(
                this.scope,
                this.id,
                this.config.build()
            );
