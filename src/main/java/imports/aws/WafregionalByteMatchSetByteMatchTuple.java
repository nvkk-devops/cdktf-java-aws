...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.WafregionalByteMatchSetByteMatchTuple")
@software.amazon.jsii.Jsii.Proxy(WafregionalByteMatchSetByteMatchTuple.Jsii$Proxy.class)
public interface WafregionalByteMatchSetByteMatchTuple extends software.amazon.jsii.JsiiSerializable {

    /**
     * field_to_match block.
     */
    @org.jetbrains.annotations.NotNull java.util.List<imports.aws.WafregionalByteMatchSetByteMatchTupleFieldToMatch> getFieldToMatch();
    ...
    /**
     * @return a {@link Builder} of {@link WafregionalByteMatchSetByteMatchTuple}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link WafregionalByteMatchSetByteMatchTuple}
     */
    public static final class Builder implements software.amazon.jsii.Builder<WafregionalByteMatchSetByteMatchTuple> {
        private java.util.List<imports.aws.WafregionalByteMatchSetByteMatchTupleFieldToMatch> fieldToMatch;
        ...
        /**
         * Sets the value of {@link WafregionalByteMatchSetByteMatchTuple#getFieldToMatch}
         * @param fieldToMatch field_to_match block. This parameter is required.
         * @return {@code this}
         */
        @SuppressWarnings("unchecked")
        public Builder fieldToMatch(java.util.List<? extends imports.aws.WafregionalByteMatchSetByteMatchTupleFieldToMatch> fieldToMatch) {
            this.fieldToMatch = (java.util.List<imports.aws.WafregionalByteMatchSetByteMatchTupleFieldToMatch>)fieldToMatch;
            return this;
        }

        /**
         * Sets the value of {@link WafregionalByteMatchSetByteMatchTuple#getPositionalConstraint}
        ...
        /**
         * Sets the value of {@link WafregionalByteMatchSetByteMatchTuple#getTextTransformation}
        ...
        /**
         * Sets the value of {@link WafregionalByteMatchSetByteMatchTuple#getTargetString}
         ...
         * @return a new instance of {@link WafregionalByteMatchSetByteMatchTuple}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public WafregionalByteMatchSetByteMatchTuple build() {
            return new Jsii$Proxy(fieldToMatch, positionalConstraint, textTransformation, targetString);
        }
    }

    /**
     * An implementation for {@link WafregionalByteMatchSetByteMatchTuple}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements WafregionalByteMatchSetByteMatchTuple {
        private final java.util.List<imports.aws.WafregionalByteMatchSetByteMatchTupleFieldToMatch> fieldToMatch;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.fieldToMatch = software.amazon.jsii.Kernel.get(this, "fieldToMatch", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.WafregionalByteMatchSetByteMatchTupleFieldToMatch.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.aws.WafregionalByteMatchSetByteMatchTupleFieldToMatch> fieldToMatch, final java.lang.String positionalConstraint, final java.lang.String textTransformation, final java.lang.String targetString) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.fieldToMatch = (java.util.List<imports.aws.WafregionalByteMatchSetByteMatchTupleFieldToMatch>)java.util.Objects.requireNonNull(fieldToMatch, "fieldToMatch is required");
        ...
        @Override
        public final java.util.List<imports.aws.WafregionalByteMatchSetByteMatchTupleFieldToMatch> getFieldToMatch() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.WafregionalByteMatchSetByteMatchTuple"));
        ...
        public final boolean equals(final Object o) {
            ...
            WafregionalByteMatchSetByteMatchTuple.Jsii$Proxy that = (WafregionalByteMatchSetByteMatchTuple.Jsii$Proxy) o;
