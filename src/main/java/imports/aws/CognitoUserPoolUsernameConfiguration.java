...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.CognitoUserPoolUsernameConfiguration")
...
public interface CognitoUserPoolUsernameConfiguration extends software.amazon.jsii.JsiiSerializable {
    ...
    @org.jetbrains.annotations.NotNull java.lang.Boolean getCaseSensitive();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<CognitoUserPoolUsernameConfiguration> {
         ...
         * @param caseSensitive the value to be set. This parameter is required.
         * @return {@code this}
         */
        ...
        public CognitoUserPoolUsernameConfiguration build() {
            return new Jsii$Proxy(caseSensitive);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CognitoUserPoolUsernameConfiguration {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.caseSensitive = software.amazon.jsii.Kernel.get(this, "caseSensitive", software.amazon.jsii.NativeType.forClass(java.lang.Boolean.class));
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        protected Jsii$Proxy(final java.lang.Boolean caseSensitive) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.caseSensitive = java.util.Objects.requireNonNull(caseSensitive, "caseSensitive is required");
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.CognitoUserPoolUsernameConfiguration"));
