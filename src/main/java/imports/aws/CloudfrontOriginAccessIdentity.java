...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.CloudfrontOriginAccessIdentity")
public class CloudfrontOriginAccessIdentity extends com.hashicorp.cdktf.TerraformResource {
    ...
    public CloudfrontOriginAccessIdentity(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.CloudfrontOriginAccessIdentityConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.CloudfrontOriginAccessIdentity}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.CloudfrontOriginAccessIdentity> {
        /**
        ...
        private imports.aws.CloudfrontOriginAccessIdentityConfig.Builder config;
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.CloudfrontOriginAccessIdentity}.
         */
        @Override
        public imports.aws.CloudfrontOriginAccessIdentity build() {
            return new imports.aws.CloudfrontOriginAccessIdentity(
                this.scope,
                this.id,
        ...
        private imports.aws.CloudfrontOriginAccessIdentityConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.CloudfrontOriginAccessIdentityConfig.Builder();
            }
            return this.config;
        }
    }
