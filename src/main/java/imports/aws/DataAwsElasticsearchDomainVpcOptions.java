...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsElasticsearchDomainVpcOptions")
public class DataAwsElasticsearchDomainVpcOptions extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataAwsElasticsearchDomainVpcOptions(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsElasticsearchDomainVpcOptions(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DataAwsElasticsearchDomainVpcOptions(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
