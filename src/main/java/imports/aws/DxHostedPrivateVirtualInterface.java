...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DxHostedPrivateVirtualInterface")
public class DxHostedPrivateVirtualInterface extends com.hashicorp.cdktf.TerraformResource {
    ...
    public DxHostedPrivateVirtualInterface(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DxHostedPrivateVirtualInterfaceConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getOwnerAccountIdInput() {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.DxHostedPrivateVirtualInterfaceTimeouts getTimeoutsInput() {
        return software.amazon.jsii.Kernel.get(this, "timeoutsInput", software.amazon.jsii.NativeType.forClass(imports.aws.DxHostedPrivateVirtualInterfaceTimeouts.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.DxHostedPrivateVirtualInterfaceTimeouts getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.DxHostedPrivateVirtualInterfaceTimeouts.class));
    }

    public void setTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.DxHostedPrivateVirtualInterfaceTimeouts value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DxHostedPrivateVirtualInterface}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DxHostedPrivateVirtualInterface> {
        /**
        ...
        private final imports.aws.DxHostedPrivateVirtualInterfaceConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DxHostedPrivateVirtualInterfaceConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param ownerAccountId This parameter is required.
         */
         ...
         */
        public Builder timeouts(final imports.aws.DxHostedPrivateVirtualInterfaceTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.DxHostedPrivateVirtualInterface}.
         */
        @Override
        public imports.aws.DxHostedPrivateVirtualInterface build() {
            return new imports.aws.DxHostedPrivateVirtualInterface(
                this.scope,
                this.id,
                this.config.build()
            );
