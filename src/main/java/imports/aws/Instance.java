...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.624Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.Instance")
public class Instance extends com.hashicorp.cdktf.TerraformResource {
    ...
    public Instance(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.InstanceConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.InstanceCreditSpecification> getCreditSpecificationInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.InstanceCreditSpecification>)(software.amazon.jsii.Kernel.get(this, "creditSpecificationInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.InstanceCreditSpecification.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.InstanceEbsBlockDevice> getEbsBlockDeviceInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.InstanceEbsBlockDevice>)(software.amazon.jsii.Kernel.get(this, "ebsBlockDeviceInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.InstanceEbsBlockDevice.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.InstanceEphemeralBlockDevice> getEphemeralBlockDeviceInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.InstanceEphemeralBlockDevice>)(software.amazon.jsii.Kernel.get(this, "ephemeralBlockDeviceInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.InstanceEphemeralBlockDevice.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.InstanceMetadataOptions> getMetadataOptionsInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.InstanceMetadataOptions>)(software.amazon.jsii.Kernel.get(this, "metadataOptionsInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.InstanceMetadataOptions.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.InstanceNetworkInterface> getNetworkInterfaceInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.InstanceNetworkInterface>)(software.amazon.jsii.Kernel.get(this, "networkInterfaceInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.InstanceNetworkInterface.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.InstanceRootBlockDevice> getRootBlockDeviceInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.InstanceRootBlockDevice>)(software.amazon.jsii.Kernel.get(this, "rootBlockDeviceInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.InstanceRootBlockDevice.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.InstanceTimeouts getTimeoutsInput() {
        return software.amazon.jsii.Kernel.get(this, "timeoutsInput", software.amazon.jsii.NativeType.forClass(imports.aws.InstanceTimeouts.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.InstanceCreditSpecification> getCreditSpecification() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "creditSpecification", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.InstanceCreditSpecification.class))));
    }

    public void setCreditSpecification(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.InstanceCreditSpecification> value) {
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.InstanceEbsBlockDevice> getEbsBlockDevice() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "ebsBlockDevice", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.InstanceEbsBlockDevice.class))));
    }

    public void setEbsBlockDevice(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.InstanceEbsBlockDevice> value) {
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.InstanceEphemeralBlockDevice> getEphemeralBlockDevice() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "ephemeralBlockDevice", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.InstanceEphemeralBlockDevice.class))));
    }

    public void setEphemeralBlockDevice(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.InstanceEphemeralBlockDevice> value) {
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.InstanceMetadataOptions> getMetadataOptions() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "metadataOptions", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.InstanceMetadataOptions.class))));
    }

    public void setMetadataOptions(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.InstanceMetadataOptions> value) {
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.InstanceNetworkInterface> getNetworkInterface() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "networkInterface", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.InstanceNetworkInterface.class))));
    }

    public void setNetworkInterface(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.InstanceNetworkInterface> value) {
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.InstanceRootBlockDevice> getRootBlockDevice() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "rootBlockDevice", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.InstanceRootBlockDevice.class))));
    }

    public void setRootBlockDevice(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.InstanceRootBlockDevice> value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.InstanceTimeouts getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.InstanceTimeouts.class));
    }

    public void setTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.InstanceTimeouts value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.Instance}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.Instance> {
        /**
        ...
        private final imports.aws.InstanceConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.InstanceConfig.Builder();
        }
         ...
         */
        public Builder creditSpecification(final java.util.List<? extends imports.aws.InstanceCreditSpecification> creditSpecification) {
         ...
         */
        public Builder ebsBlockDevice(final java.util.List<? extends imports.aws.InstanceEbsBlockDevice> ebsBlockDevice) {
         ...
         */
        public Builder ephemeralBlockDevice(final java.util.List<? extends imports.aws.InstanceEphemeralBlockDevice> ephemeralBlockDevice) {
         ...
         */
        public Builder metadataOptions(final java.util.List<? extends imports.aws.InstanceMetadataOptions> metadataOptions) {
         ...
         */
        public Builder networkInterface(final java.util.List<? extends imports.aws.InstanceNetworkInterface> networkInterface) {
         ...
         */
        public Builder rootBlockDevice(final java.util.List<? extends imports.aws.InstanceRootBlockDevice> rootBlockDevice) {
         ...
         */
        public Builder timeouts(final imports.aws.InstanceTimeouts timeouts) {
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.Instance}.
         */
        @Override
        public imports.aws.Instance build() {
            return new imports.aws.Instance(
                this.scope,
                this.id,
                this.config.build()
            );
