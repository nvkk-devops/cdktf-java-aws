...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DefaultRouteTable")
public class DefaultRouteTable extends com.hashicorp.cdktf.TerraformResource {
    ...
    public DefaultRouteTable(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DefaultRouteTableConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getDefaultRouteTableIdInput() {
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.DefaultRouteTableRoute> getRouteInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.DefaultRouteTableRoute>)(software.amazon.jsii.Kernel.get(this, "routeInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.DefaultRouteTableRoute.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.DefaultRouteTableRoute> getRoute() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "route", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.DefaultRouteTableRoute.class))));
    }

    public void setRoute(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.DefaultRouteTableRoute> value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DefaultRouteTable}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DefaultRouteTable> {
        /**
        ...
        private final imports.aws.DefaultRouteTableConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DefaultRouteTableConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param defaultRouteTableId This parameter is required.
         */
         ...
         */
        public Builder route(final java.util.List<? extends imports.aws.DefaultRouteTableRoute> route) {
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DefaultRouteTable}.
         */
        @Override
        public imports.aws.DefaultRouteTable build() {
            return new imports.aws.DefaultRouteTable(
                this.scope,
                this.id,
                this.config.build()
            );
