...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.OpsworksJavaAppLayer")
public class OpsworksJavaAppLayer extends com.hashicorp.cdktf.TerraformResource {
    ...
    public OpsworksJavaAppLayer(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.OpsworksJavaAppLayerConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.OpsworksJavaAppLayerEbsVolume> getEbsVolumeInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.OpsworksJavaAppLayerEbsVolume>)(software.amazon.jsii.Kernel.get(this, "ebsVolumeInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.OpsworksJavaAppLayerEbsVolume.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.OpsworksJavaAppLayerEbsVolume> getEbsVolume() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "ebsVolume", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.OpsworksJavaAppLayerEbsVolume.class))));
    }

    public void setEbsVolume(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.OpsworksJavaAppLayerEbsVolume> value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.OpsworksJavaAppLayer}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.OpsworksJavaAppLayer> {
        /**
        ...
        private final imports.aws.OpsworksJavaAppLayerConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.OpsworksJavaAppLayerConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param appServerVersion This parameter is required.
         */
         ...
         */
        public Builder ebsVolume(final java.util.List<? extends imports.aws.OpsworksJavaAppLayerEbsVolume> ebsVolume) {
        ...
        /**
         * @return {@code this}
         * @param jvmOptions This parameter is required.
         */
        ...
        /**
         * @return {@code this}
         * @param jvmType This parameter is required.
         */
        ...
        /**
         * @return {@code this}
         * @param jvmVersion This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.OpsworksJavaAppLayer}.
         */
        @Override
        public imports.aws.OpsworksJavaAppLayer build() {
            return new imports.aws.OpsworksJavaAppLayer(
                this.scope,
                this.id,
                this.config.build()
            );
