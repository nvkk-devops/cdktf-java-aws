...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.WafregionalSizeConstraintSetSizeConstraints")
...
public interface WafregionalSizeConstraintSetSizeConstraints extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull java.util.List<imports.aws.WafregionalSizeConstraintSetSizeConstraintsFieldToMatch> getFieldToMatch();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<WafregionalSizeConstraintSetSizeConstraints> {
        ...
        private java.util.List<imports.aws.WafregionalSizeConstraintSetSizeConstraintsFieldToMatch> fieldToMatch;
        ...
        public Builder fieldToMatch(java.util.List<? extends imports.aws.WafregionalSizeConstraintSetSizeConstraintsFieldToMatch> fieldToMatch) {
            this.fieldToMatch = (java.util.List<imports.aws.WafregionalSizeConstraintSetSizeConstraintsFieldToMatch>)fieldToMatch;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements WafregionalSizeConstraintSetSizeConstraints {
        ...
        private final java.util.List<imports.aws.WafregionalSizeConstraintSetSizeConstraintsFieldToMatch> fieldToMatch;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.fieldToMatch = software.amazon.jsii.Kernel.get(this, "fieldToMatch", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.WafregionalSizeConstraintSetSizeConstraintsFieldToMatch.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String comparisonOperator, final java.util.List<? extends imports.aws.WafregionalSizeConstraintSetSizeConstraintsFieldToMatch> fieldToMatch, final java.lang.Number size, final java.lang.String textTransformation) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.comparisonOperator = java.util.Objects.requireNonNull(comparisonOperator, "comparisonOperator is required");
            this.fieldToMatch = (java.util.List<imports.aws.WafregionalSizeConstraintSetSizeConstraintsFieldToMatch>)java.util.Objects.requireNonNull(fieldToMatch, "fieldToMatch is required");
        ...
        @Override
        public final java.util.List<imports.aws.WafregionalSizeConstraintSetSizeConstraintsFieldToMatch> getFieldToMatch() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.WafregionalSizeConstraintSetSizeConstraints"));
