...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsOutpostsOutpost")
public class DataAwsOutpostsOutpost extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    public DataAwsOutpostsOutpost(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.DataAwsOutpostsOutpostConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DataAwsOutpostsOutpost}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DataAwsOutpostsOutpost> {
        /**
        ...
        private imports.aws.DataAwsOutpostsOutpostConfig.Builder config;
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DataAwsOutpostsOutpost}.
         */
        @Override
        public imports.aws.DataAwsOutpostsOutpost build() {
            return new imports.aws.DataAwsOutpostsOutpost(
                this.scope,
                this.id,
        ...
        private imports.aws.DataAwsOutpostsOutpostConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.DataAwsOutpostsOutpostConfig.Builder();
            }
            return this.config;
        }
    }
