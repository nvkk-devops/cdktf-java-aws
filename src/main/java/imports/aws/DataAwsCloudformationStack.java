...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.246Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsCloudformationStack")
public class DataAwsCloudformationStack extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    public DataAwsCloudformationStack(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DataAwsCloudformationStackConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DataAwsCloudformationStack}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DataAwsCloudformationStack> {
        /**
        ...
        private final imports.aws.DataAwsCloudformationStackConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DataAwsCloudformationStackConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DataAwsCloudformationStack}.
         */
        @Override
        public imports.aws.DataAwsCloudformationStack build() {
            return new imports.aws.DataAwsCloudformationStack(
                this.scope,
                this.id,
                this.config.build()
            );
