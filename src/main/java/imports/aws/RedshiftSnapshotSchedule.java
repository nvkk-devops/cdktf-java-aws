...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.RedshiftSnapshotSchedule")
public class RedshiftSnapshotSchedule extends com.hashicorp.cdktf.TerraformResource {
    ...
    public RedshiftSnapshotSchedule(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.RedshiftSnapshotScheduleConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<java.lang.String> getDefinitionsInput() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "definitionsInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(java.lang.String.class))));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.RedshiftSnapshotSchedule}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.RedshiftSnapshotSchedule> {
        /**
        ...
        private final imports.aws.RedshiftSnapshotScheduleConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.RedshiftSnapshotScheduleConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param definitions This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.RedshiftSnapshotSchedule}.
         */
        @Override
        public imports.aws.RedshiftSnapshotSchedule build() {
            return new imports.aws.RedshiftSnapshotSchedule(
                this.scope,
                this.id,
                this.config.build()
            );
