...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DaxCluster")
public class DaxCluster extends com.hashicorp.cdktf.TerraformResource {
    ...
    public DaxCluster(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DaxClusterConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public @org.jetbrains.annotations.NotNull imports.aws.DaxClusterNodes nodes(final @org.jetbrains.annotations.NotNull java.lang.String index) {
        return software.amazon.jsii.Kernel.call(this, "nodes", software.amazon.jsii.NativeType.forClass(imports.aws.DaxClusterNodes.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public @org.jetbrains.annotations.NotNull java.lang.Number getReplicationFactorInput() {
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.DaxClusterServerSideEncryption> getServerSideEncryptionInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.DaxClusterServerSideEncryption>)(software.amazon.jsii.Kernel.get(this, "serverSideEncryptionInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.DaxClusterServerSideEncryption.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.DaxClusterTimeouts getTimeoutsInput() {
        return software.amazon.jsii.Kernel.get(this, "timeoutsInput", software.amazon.jsii.NativeType.forClass(imports.aws.DaxClusterTimeouts.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.DaxClusterServerSideEncryption> getServerSideEncryption() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "serverSideEncryption", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.DaxClusterServerSideEncryption.class))));
    }

    public void setServerSideEncryption(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.DaxClusterServerSideEncryption> value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.DaxClusterTimeouts getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.DaxClusterTimeouts.class));
    }

    public void setTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.DaxClusterTimeouts value) {
        software.amazon.jsii.Kernel.set(this, "timeouts", java.util.Objects.requireNonNull(value, "timeouts is required"));
    }

    /**
     * A fluent builder for {@link imports.aws.DaxCluster}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DaxCluster> {
        /**
        ...
        private final imports.aws.DaxClusterConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DaxClusterConfig.Builder();
        }
         ...
         */
        public Builder serverSideEncryption(final java.util.List<? extends imports.aws.DaxClusterServerSideEncryption> serverSideEncryption) {
         ...
         */
        public Builder timeouts(final imports.aws.DaxClusterTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.DaxCluster}.
         */
        @Override
        public imports.aws.DaxCluster build() {
            return new imports.aws.DaxCluster(
                this.scope,
                this.id,
                this.config.build()
            );
