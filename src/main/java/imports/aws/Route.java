...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.Route")
public class Route extends com.hashicorp.cdktf.TerraformResource {
    ...
    public Route(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.RouteConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.RouteTimeouts getTimeoutsInput() {
        return software.amazon.jsii.Kernel.get(this, "timeoutsInput", software.amazon.jsii.NativeType.forClass(imports.aws.RouteTimeouts.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.RouteTimeouts getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.RouteTimeouts.class));
    }

    public void setTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.RouteTimeouts value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.Route}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.Route> {
        /**
        ...
        private final imports.aws.RouteConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.RouteConfig.Builder();
        }
         ...
         */
        public Builder timeouts(final imports.aws.RouteTimeouts timeouts) {
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.Route}.
         */
        @Override
        public imports.aws.Route build() {
            return new imports.aws.Route(
                this.scope,
                this.id,
                this.config.build()
            );
