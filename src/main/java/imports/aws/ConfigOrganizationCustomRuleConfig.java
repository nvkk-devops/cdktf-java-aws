...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.206Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.ConfigOrganizationCustomRuleConfig")
...
public interface ConfigOrganizationCustomRuleConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     * timeouts block.
     */
    default @org.jetbrains.annotations.Nullable imports.aws.ConfigOrganizationCustomRuleTimeouts getTimeouts() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ConfigOrganizationCustomRuleConfig> {
        ...
        private java.util.List<java.lang.String> triggerTypes;
        ...
        private imports.aws.ConfigOrganizationCustomRuleTimeouts timeouts;
         ...
         * @param lambdaFunctionArn the value to be set. This parameter is required.
         * @return {@code this}
         */
         ...
         * @param triggerTypes the value to be set. This parameter is required.
         * @return {@code this}
         */
         ...
         * @return {@code this}
         */
        public Builder timeouts(imports.aws.ConfigOrganizationCustomRuleTimeouts timeouts) {
        ...
        public ConfigOrganizationCustomRuleConfig build() {
            return new Jsii$Proxy(lambdaFunctionArn, name, triggerTypes, description, excludedAccounts, inputParameters, maximumExecutionFrequency, resourceIdScope, resourceTypesScope, tagKeyScope, tagValueScope, timeouts, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ConfigOrganizationCustomRuleConfig {
        ...
        private final imports.aws.ConfigOrganizationCustomRuleTimeouts timeouts;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.timeouts = software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.ConfigOrganizationCustomRuleTimeouts.class));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String lambdaFunctionArn, final java.lang.String name, final java.util.List<java.lang.String> triggerTypes, final java.lang.String description, final java.util.List<java.lang.String> excludedAccounts, final java.lang.String inputParameters, final java.lang.String maximumExecutionFrequency, final java.lang.String resourceIdScope, final java.util.List<java.lang.String> resourceTypesScope, final java.lang.String tagKeyScope, final java.lang.String tagValueScope, final imports.aws.ConfigOrganizationCustomRuleTimeouts timeouts, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.lambdaFunctionArn = java.util.Objects.requireNonNull(lambdaFunctionArn, "lambdaFunctionArn is required");
            this.name = java.util.Objects.requireNonNull(name, "name is required");
            this.triggerTypes = java.util.Objects.requireNonNull(triggerTypes, "triggerTypes is required");
            this.description = description;
            this.excludedAccounts = excludedAccounts;
            this.inputParameters = inputParameters;
            this.maximumExecutionFrequency = maximumExecutionFrequency;
        ...
        @Override
        public final imports.aws.ConfigOrganizationCustomRuleTimeouts getTimeouts() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.ConfigOrganizationCustomRuleConfig"));
