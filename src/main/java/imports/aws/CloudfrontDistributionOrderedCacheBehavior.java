...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.CloudfrontDistributionOrderedCacheBehavior")
...
public interface CloudfrontDistributionOrderedCacheBehavior extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull java.util.List<imports.aws.CloudfrontDistributionOrderedCacheBehaviorForwardedValues> getForwardedValues();
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.CloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociation> getLambdaFunctionAssociation() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<CloudfrontDistributionOrderedCacheBehavior> {
        ...
        private java.util.List<imports.aws.CloudfrontDistributionOrderedCacheBehaviorForwardedValues> forwardedValues;
        ...
        private java.util.List<imports.aws.CloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociation> lambdaFunctionAssociation;
        ...
        public Builder forwardedValues(java.util.List<? extends imports.aws.CloudfrontDistributionOrderedCacheBehaviorForwardedValues> forwardedValues) {
            this.forwardedValues = (java.util.List<imports.aws.CloudfrontDistributionOrderedCacheBehaviorForwardedValues>)forwardedValues;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder lambdaFunctionAssociation(java.util.List<? extends imports.aws.CloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociation> lambdaFunctionAssociation) {
            this.lambdaFunctionAssociation = (java.util.List<imports.aws.CloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociation>)lambdaFunctionAssociation;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CloudfrontDistributionOrderedCacheBehavior {
        ...
        private final java.util.List<imports.aws.CloudfrontDistributionOrderedCacheBehaviorForwardedValues> forwardedValues;
        ...
        private final java.util.List<imports.aws.CloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociation> lambdaFunctionAssociation;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.forwardedValues = software.amazon.jsii.Kernel.get(this, "forwardedValues", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.CloudfrontDistributionOrderedCacheBehaviorForwardedValues.class)));
            ...
            this.lambdaFunctionAssociation = software.amazon.jsii.Kernel.get(this, "lambdaFunctionAssociation", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.CloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociation.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<java.lang.String> allowedMethods, final java.util.List<java.lang.String> cachedMethods, final java.util.List<? extends imports.aws.CloudfrontDistributionOrderedCacheBehaviorForwardedValues> forwardedValues, final java.lang.String pathPattern, final java.lang.String targetOriginId, final java.lang.String viewerProtocolPolicy, final java.lang.Boolean compress, final java.lang.Number defaultTtl, final java.lang.String fieldLevelEncryptionId, final java.util.List<? extends imports.aws.CloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociation> lambdaFunctionAssociation, final java.lang.Number maxTtl, final java.lang.Number minTtl, final java.lang.Boolean smoothStreaming, final java.util.List<java.lang.String> trustedSigners) {
            ...
            this.forwardedValues = (java.util.List<imports.aws.CloudfrontDistributionOrderedCacheBehaviorForwardedValues>)java.util.Objects.requireNonNull(forwardedValues, "forwardedValues is required");
        ...
        @Override
        public final java.util.List<imports.aws.CloudfrontDistributionOrderedCacheBehaviorForwardedValues> getForwardedValues() {
        ...
        @Override
        public final java.util.List<imports.aws.CloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociation> getLambdaFunctionAssociation() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.CloudfrontDistributionOrderedCacheBehavior"));
