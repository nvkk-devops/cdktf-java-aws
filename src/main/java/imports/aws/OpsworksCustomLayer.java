...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.OpsworksCustomLayer")
public class OpsworksCustomLayer extends com.hashicorp.cdktf.TerraformResource {
    ...
    public OpsworksCustomLayer(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.OpsworksCustomLayerConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getShortNameInput() {
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.OpsworksCustomLayerEbsVolume> getEbsVolumeInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.OpsworksCustomLayerEbsVolume>)(software.amazon.jsii.Kernel.get(this, "ebsVolumeInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.OpsworksCustomLayerEbsVolume.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.OpsworksCustomLayerEbsVolume> getEbsVolume() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "ebsVolume", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.OpsworksCustomLayerEbsVolume.class))));
    }

    public void setEbsVolume(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.OpsworksCustomLayerEbsVolume> value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.OpsworksCustomLayer}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.OpsworksCustomLayer> {
        /**
        ...
        private final imports.aws.OpsworksCustomLayerConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.OpsworksCustomLayerConfig.Builder();
        }
         ...
         */
        public Builder ebsVolume(final java.util.List<? extends imports.aws.OpsworksCustomLayerEbsVolume> ebsVolume) {
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.OpsworksCustomLayer}.
         */
        @Override
        public imports.aws.OpsworksCustomLayer build() {
            return new imports.aws.OpsworksCustomLayer(
                this.scope,
                this.id,
                this.config.build()
            );
