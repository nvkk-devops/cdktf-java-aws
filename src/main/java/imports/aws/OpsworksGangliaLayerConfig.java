...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.743Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.OpsworksGangliaLayerConfig")
...
public interface OpsworksGangliaLayerConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     * ebs_volume block.
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.OpsworksGangliaLayerEbsVolume> getEbsVolume() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<OpsworksGangliaLayerConfig> {
        ...
        private java.util.List<imports.aws.OpsworksGangliaLayerEbsVolume> ebsVolume;
        ...
        public Builder ebsVolume(java.util.List<? extends imports.aws.OpsworksGangliaLayerEbsVolume> ebsVolume) {
            this.ebsVolume = (java.util.List<imports.aws.OpsworksGangliaLayerEbsVolume>)ebsVolume;
            return this;
        }
        ...
        public OpsworksGangliaLayerConfig build() {
            return new Jsii$Proxy(password, stackId, autoAssignElasticIps, autoAssignPublicIps, autoHealing, customConfigureRecipes, customDeployRecipes, customInstanceProfileArn, customJson, customSecurityGroupIds, customSetupRecipes, customShutdownRecipes, customUndeployRecipes, drainElbOnShutdown, ebsVolume, elasticLoadBalancer, installUpdatesOnBoot, instanceShutdownTimeout, name, systemPackages, tags, url, useEbsOptimizedInstances, username, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements OpsworksGangliaLayerConfig {
        ...
        private final java.util.List<imports.aws.OpsworksGangliaLayerEbsVolume> ebsVolume;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.ebsVolume = software.amazon.jsii.Kernel.get(this, "ebsVolume", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.OpsworksGangliaLayerEbsVolume.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String password, final java.lang.String stackId, final java.lang.Boolean autoAssignElasticIps, final java.lang.Boolean autoAssignPublicIps, final java.lang.Boolean autoHealing, final java.util.List<java.lang.String> customConfigureRecipes, final java.util.List<java.lang.String> customDeployRecipes, final java.lang.String customInstanceProfileArn, final java.lang.String customJson, final java.util.List<java.lang.String> customSecurityGroupIds, final java.util.List<java.lang.String> customSetupRecipes, final java.util.List<java.lang.String> customShutdownRecipes, final java.util.List<java.lang.String> customUndeployRecipes, final java.lang.Boolean drainElbOnShutdown, final java.util.List<? extends imports.aws.OpsworksGangliaLayerEbsVolume> ebsVolume, final java.lang.String elasticLoadBalancer, final java.lang.Boolean installUpdatesOnBoot, final java.lang.Number instanceShutdownTimeout, final java.lang.String name, final java.util.List<java.lang.String> systemPackages, final java.util.Map<java.lang.String, java.lang.String> tags, final java.lang.String url, final java.lang.Boolean useEbsOptimizedInstances, final java.lang.String username, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
        ...
        @Override
        public final java.util.List<imports.aws.OpsworksGangliaLayerEbsVolume> getEbsVolume() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.OpsworksGangliaLayerConfig"));
