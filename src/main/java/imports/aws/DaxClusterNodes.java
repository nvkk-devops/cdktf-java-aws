...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DaxClusterNodes")
public class DaxClusterNodes extends com.hashicorp.cdktf.ComplexComputedList {

    protected DaxClusterNodes(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DaxClusterNodes(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DaxClusterNodes(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
