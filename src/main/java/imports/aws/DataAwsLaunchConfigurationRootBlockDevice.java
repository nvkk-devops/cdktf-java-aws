...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsLaunchConfigurationRootBlockDevice")
public class DataAwsLaunchConfigurationRootBlockDevice extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataAwsLaunchConfigurationRootBlockDevice(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsLaunchConfigurationRootBlockDevice(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DataAwsLaunchConfigurationRootBlockDevice(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
