...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DatasyncLocationSmb")
public class DatasyncLocationSmb extends com.hashicorp.cdktf.TerraformResource {
    ...
    public DatasyncLocationSmb(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DatasyncLocationSmbConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<java.lang.String> getAgentArnsInput() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "agentArnsInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(java.lang.String.class))));
    }
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.DatasyncLocationSmbMountOptions> getMountOptionsInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.DatasyncLocationSmbMountOptions>)(software.amazon.jsii.Kernel.get(this, "mountOptionsInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.DatasyncLocationSmbMountOptions.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.DatasyncLocationSmbMountOptions> getMountOptions() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "mountOptions", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.DatasyncLocationSmbMountOptions.class))));
    }

    public void setMountOptions(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.DatasyncLocationSmbMountOptions> value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DatasyncLocationSmb}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DatasyncLocationSmb> {
        /**
        ...
        private final imports.aws.DatasyncLocationSmbConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DatasyncLocationSmbConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param agentArns This parameter is required.
         */
         ...
         */
        public Builder mountOptions(final java.util.List<? extends imports.aws.DatasyncLocationSmbMountOptions> mountOptions) {
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DatasyncLocationSmb}.
         */
        @Override
        public imports.aws.DatasyncLocationSmb build() {
            return new imports.aws.DatasyncLocationSmb(
                this.scope,
                this.id,
                this.config.build()
            );
