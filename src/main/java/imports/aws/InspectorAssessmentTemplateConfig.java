...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.InspectorAssessmentTemplateConfig")
...
public interface InspectorAssessmentTemplateConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<InspectorAssessmentTemplateConfig> {
         ...
         * @param rulesPackageArns the value to be set. This parameter is required.
         * @return {@code this}
         */
        ...
        public InspectorAssessmentTemplateConfig build() {
            return new Jsii$Proxy(duration, name, rulesPackageArns, targetArn, tags, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements InspectorAssessmentTemplateConfig {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.Number duration, final java.lang.String name, final java.util.List<java.lang.String> rulesPackageArns, final java.lang.String targetArn, final java.util.Map<java.lang.String, java.lang.String> tags, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.duration = java.util.Objects.requireNonNull(duration, "duration is required");
            this.name = java.util.Objects.requireNonNull(name, "name is required");
            this.rulesPackageArns = java.util.Objects.requireNonNull(rulesPackageArns, "rulesPackageArns is required");
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.InspectorAssessmentTemplateConfig"));
