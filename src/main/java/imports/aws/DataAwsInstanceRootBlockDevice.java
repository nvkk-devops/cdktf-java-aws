...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsInstanceRootBlockDevice")
public class DataAwsInstanceRootBlockDevice extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataAwsInstanceRootBlockDevice(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsInstanceRootBlockDevice(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DataAwsInstanceRootBlockDevice(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
