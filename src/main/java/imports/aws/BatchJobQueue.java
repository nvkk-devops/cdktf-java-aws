...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.BatchJobQueue")
public class BatchJobQueue extends com.hashicorp.cdktf.TerraformResource {
    ...
    public BatchJobQueue(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.BatchJobQueueConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<java.lang.String> getComputeEnvironmentsInput() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "computeEnvironmentsInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(java.lang.String.class))));
    }
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getStateInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.BatchJobQueue}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.BatchJobQueue> {
        /**
        ...
        private final imports.aws.BatchJobQueueConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.BatchJobQueueConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param computeEnvironments This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.BatchJobQueue}.
         */
        @Override
        public imports.aws.BatchJobQueue build() {
            return new imports.aws.BatchJobQueue(
                this.scope,
                this.id,
                this.config.build()
            );
