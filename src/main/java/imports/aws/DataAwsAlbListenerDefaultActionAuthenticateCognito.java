...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.220Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsAlbListenerDefaultActionAuthenticateCognito")
public class DataAwsAlbListenerDefaultActionAuthenticateCognito extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataAwsAlbListenerDefaultActionAuthenticateCognito(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsAlbListenerDefaultActionAuthenticateCognito(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DataAwsAlbListenerDefaultActionAuthenticateCognito(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
