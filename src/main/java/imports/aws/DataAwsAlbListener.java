...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsAlbListener")
public class DataAwsAlbListener extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    public DataAwsAlbListener(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.DataAwsAlbListenerConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.DataAwsAlbListenerDefaultAction defaultAction(final @org.jetbrains.annotations.NotNull java.lang.String index) {
        return software.amazon.jsii.Kernel.call(this, "defaultAction", software.amazon.jsii.NativeType.forClass(imports.aws.DataAwsAlbListenerDefaultAction.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.DataAwsAlbListener}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DataAwsAlbListener> {
        /**
        ...
        private imports.aws.DataAwsAlbListenerConfig.Builder config;
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DataAwsAlbListener}.
         */
        @Override
        public imports.aws.DataAwsAlbListener build() {
            return new imports.aws.DataAwsAlbListener(
                this.scope,
                this.id,
        ...
        private imports.aws.DataAwsAlbListenerConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.DataAwsAlbListenerConfig.Builder();
            }
            return this.config;
        }
    }
