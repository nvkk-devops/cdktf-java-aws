...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.229Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsApiGatewayResource")
public class DataAwsApiGatewayResource extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    public DataAwsApiGatewayResource(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DataAwsApiGatewayResourceConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getPathInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.DataAwsApiGatewayResource}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DataAwsApiGatewayResource> {
        /**
        ...
        private final imports.aws.DataAwsApiGatewayResourceConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DataAwsApiGatewayResourceConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DataAwsApiGatewayResource}.
         */
        @Override
        public imports.aws.DataAwsApiGatewayResource build() {
            return new imports.aws.DataAwsApiGatewayResource(
                this.scope,
                this.id,
                this.config.build()
            );
