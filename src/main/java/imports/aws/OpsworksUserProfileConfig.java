...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.776Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.OpsworksUserProfileConfig")
...
public interface OpsworksUserProfileConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
    ...
    default @org.jetbrains.annotations.Nullable java.lang.Boolean getAllowSelfManagement() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<OpsworksUserProfileConfig> {
         ...
         * @param sshUsername the value to be set. This parameter is required.
         * @return {@code this}
         */
         ...
         * @param allowSelfManagement the value to be set.
         * @return {@code this}
         */
         ...
         * @param sshPublicKey the value to be set.
         * @return {@code this}
         */
        ...
        public OpsworksUserProfileConfig build() {
            return new Jsii$Proxy(sshUsername, userArn, allowSelfManagement, sshPublicKey, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements OpsworksUserProfileConfig {
        ...
        private final java.lang.Boolean allowSelfManagement;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.allowSelfManagement = software.amazon.jsii.Kernel.get(this, "allowSelfManagement", software.amazon.jsii.NativeType.forClass(java.lang.Boolean.class));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String sshUsername, final java.lang.String userArn, final java.lang.Boolean allowSelfManagement, final java.lang.String sshPublicKey, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.sshUsername = java.util.Objects.requireNonNull(sshUsername, "sshUsername is required");
        ...
        @Override
        public final java.lang.Boolean getAllowSelfManagement() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.OpsworksUserProfileConfig"));
