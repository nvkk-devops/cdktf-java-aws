...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.S3BucketReplicationConfiguration")
...
public interface S3BucketReplicationConfiguration extends software.amazon.jsii.JsiiSerializable {
     ...
     * rules block.
     */
    @org.jetbrains.annotations.NotNull java.util.List<imports.aws.S3BucketReplicationConfigurationRules> getRules();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<S3BucketReplicationConfiguration> {
        ...
        private java.util.List<imports.aws.S3BucketReplicationConfigurationRules> rules;
        ...
        public Builder rules(java.util.List<? extends imports.aws.S3BucketReplicationConfigurationRules> rules) {
            this.rules = (java.util.List<imports.aws.S3BucketReplicationConfigurationRules>)rules;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements S3BucketReplicationConfiguration {
        ...
        private final java.util.List<imports.aws.S3BucketReplicationConfigurationRules> rules;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.rules = software.amazon.jsii.Kernel.get(this, "rules", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.S3BucketReplicationConfigurationRules.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String role, final java.util.List<? extends imports.aws.S3BucketReplicationConfigurationRules> rules) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.role = java.util.Objects.requireNonNull(role, "role is required");
            this.rules = (java.util.List<imports.aws.S3BucketReplicationConfigurationRules>)java.util.Objects.requireNonNull(rules, "rules is required");
        }
        ...
        @Override
        public final java.util.List<imports.aws.S3BucketReplicationConfigurationRules> getRules() {
            return this.rules;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.S3BucketReplicationConfiguration"));
