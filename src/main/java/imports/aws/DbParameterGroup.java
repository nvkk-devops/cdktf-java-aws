...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DbParameterGroup")
public class DbParameterGroup extends com.hashicorp.cdktf.TerraformResource {
    ...
    public DbParameterGroup(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DbParameterGroupConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.DbParameterGroupParameter> getParameterInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.DbParameterGroupParameter>)(software.amazon.jsii.Kernel.get(this, "parameterInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.DbParameterGroupParameter.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.DbParameterGroupParameter> getParameter() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "parameter", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.DbParameterGroupParameter.class))));
    }

    public void setParameter(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.DbParameterGroupParameter> value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DbParameterGroup}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DbParameterGroup> {
        /**
        ...
        private final imports.aws.DbParameterGroupConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DbParameterGroupConfig.Builder();
        }
         ...
         */
        public Builder parameter(final java.util.List<? extends imports.aws.DbParameterGroupParameter> parameter) {
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DbParameterGroup}.
         */
        @Override
        public imports.aws.DbParameterGroup build() {
            return new imports.aws.DbParameterGroup(
                this.scope,
                this.id,
                this.config.build()
            );
