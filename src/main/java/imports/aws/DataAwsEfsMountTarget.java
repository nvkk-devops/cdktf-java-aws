...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsEfsMountTarget")
public class DataAwsEfsMountTarget extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    public DataAwsEfsMountTarget(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DataAwsEfsMountTargetConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getMountTargetIdInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.DataAwsEfsMountTarget}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DataAwsEfsMountTarget> {
        /**
        ...
        private final imports.aws.DataAwsEfsMountTargetConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DataAwsEfsMountTargetConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param mountTargetId This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DataAwsEfsMountTarget}.
         */
        @Override
        public imports.aws.DataAwsEfsMountTarget build() {
            return new imports.aws.DataAwsEfsMountTarget(
                this.scope,
                this.id,
                this.config.build()
            );
