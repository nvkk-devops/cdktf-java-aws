...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.CloudwatchLogDestination")
public class CloudwatchLogDestination extends com.hashicorp.cdktf.TerraformResource {
    ...
    public CloudwatchLogDestination(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.CloudwatchLogDestinationConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getTargetArnInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.CloudwatchLogDestination}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.CloudwatchLogDestination> {
        /**
        ...
        private final imports.aws.CloudwatchLogDestinationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.CloudwatchLogDestinationConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param targetArn This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.CloudwatchLogDestination}.
         */
        @Override
        public imports.aws.CloudwatchLogDestination build() {
            return new imports.aws.CloudwatchLogDestination(
                this.scope,
                this.id,
                this.config.build()
            );
