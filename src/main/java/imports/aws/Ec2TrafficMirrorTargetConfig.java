...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.Ec2TrafficMirrorTargetConfig")
...
public interface Ec2TrafficMirrorTargetConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<Ec2TrafficMirrorTargetConfig> {
        ...
        private java.lang.String networkLoadBalancerArn;
         ...
         * @param networkLoadBalancerArn the value to be set.
         * @return {@code this}
         */
        ...
        public Ec2TrafficMirrorTargetConfig build() {
            return new Jsii$Proxy(description, networkInterfaceId, networkLoadBalancerArn, tags, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements Ec2TrafficMirrorTargetConfig {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String description, final java.lang.String networkInterfaceId, final java.lang.String networkLoadBalancerArn, final java.util.Map<java.lang.String, java.lang.String> tags, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.Ec2TrafficMirrorTargetConfig"));
