...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DxHostedPublicVirtualInterface")
public class DxHostedPublicVirtualInterface extends com.hashicorp.cdktf.TerraformResource {
    ...
    public DxHostedPublicVirtualInterface(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DxHostedPublicVirtualInterfaceConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.DxHostedPublicVirtualInterfaceTimeouts getTimeoutsInput() {
        return software.amazon.jsii.Kernel.get(this, "timeoutsInput", software.amazon.jsii.NativeType.forClass(imports.aws.DxHostedPublicVirtualInterfaceTimeouts.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.DxHostedPublicVirtualInterfaceTimeouts getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.DxHostedPublicVirtualInterfaceTimeouts.class));
    }

    public void setTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.DxHostedPublicVirtualInterfaceTimeouts value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DxHostedPublicVirtualInterface}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DxHostedPublicVirtualInterface> {
        /**
        ...
        private final imports.aws.DxHostedPublicVirtualInterfaceConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DxHostedPublicVirtualInterfaceConfig.Builder();
        }
         ...
         */
        public Builder timeouts(final imports.aws.DxHostedPublicVirtualInterfaceTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.DxHostedPublicVirtualInterface}.
         */
        @Override
        public imports.aws.DxHostedPublicVirtualInterface build() {
            return new imports.aws.DxHostedPublicVirtualInterface(
                this.scope,
                this.id,
                this.config.build()
            );
