...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsVpcEndpointConfig")
...
public interface DataAwsVpcEndpointConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     * filter block.
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.DataAwsVpcEndpointFilter> getFilter() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DataAwsVpcEndpointConfig> {
        private java.util.List<imports.aws.DataAwsVpcEndpointFilter> filter;
        ...
        public Builder filter(java.util.List<? extends imports.aws.DataAwsVpcEndpointFilter> filter) {
            this.filter = (java.util.List<imports.aws.DataAwsVpcEndpointFilter>)filter;
            return this;
        }
        ...
        public DataAwsVpcEndpointConfig build() {
            return new Jsii$Proxy(filter, serviceName, state, tags, vpcId, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DataAwsVpcEndpointConfig {
        private final java.util.List<imports.aws.DataAwsVpcEndpointFilter> filter;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.filter = software.amazon.jsii.Kernel.get(this, "filter", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.DataAwsVpcEndpointFilter.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.aws.DataAwsVpcEndpointFilter> filter, final java.lang.String serviceName, final java.lang.String state, final java.util.Map<java.lang.String, java.lang.String> tags, final java.lang.String vpcId, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
        ...
        @Override
        public final java.util.List<imports.aws.DataAwsVpcEndpointFilter> getFilter() {
            return this.filter;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.DataAwsVpcEndpointConfig"));
