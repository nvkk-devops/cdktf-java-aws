...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsAlb")
public class DataAwsAlb extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    public DataAwsAlb(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.DataAwsAlbConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.DataAwsAlbAccessLogs accessLogs(final @org.jetbrains.annotations.NotNull java.lang.String index) {
        return software.amazon.jsii.Kernel.call(this, "accessLogs", software.amazon.jsii.NativeType.forClass(imports.aws.DataAwsAlbAccessLogs.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.DataAwsAlbSubnetMapping subnetMapping(final @org.jetbrains.annotations.NotNull java.lang.String index) {
        return software.amazon.jsii.Kernel.call(this, "subnetMapping", software.amazon.jsii.NativeType.forClass(imports.aws.DataAwsAlbSubnetMapping.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.DataAwsAlb}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DataAwsAlb> {
        /**
        ...
        private imports.aws.DataAwsAlbConfig.Builder config;
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DataAwsAlb}.
         */
        @Override
        public imports.aws.DataAwsAlb build() {
            return new imports.aws.DataAwsAlb(
                this.scope,
                this.id,
        ...
        private imports.aws.DataAwsAlbConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.DataAwsAlbConfig.Builder();
            }
            return this.config;
        }
    }
