...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.PinpointAdmChannel")
public class PinpointAdmChannel extends com.hashicorp.cdktf.TerraformResource {
    ...
    public PinpointAdmChannel(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.PinpointAdmChannelConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getClientIdInput() {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getClientSecretInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.PinpointAdmChannel}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.PinpointAdmChannel> {
        /**
        ...
        private final imports.aws.PinpointAdmChannelConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.PinpointAdmChannelConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param clientId This parameter is required.
         */
        ...
        /**
         * @return {@code this}
         * @param clientSecret This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.PinpointAdmChannel}.
         */
        @Override
        public imports.aws.PinpointAdmChannel build() {
            return new imports.aws.PinpointAdmChannel(
                this.scope,
                this.id,
                this.config.build()
            );
