...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.PinpointApnsSandboxChannel")
public class PinpointApnsSandboxChannel extends com.hashicorp.cdktf.TerraformResource {
    ...
    public PinpointApnsSandboxChannel(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.PinpointApnsSandboxChannelConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.PinpointApnsSandboxChannel}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.PinpointApnsSandboxChannel> {
        /**
        ...
        private final imports.aws.PinpointApnsSandboxChannelConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.PinpointApnsSandboxChannelConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.PinpointApnsSandboxChannel}.
         */
        @Override
        public imports.aws.PinpointApnsSandboxChannel build() {
            return new imports.aws.PinpointApnsSandboxChannel(
                this.scope,
                this.id,
                this.config.build()
            );
