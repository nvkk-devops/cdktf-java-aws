...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.StoragegatewayWorkingStorage")
public class StoragegatewayWorkingStorage extends com.hashicorp.cdktf.TerraformResource {
    ...
    public StoragegatewayWorkingStorage(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.StoragegatewayWorkingStorageConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getDiskIdInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.StoragegatewayWorkingStorage}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.StoragegatewayWorkingStorage> {
        /**
        ...
        private final imports.aws.StoragegatewayWorkingStorageConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.StoragegatewayWorkingStorageConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.StoragegatewayWorkingStorage}.
         */
        @Override
        public imports.aws.StoragegatewayWorkingStorage build() {
            return new imports.aws.StoragegatewayWorkingStorage(
                this.scope,
                this.id,
                this.config.build()
            );
