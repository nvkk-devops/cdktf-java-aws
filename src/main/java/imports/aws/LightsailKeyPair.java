...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.LightsailKeyPair")
public class LightsailKeyPair extends com.hashicorp.cdktf.TerraformResource {
    ...
    public LightsailKeyPair(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.LightsailKeyPairConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.LightsailKeyPair}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.LightsailKeyPair> {
        /**
        ...
        private imports.aws.LightsailKeyPairConfig.Builder config;
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.LightsailKeyPair}.
         */
        @Override
        public imports.aws.LightsailKeyPair build() {
            return new imports.aws.LightsailKeyPair(
                this.scope,
                this.id,
        ...
        private imports.aws.LightsailKeyPairConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.LightsailKeyPairConfig.Builder();
            }
            return this.config;
        }
    }
