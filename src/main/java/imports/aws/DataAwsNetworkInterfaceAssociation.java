...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsNetworkInterfaceAssociation")
public class DataAwsNetworkInterfaceAssociation extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataAwsNetworkInterfaceAssociation(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsNetworkInterfaceAssociation(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DataAwsNetworkInterfaceAssociation(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
