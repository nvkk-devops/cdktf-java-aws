...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.LoadBalancerListenerPolicy")
public class LoadBalancerListenerPolicy extends com.hashicorp.cdktf.TerraformResource {
    ...
    public LoadBalancerListenerPolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.LoadBalancerListenerPolicyConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.Number getLoadBalancerPortInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.LoadBalancerListenerPolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.LoadBalancerListenerPolicy> {
        /**
        ...
        private final imports.aws.LoadBalancerListenerPolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.LoadBalancerListenerPolicyConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param loadBalancerPort This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.LoadBalancerListenerPolicy}.
         */
        @Override
        public imports.aws.LoadBalancerListenerPolicy build() {
            return new imports.aws.LoadBalancerListenerPolicy(
                this.scope,
                this.id,
                this.config.build()
            );
