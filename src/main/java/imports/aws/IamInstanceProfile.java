...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.IamInstanceProfile")
public class IamInstanceProfile extends com.hashicorp.cdktf.TerraformResource {
    ...
    public IamInstanceProfile(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.IamInstanceProfileConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.IamInstanceProfile}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.IamInstanceProfile> {
        /**
        ...
        private imports.aws.IamInstanceProfileConfig.Builder config;
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.IamInstanceProfile}.
         */
        @Override
        public imports.aws.IamInstanceProfile build() {
            return new imports.aws.IamInstanceProfile(
                this.scope,
                this.id,
        ...
        private imports.aws.IamInstanceProfileConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.IamInstanceProfileConfig.Builder();
            }
            return this.config;
        }
    }
