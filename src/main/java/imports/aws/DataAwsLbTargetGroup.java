...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsLbTargetGroup")
public class DataAwsLbTargetGroup extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    public DataAwsLbTargetGroup(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.DataAwsLbTargetGroupConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.DataAwsLbTargetGroupHealthCheck healthCheck(final @org.jetbrains.annotations.NotNull java.lang.String index) {
        return software.amazon.jsii.Kernel.call(this, "healthCheck", software.amazon.jsii.NativeType.forClass(imports.aws.DataAwsLbTargetGroupHealthCheck.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.DataAwsLbTargetGroupStickiness stickiness(final @org.jetbrains.annotations.NotNull java.lang.String index) {
        return software.amazon.jsii.Kernel.call(this, "stickiness", software.amazon.jsii.NativeType.forClass(imports.aws.DataAwsLbTargetGroupStickiness.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.DataAwsLbTargetGroup}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DataAwsLbTargetGroup> {
        /**
        ...
        private imports.aws.DataAwsLbTargetGroupConfig.Builder config;
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DataAwsLbTargetGroup}.
         */
        @Override
        public imports.aws.DataAwsLbTargetGroup build() {
            return new imports.aws.DataAwsLbTargetGroup(
                this.scope,
                this.id,
        ...
        private imports.aws.DataAwsLbTargetGroupConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.DataAwsLbTargetGroupConfig.Builder();
            }
            return this.config;
        }
    }
