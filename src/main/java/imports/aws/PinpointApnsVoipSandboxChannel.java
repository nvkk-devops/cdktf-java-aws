...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.783Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.PinpointApnsVoipSandboxChannel")
public class PinpointApnsVoipSandboxChannel extends com.hashicorp.cdktf.TerraformResource {
    ...
    public PinpointApnsVoipSandboxChannel(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.PinpointApnsVoipSandboxChannelConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.PinpointApnsVoipSandboxChannel}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.PinpointApnsVoipSandboxChannel> {
        /**
        ...
        private final imports.aws.PinpointApnsVoipSandboxChannelConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.PinpointApnsVoipSandboxChannelConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.PinpointApnsVoipSandboxChannel}.
         */
        @Override
        public imports.aws.PinpointApnsVoipSandboxChannel build() {
            return new imports.aws.PinpointApnsVoipSandboxChannel(
                this.scope,
                this.id,
                this.config.build()
            );
