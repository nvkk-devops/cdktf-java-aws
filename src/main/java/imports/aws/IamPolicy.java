...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.IamPolicy")
public class IamPolicy extends com.hashicorp.cdktf.TerraformResource {
    ...
    public IamPolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.IamPolicyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.IamPolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.IamPolicy> {
        /**
        ...
        private final imports.aws.IamPolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.IamPolicyConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.IamPolicy}.
         */
        @Override
        public imports.aws.IamPolicy build() {
            return new imports.aws.IamPolicy(
                this.scope,
                this.id,
                this.config.build()
            );
