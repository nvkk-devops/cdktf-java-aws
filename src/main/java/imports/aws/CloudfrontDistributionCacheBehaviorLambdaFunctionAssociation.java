...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation")
@software.amazon.jsii.Jsii.Proxy(CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation.Jsii$Proxy.class)
public interface CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation}
     */
    public static final class Builder implements software.amazon.jsii.Builder<CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation> {
        private java.lang.String eventType;
        private java.lang.String lambdaArn;
        private java.lang.Boolean includeBody;

        /**
         * Sets the value of {@link CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation#getEventType}
        ...
        /**
         * Sets the value of {@link CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation#getLambdaArn}
        ...
        /**
         * Sets the value of {@link CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation#getIncludeBody}
         ...
         * @return a new instance of {@link CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation build() {
            return new Jsii$Proxy(eventType, lambdaArn, includeBody);
        }
    }

    /**
     * An implementation for {@link CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation"));
        ...
        public final boolean equals(final Object o) {
            ...
            CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation.Jsii$Proxy that = (CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation.Jsii$Proxy) o;
