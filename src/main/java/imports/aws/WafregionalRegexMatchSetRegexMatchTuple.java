...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.WafregionalRegexMatchSetRegexMatchTuple")
...
public interface WafregionalRegexMatchSetRegexMatchTuple extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull java.util.List<imports.aws.WafregionalRegexMatchSetRegexMatchTupleFieldToMatch> getFieldToMatch();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<WafregionalRegexMatchSetRegexMatchTuple> {
        private java.util.List<imports.aws.WafregionalRegexMatchSetRegexMatchTupleFieldToMatch> fieldToMatch;
        ...
        public Builder fieldToMatch(java.util.List<? extends imports.aws.WafregionalRegexMatchSetRegexMatchTupleFieldToMatch> fieldToMatch) {
            this.fieldToMatch = (java.util.List<imports.aws.WafregionalRegexMatchSetRegexMatchTupleFieldToMatch>)fieldToMatch;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements WafregionalRegexMatchSetRegexMatchTuple {
        private final java.util.List<imports.aws.WafregionalRegexMatchSetRegexMatchTupleFieldToMatch> fieldToMatch;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.fieldToMatch = software.amazon.jsii.Kernel.get(this, "fieldToMatch", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.WafregionalRegexMatchSetRegexMatchTupleFieldToMatch.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.aws.WafregionalRegexMatchSetRegexMatchTupleFieldToMatch> fieldToMatch, final java.lang.String regexPatternSetId, final java.lang.String textTransformation) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.fieldToMatch = (java.util.List<imports.aws.WafregionalRegexMatchSetRegexMatchTupleFieldToMatch>)java.util.Objects.requireNonNull(fieldToMatch, "fieldToMatch is required");
        ...
        @Override
        public final java.util.List<imports.aws.WafregionalRegexMatchSetRegexMatchTupleFieldToMatch> getFieldToMatch() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.WafregionalRegexMatchSetRegexMatchTuple"));
