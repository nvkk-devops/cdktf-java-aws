...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.IamGroupPolicy")
public class IamGroupPolicy extends com.hashicorp.cdktf.TerraformResource {
    ...
    public IamGroupPolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.IamGroupPolicyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.IamGroupPolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.IamGroupPolicy> {
        /**
        ...
        private final imports.aws.IamGroupPolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.IamGroupPolicyConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.IamGroupPolicy}.
         */
        @Override
        public imports.aws.IamGroupPolicy build() {
            return new imports.aws.IamGroupPolicy(
                this.scope,
                this.id,
                this.config.build()
            );
