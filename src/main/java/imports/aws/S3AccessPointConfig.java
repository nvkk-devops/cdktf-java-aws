...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.S3AccessPointConfig")
...
public interface S3AccessPointConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.S3AccessPointPublicAccessBlockConfiguration> getPublicAccessBlockConfiguration() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.S3AccessPointVpcConfiguration> getVpcConfiguration() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<S3AccessPointConfig> {
        ...
        private java.util.List<imports.aws.S3AccessPointPublicAccessBlockConfiguration> publicAccessBlockConfiguration;
        private java.util.List<imports.aws.S3AccessPointVpcConfiguration> vpcConfiguration;
        ...
        public Builder publicAccessBlockConfiguration(java.util.List<? extends imports.aws.S3AccessPointPublicAccessBlockConfiguration> publicAccessBlockConfiguration) {
            this.publicAccessBlockConfiguration = (java.util.List<imports.aws.S3AccessPointPublicAccessBlockConfiguration>)publicAccessBlockConfiguration;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder vpcConfiguration(java.util.List<? extends imports.aws.S3AccessPointVpcConfiguration> vpcConfiguration) {
            this.vpcConfiguration = (java.util.List<imports.aws.S3AccessPointVpcConfiguration>)vpcConfiguration;
            return this;
        }
        ...
        public S3AccessPointConfig build() {
            return new Jsii$Proxy(bucket, name, accountId, policy, publicAccessBlockConfiguration, vpcConfiguration, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements S3AccessPointConfig {
        ...
        private final java.util.List<imports.aws.S3AccessPointPublicAccessBlockConfiguration> publicAccessBlockConfiguration;
        private final java.util.List<imports.aws.S3AccessPointVpcConfiguration> vpcConfiguration;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.publicAccessBlockConfiguration = software.amazon.jsii.Kernel.get(this, "publicAccessBlockConfiguration", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.S3AccessPointPublicAccessBlockConfiguration.class)));
            this.vpcConfiguration = software.amazon.jsii.Kernel.get(this, "vpcConfiguration", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.S3AccessPointVpcConfiguration.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String bucket, final java.lang.String name, final java.lang.String accountId, final java.lang.String policy, final java.util.List<? extends imports.aws.S3AccessPointPublicAccessBlockConfiguration> publicAccessBlockConfiguration, final java.util.List<? extends imports.aws.S3AccessPointVpcConfiguration> vpcConfiguration, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
        ...
        @Override
        public final java.util.List<imports.aws.S3AccessPointPublicAccessBlockConfiguration> getPublicAccessBlockConfiguration() {
            return this.publicAccessBlockConfiguration;
        }

        @Override
        public final java.util.List<imports.aws.S3AccessPointVpcConfiguration> getVpcConfiguration() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.S3AccessPointConfig"));
