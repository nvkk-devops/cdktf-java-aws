...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.ApiGatewayUsagePlanKeyConfig")
...
public interface ApiGatewayUsagePlanKeyConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ApiGatewayUsagePlanKeyConfig> {
        ...
        private java.lang.String usagePlanId;
         ...
         * @param keyType the value to be set. This parameter is required.
         * @return {@code this}
         */
         ...
         * @param usagePlanId the value to be set. This parameter is required.
         * @return {@code this}
         */
        ...
        public ApiGatewayUsagePlanKeyConfig build() {
            return new Jsii$Proxy(keyId, keyType, usagePlanId, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ApiGatewayUsagePlanKeyConfig {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String keyId, final java.lang.String keyType, final java.lang.String usagePlanId, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
            ...
            this.usagePlanId = java.util.Objects.requireNonNull(usagePlanId, "usagePlanId is required");
            this.count = count;
            this.dependsOn = (java.util.List<com.hashicorp.cdktf.ITerraformDependable>)dependsOn;
            this.lifecycle = lifecycle;
            this.provider = provider;
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.ApiGatewayUsagePlanKeyConfig"));
