...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.LbListener")
public class LbListener extends com.hashicorp.cdktf.TerraformResource {
    ...
    public LbListener(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.LbListenerConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.LbListenerDefaultAction> getDefaultActionInput() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "defaultActionInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.LbListenerDefaultAction.class))));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.LbListenerTimeouts getTimeoutsInput() {
        return software.amazon.jsii.Kernel.get(this, "timeoutsInput", software.amazon.jsii.NativeType.forClass(imports.aws.LbListenerTimeouts.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.LbListenerDefaultAction> getDefaultAction() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "defaultAction", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.LbListenerDefaultAction.class))));
    }

    public void setDefaultAction(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.LbListenerDefaultAction> value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.LbListenerTimeouts getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.LbListenerTimeouts.class));
    }

    public void setTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.LbListenerTimeouts value) {
        software.amazon.jsii.Kernel.set(this, "timeouts", java.util.Objects.requireNonNull(value, "timeouts is required"));
    }

    /**
     * A fluent builder for {@link imports.aws.LbListener}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.LbListener> {
        /**
        ...
        private final imports.aws.LbListenerConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.LbListenerConfig.Builder();
        }
         ...
         */
        public Builder defaultAction(final java.util.List<? extends imports.aws.LbListenerDefaultAction> defaultAction) {
         ...
         */
        public Builder timeouts(final imports.aws.LbListenerTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.LbListener}.
         */
        @Override
        public imports.aws.LbListener build() {
            return new imports.aws.LbListener(
                this.scope,
                this.id,
                this.config.build()
            );
