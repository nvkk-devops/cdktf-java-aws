...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsVpcEndpointDnsEntry")
public class DataAwsVpcEndpointDnsEntry extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataAwsVpcEndpointDnsEntry(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsVpcEndpointDnsEntry(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DataAwsVpcEndpointDnsEntry(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
