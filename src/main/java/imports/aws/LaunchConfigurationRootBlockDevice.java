...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.LaunchConfigurationRootBlockDevice")
...
public interface LaunchConfigurationRootBlockDevice extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<LaunchConfigurationRootBlockDevice> {
        ...
        public LaunchConfigurationRootBlockDevice build() {
            return new Jsii$Proxy(deleteOnTermination, encrypted, iops, volumeSize, volumeType);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements LaunchConfigurationRootBlockDevice {
         ...
         */
        protected Jsii$Proxy(final java.lang.Boolean deleteOnTermination, final java.lang.Boolean encrypted, final java.lang.Number iops, final java.lang.Number volumeSize, final java.lang.String volumeType) {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.LaunchConfigurationRootBlockDevice"));
