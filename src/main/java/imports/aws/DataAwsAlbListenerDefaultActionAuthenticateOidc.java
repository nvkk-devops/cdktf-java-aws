...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.221Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsAlbListenerDefaultActionAuthenticateOidc")
public class DataAwsAlbListenerDefaultActionAuthenticateOidc extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataAwsAlbListenerDefaultActionAuthenticateOidc(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsAlbListenerDefaultActionAuthenticateOidc(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DataAwsAlbListenerDefaultActionAuthenticateOidc(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
