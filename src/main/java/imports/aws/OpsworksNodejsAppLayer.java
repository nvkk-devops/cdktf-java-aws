...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.755Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.OpsworksNodejsAppLayer")
public class OpsworksNodejsAppLayer extends com.hashicorp.cdktf.TerraformResource {
    ...
    public OpsworksNodejsAppLayer(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.OpsworksNodejsAppLayerConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.OpsworksNodejsAppLayerEbsVolume> getEbsVolumeInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.OpsworksNodejsAppLayerEbsVolume>)(software.amazon.jsii.Kernel.get(this, "ebsVolumeInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.OpsworksNodejsAppLayerEbsVolume.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.OpsworksNodejsAppLayerEbsVolume> getEbsVolume() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "ebsVolume", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.OpsworksNodejsAppLayerEbsVolume.class))));
    }

    public void setEbsVolume(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.OpsworksNodejsAppLayerEbsVolume> value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.OpsworksNodejsAppLayer}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.OpsworksNodejsAppLayer> {
        /**
        ...
        private final imports.aws.OpsworksNodejsAppLayerConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.OpsworksNodejsAppLayerConfig.Builder();
        }
         ...
         */
        public Builder ebsVolume(final java.util.List<? extends imports.aws.OpsworksNodejsAppLayerEbsVolume> ebsVolume) {
        ...
        /**
         * @return {@code this}
         * @param nodejsVersion This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.OpsworksNodejsAppLayer}.
         */
        @Override
        public imports.aws.OpsworksNodejsAppLayer build() {
            return new imports.aws.OpsworksNodejsAppLayer(
                this.scope,
                this.id,
                this.config.build()
            );
