...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.GlobalacceleratorListenerConfig")
...
public interface GlobalacceleratorListenerConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     * port_range block.
     */
    @org.jetbrains.annotations.NotNull java.util.List<imports.aws.GlobalacceleratorListenerPortRange> getPortRange();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<GlobalacceleratorListenerConfig> {
        ...
        private java.util.List<imports.aws.GlobalacceleratorListenerPortRange> portRange;
         ...
         * @param acceleratorArn the value to be set. This parameter is required.
         * @return {@code this}
         */
        ...
        public Builder portRange(java.util.List<? extends imports.aws.GlobalacceleratorListenerPortRange> portRange) {
            this.portRange = (java.util.List<imports.aws.GlobalacceleratorListenerPortRange>)portRange;
            return this;
        }
        ...
        public GlobalacceleratorListenerConfig build() {
            return new Jsii$Proxy(acceleratorArn, portRange, protocol, clientAffinity, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements GlobalacceleratorListenerConfig {
        ...
        private final java.util.List<imports.aws.GlobalacceleratorListenerPortRange> portRange;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.portRange = software.amazon.jsii.Kernel.get(this, "portRange", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.GlobalacceleratorListenerPortRange.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String acceleratorArn, final java.util.List<? extends imports.aws.GlobalacceleratorListenerPortRange> portRange, final java.lang.String protocol, final java.lang.String clientAffinity, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.acceleratorArn = java.util.Objects.requireNonNull(acceleratorArn, "acceleratorArn is required");
            this.portRange = (java.util.List<imports.aws.GlobalacceleratorListenerPortRange>)java.util.Objects.requireNonNull(portRange, "portRange is required");
        ...
        @Override
        public final java.util.List<imports.aws.GlobalacceleratorListenerPortRange> getPortRange() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.GlobalacceleratorListenerConfig"));
