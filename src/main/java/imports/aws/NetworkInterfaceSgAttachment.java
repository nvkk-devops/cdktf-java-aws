...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.NetworkInterfaceSgAttachment")
public class NetworkInterfaceSgAttachment extends com.hashicorp.cdktf.TerraformResource {
    ...
    public NetworkInterfaceSgAttachment(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.NetworkInterfaceSgAttachmentConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.NetworkInterfaceSgAttachment}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.NetworkInterfaceSgAttachment> {
        /**
        ...
        private final imports.aws.NetworkInterfaceSgAttachmentConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.NetworkInterfaceSgAttachmentConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.NetworkInterfaceSgAttachment}.
         */
        @Override
        public imports.aws.NetworkInterfaceSgAttachment build() {
            return new imports.aws.NetworkInterfaceSgAttachment(
                this.scope,
                this.id,
                this.config.build()
            );
