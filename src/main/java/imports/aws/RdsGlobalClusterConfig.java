...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.RdsGlobalClusterConfig")
...
public interface RdsGlobalClusterConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<RdsGlobalClusterConfig> {
         ...
         * @param globalClusterIdentifier the value to be set. This parameter is required.
         * @return {@code this}
         */
        ...
        public RdsGlobalClusterConfig build() {
            return new Jsii$Proxy(globalClusterIdentifier, databaseName, deletionProtection, engine, engineVersion, storageEncrypted, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements RdsGlobalClusterConfig {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String globalClusterIdentifier, final java.lang.String databaseName, final java.lang.Boolean deletionProtection, final java.lang.String engine, final java.lang.String engineVersion, final java.lang.Boolean storageEncrypted, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.globalClusterIdentifier = java.util.Objects.requireNonNull(globalClusterIdentifier, "globalClusterIdentifier is required");
            this.databaseName = databaseName;
            this.deletionProtection = deletionProtection;
            this.engine = engine;
            this.engineVersion = engineVersion;
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.RdsGlobalClusterConfig"));
