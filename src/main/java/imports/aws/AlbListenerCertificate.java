...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.AlbListenerCertificate")
public class AlbListenerCertificate extends com.hashicorp.cdktf.TerraformResource {
    ...
    public AlbListenerCertificate(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.AlbListenerCertificateConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.AlbListenerCertificate}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.AlbListenerCertificate> {
        /**
        ...
        private final imports.aws.AlbListenerCertificateConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.AlbListenerCertificateConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.AlbListenerCertificate}.
         */
        @Override
        public imports.aws.AlbListenerCertificate build() {
            return new imports.aws.AlbListenerCertificate(
                this.scope,
                this.id,
                this.config.build()
            );
