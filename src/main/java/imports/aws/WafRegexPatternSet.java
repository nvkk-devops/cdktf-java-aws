...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.WafRegexPatternSet")
public class WafRegexPatternSet extends com.hashicorp.cdktf.TerraformResource {
    ...
    public WafRegexPatternSet(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.WafRegexPatternSetConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.WafRegexPatternSet}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.WafRegexPatternSet> {
        /**
        ...
        private final imports.aws.WafRegexPatternSetConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.WafRegexPatternSetConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.WafRegexPatternSet}.
         */
        @Override
        public imports.aws.WafRegexPatternSet build() {
            return new imports.aws.WafRegexPatternSet(
                this.scope,
                this.id,
                this.config.build()
            );
