...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsRedshiftCluster")
public class DataAwsRedshiftCluster extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    public DataAwsRedshiftCluster(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.DataAwsRedshiftClusterConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DataAwsRedshiftCluster}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DataAwsRedshiftCluster> {
        /**
        ...
        private final imports.aws.DataAwsRedshiftClusterConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.DataAwsRedshiftClusterConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DataAwsRedshiftCluster}.
         */
        @Override
        public imports.aws.DataAwsRedshiftCluster build() {
            return new imports.aws.DataAwsRedshiftCluster(
                this.scope,
                this.id,
                this.config.build()
            );
