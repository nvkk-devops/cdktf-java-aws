...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.CustomerGateway")
public class CustomerGateway extends com.hashicorp.cdktf.TerraformResource {
    ...
    public CustomerGateway(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.CustomerGatewayConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getBgpAsnInput() {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getIpAddressInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.CustomerGateway}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.CustomerGateway> {
        /**
        ...
        private final imports.aws.CustomerGatewayConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.CustomerGatewayConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.CustomerGateway}.
         */
        @Override
        public imports.aws.CustomerGateway build() {
            return new imports.aws.CustomerGateway(
                this.scope,
                this.id,
                this.config.build()
            );
