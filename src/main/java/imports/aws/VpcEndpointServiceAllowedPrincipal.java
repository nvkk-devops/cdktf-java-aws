...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.VpcEndpointServiceAllowedPrincipal")
public class VpcEndpointServiceAllowedPrincipal extends com.hashicorp.cdktf.TerraformResource {
    ...
    public VpcEndpointServiceAllowedPrincipal(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.VpcEndpointServiceAllowedPrincipalConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getPrincipalArnInput() {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getVpcEndpointServiceIdInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.VpcEndpointServiceAllowedPrincipal}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.VpcEndpointServiceAllowedPrincipal> {
        /**
        ...
        private final imports.aws.VpcEndpointServiceAllowedPrincipalConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.VpcEndpointServiceAllowedPrincipalConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param principalArn This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.VpcEndpointServiceAllowedPrincipal}.
         */
        @Override
        public imports.aws.VpcEndpointServiceAllowedPrincipal build() {
            return new imports.aws.VpcEndpointServiceAllowedPrincipal(
                this.scope,
                this.id,
                this.config.build()
            );
