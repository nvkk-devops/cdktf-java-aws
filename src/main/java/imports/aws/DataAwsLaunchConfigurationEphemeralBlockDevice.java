...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsLaunchConfigurationEphemeralBlockDevice")
public class DataAwsLaunchConfigurationEphemeralBlockDevice extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataAwsLaunchConfigurationEphemeralBlockDevice(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsLaunchConfigurationEphemeralBlockDevice(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DataAwsLaunchConfigurationEphemeralBlockDevice(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
