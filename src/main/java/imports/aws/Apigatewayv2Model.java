...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.Apigatewayv2Model")
public class Apigatewayv2Model extends com.hashicorp.cdktf.TerraformResource {
    ...
    public Apigatewayv2Model(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.Apigatewayv2ModelConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getSchemaInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.Apigatewayv2Model}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.Apigatewayv2Model> {
        /**
        ...
        private final imports.aws.Apigatewayv2ModelConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.Apigatewayv2ModelConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.Apigatewayv2Model}.
         */
        @Override
        public imports.aws.Apigatewayv2Model build() {
            return new imports.aws.Apigatewayv2Model(
                this.scope,
                this.id,
                this.config.build()
            );
