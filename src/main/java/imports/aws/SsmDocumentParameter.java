...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.SsmDocumentParameter")
public class SsmDocumentParameter extends com.hashicorp.cdktf.ComplexComputedList {

    protected SsmDocumentParameter(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected SsmDocumentParameter(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public SsmDocumentParameter(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
