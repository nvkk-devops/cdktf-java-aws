...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsElasticsearchDomainLogPublishingOptions")
public class DataAwsElasticsearchDomainLogPublishingOptions extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataAwsElasticsearchDomainLogPublishingOptions(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsElasticsearchDomainLogPublishingOptions(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DataAwsElasticsearchDomainLogPublishingOptions(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
