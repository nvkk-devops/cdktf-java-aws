...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.KmsKeyConfig")
...
public interface KmsKeyConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<KmsKeyConfig> {
        private java.lang.String customerMasterKeySpec;
         ...
         * @param customerMasterKeySpec the value to be set.
         * @return {@code this}
         */
         ...
         * @param enableKeyRotation the value to be set.
         * @return {@code this}
         */
        ...
        public KmsKeyConfig build() {
            return new Jsii$Proxy(customerMasterKeySpec, deletionWindowInDays, description, enableKeyRotation, isEnabled, keyUsage, policy, tags, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements KmsKeyConfig {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String customerMasterKeySpec, final java.lang.Number deletionWindowInDays, final java.lang.String description, final java.lang.Boolean enableKeyRotation, final java.lang.Boolean isEnabled, final java.lang.String keyUsage, final java.lang.String policy, final java.util.Map<java.lang.String, java.lang.String> tags, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.KmsKeyConfig"));
        ...
        public final int hashCode() {
            int result = this.customerMasterKeySpec != null ? this.customerMasterKeySpec.hashCode() : 0;
