...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DocdbCluster")
public class DocdbCluster extends com.hashicorp.cdktf.TerraformResource {
    ...
    public DocdbCluster(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.DocdbClusterConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.DocdbClusterTimeouts getTimeoutsInput() {
        return software.amazon.jsii.Kernel.get(this, "timeoutsInput", software.amazon.jsii.NativeType.forClass(imports.aws.DocdbClusterTimeouts.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.DocdbClusterTimeouts getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.DocdbClusterTimeouts.class));
    }

    public void setTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.DocdbClusterTimeouts value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.DocdbCluster}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.DocdbCluster> {
        /**
        ...
        private imports.aws.DocdbClusterConfig.Builder config;
         ...
         */
        public Builder timeouts(final imports.aws.DocdbClusterTimeouts timeouts) {
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.DocdbCluster}.
         */
        @Override
        public imports.aws.DocdbCluster build() {
            return new imports.aws.DocdbCluster(
                this.scope,
                this.id,
        ...
        private imports.aws.DocdbClusterConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.DocdbClusterConfig.Builder();
            }
            return this.config;
        }
    }
