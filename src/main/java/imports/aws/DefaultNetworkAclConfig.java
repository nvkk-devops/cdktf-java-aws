...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DefaultNetworkAclConfig")
...
public interface DefaultNetworkAclConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     * egress block.
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.DefaultNetworkAclEgress> getEgress() {
        return null;
    }
     ...
     * ingress block.
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.aws.DefaultNetworkAclIngress> getIngress() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DefaultNetworkAclConfig> {
        private java.lang.String defaultNetworkAclId;
        private java.util.List<imports.aws.DefaultNetworkAclEgress> egress;
        private java.util.List<imports.aws.DefaultNetworkAclIngress> ingress;
         ...
         * @param defaultNetworkAclId the value to be set. This parameter is required.
         * @return {@code this}
         */
        ...
        public Builder egress(java.util.List<? extends imports.aws.DefaultNetworkAclEgress> egress) {
            this.egress = (java.util.List<imports.aws.DefaultNetworkAclEgress>)egress;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder ingress(java.util.List<? extends imports.aws.DefaultNetworkAclIngress> ingress) {
            this.ingress = (java.util.List<imports.aws.DefaultNetworkAclIngress>)ingress;
            return this;
        }
        ...
        public DefaultNetworkAclConfig build() {
            return new Jsii$Proxy(defaultNetworkAclId, egress, ingress, subnetIds, tags, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DefaultNetworkAclConfig {
        ...
        private final java.util.List<imports.aws.DefaultNetworkAclEgress> egress;
        private final java.util.List<imports.aws.DefaultNetworkAclIngress> ingress;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.egress = software.amazon.jsii.Kernel.get(this, "egress", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.DefaultNetworkAclEgress.class)));
            this.ingress = software.amazon.jsii.Kernel.get(this, "ingress", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.DefaultNetworkAclIngress.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String defaultNetworkAclId, final java.util.List<? extends imports.aws.DefaultNetworkAclEgress> egress, final java.util.List<? extends imports.aws.DefaultNetworkAclIngress> ingress, final java.util.List<java.lang.String> subnetIds, final java.util.Map<java.lang.String, java.lang.String> tags, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.defaultNetworkAclId = java.util.Objects.requireNonNull(defaultNetworkAclId, "defaultNetworkAclId is required");
            this.egress = (java.util.List<imports.aws.DefaultNetworkAclEgress>)egress;
            this.ingress = (java.util.List<imports.aws.DefaultNetworkAclIngress>)ingress;
            this.subnetIds = subnetIds;
            this.tags = tags;
        ...
        @Override
        public final java.util.List<imports.aws.DefaultNetworkAclEgress> getEgress() {
            return this.egress;
        }

        @Override
        public final java.util.List<imports.aws.DefaultNetworkAclIngress> getIngress() {
            return this.ingress;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("aws.DefaultNetworkAclConfig"));
