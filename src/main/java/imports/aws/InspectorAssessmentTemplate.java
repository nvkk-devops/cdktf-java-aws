...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.InspectorAssessmentTemplate")
public class InspectorAssessmentTemplate extends com.hashicorp.cdktf.TerraformResource {
    ...
    public InspectorAssessmentTemplate(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.InspectorAssessmentTemplateConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<java.lang.String> getRulesPackageArnsInput() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "rulesPackageArnsInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(java.lang.String.class))));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.InspectorAssessmentTemplate}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.InspectorAssessmentTemplate> {
        /**
        ...
        private final imports.aws.InspectorAssessmentTemplateConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.InspectorAssessmentTemplateConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param rulesPackageArns This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.InspectorAssessmentTemplate}.
         */
        @Override
        public imports.aws.InspectorAssessmentTemplate build() {
            return new imports.aws.InspectorAssessmentTemplate(
                this.scope,
                this.id,
                this.config.build()
            );
