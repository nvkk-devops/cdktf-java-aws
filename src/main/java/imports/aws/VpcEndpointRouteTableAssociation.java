...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.VpcEndpointRouteTableAssociation")
public class VpcEndpointRouteTableAssociation extends com.hashicorp.cdktf.TerraformResource {
    ...
    public VpcEndpointRouteTableAssociation(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.VpcEndpointRouteTableAssociationConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.VpcEndpointRouteTableAssociation}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.VpcEndpointRouteTableAssociation> {
        /**
        ...
        private final imports.aws.VpcEndpointRouteTableAssociationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.VpcEndpointRouteTableAssociationConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.VpcEndpointRouteTableAssociation}.
         */
        @Override
        public imports.aws.VpcEndpointRouteTableAssociation build() {
            return new imports.aws.VpcEndpointRouteTableAssociation(
                this.scope,
                this.id,
                this.config.build()
            );
