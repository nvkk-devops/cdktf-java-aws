...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.760Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.OpsworksRailsAppLayer")
public class OpsworksRailsAppLayer extends com.hashicorp.cdktf.TerraformResource {
    ...
    public OpsworksRailsAppLayer(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.OpsworksRailsAppLayerConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<imports.aws.OpsworksRailsAppLayerEbsVolume> getEbsVolumeInput() {
        return java.util.Optional.ofNullable((java.util.List<imports.aws.OpsworksRailsAppLayerEbsVolume>)(software.amazon.jsii.Kernel.get(this, "ebsVolumeInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.OpsworksRailsAppLayerEbsVolume.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.Nullable java.lang.Boolean getManageBundlerInput() {
        return software.amazon.jsii.Kernel.get(this, "manageBundlerInput", software.amazon.jsii.NativeType.forClass(java.lang.Boolean.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.aws.OpsworksRailsAppLayerEbsVolume> getEbsVolume() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "ebsVolume", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.aws.OpsworksRailsAppLayerEbsVolume.class))));
    }

    public void setEbsVolume(final @org.jetbrains.annotations.NotNull java.util.List<imports.aws.OpsworksRailsAppLayerEbsVolume> value) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.Boolean getManageBundler() {
        return software.amazon.jsii.Kernel.get(this, "manageBundler", software.amazon.jsii.NativeType.forClass(java.lang.Boolean.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.OpsworksRailsAppLayer}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.OpsworksRailsAppLayer> {
        /**
        ...
        private final imports.aws.OpsworksRailsAppLayerConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.OpsworksRailsAppLayerConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param appServer This parameter is required.
         */
        ...
        /**
         * @return {@code this}
         * @param bundlerVersion This parameter is required.
         */
         ...
         */
        public Builder ebsVolume(final java.util.List<? extends imports.aws.OpsworksRailsAppLayerEbsVolume> ebsVolume) {
        ...
        /**
         * @return {@code this}
         * @param manageBundler This parameter is required.
         */
        ...
        /**
         * @return {@code this}
         * @param passengerVersion This parameter is required.
         */
        ...
        /**
         * @return {@code this}
         * @param rubygemsVersion This parameter is required.
         */
        ...
        /**
         * @return {@code this}
         * @param rubyVersion This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.OpsworksRailsAppLayer}.
         */
        @Override
        public imports.aws.OpsworksRailsAppLayer build() {
            return new imports.aws.OpsworksRailsAppLayer(
                this.scope,
                this.id,
                this.config.build()
            );
