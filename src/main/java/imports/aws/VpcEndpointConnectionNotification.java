...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.VpcEndpointConnectionNotification")
public class VpcEndpointConnectionNotification extends com.hashicorp.cdktf.TerraformResource {
    ...
    public VpcEndpointConnectionNotification(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.VpcEndpointConnectionNotificationConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<java.lang.String> getConnectionEventsInput() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "connectionEventsInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(java.lang.String.class))));
    }

    public @org.jetbrains.annotations.NotNull java.lang.String getConnectionNotificationArnInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.VpcEndpointConnectionNotification}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.VpcEndpointConnectionNotification> {
        /**
        ...
        private final imports.aws.VpcEndpointConnectionNotificationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.VpcEndpointConnectionNotificationConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param connectionEvents This parameter is required.
         */
        ...
        /**
         * @return {@code this}
         * @param connectionNotificationArn This parameter is required.
         */
        ...
        /**
         * @return {@code this}
         * @param vpcEndpointServiceId This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.VpcEndpointConnectionNotification}.
         */
        @Override
        public imports.aws.VpcEndpointConnectionNotification build() {
            return new imports.aws.VpcEndpointConnectionNotification(
                this.scope,
                this.id,
                this.config.build()
            );
