...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsDynamodbTableLocalSecondaryIndex")
public class DataAwsDynamodbTableLocalSecondaryIndex extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataAwsDynamodbTableLocalSecondaryIndex(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsDynamodbTableLocalSecondaryIndex(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DataAwsDynamodbTableLocalSecondaryIndex(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
