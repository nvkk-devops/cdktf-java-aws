...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.StoragegatewayCache")
public class StoragegatewayCache extends com.hashicorp.cdktf.TerraformResource {
    ...
    public StoragegatewayCache(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.StoragegatewayCacheConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.StoragegatewayCache}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.StoragegatewayCache> {
        /**
        ...
        private final imports.aws.StoragegatewayCacheConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.StoragegatewayCacheConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.StoragegatewayCache}.
         */
        @Override
        public imports.aws.StoragegatewayCache build() {
            return new imports.aws.StoragegatewayCache(
                this.scope,
                this.id,
                this.config.build()
            );
