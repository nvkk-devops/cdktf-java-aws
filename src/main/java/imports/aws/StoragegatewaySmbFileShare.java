...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.StoragegatewaySmbFileShare")
public class StoragegatewaySmbFileShare extends com.hashicorp.cdktf.TerraformResource {
    ...
    public StoragegatewaySmbFileShare(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.StoragegatewaySmbFileShareConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.StoragegatewaySmbFileShareTimeouts getTimeoutsInput() {
        return software.amazon.jsii.Kernel.get(this, "timeoutsInput", software.amazon.jsii.NativeType.forClass(imports.aws.StoragegatewaySmbFileShareTimeouts.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.StoragegatewaySmbFileShareTimeouts getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.StoragegatewaySmbFileShareTimeouts.class));
    }

    public void setTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.StoragegatewaySmbFileShareTimeouts value) {
    ...
    /**
     * A fluent builder for {@link imports.aws.StoragegatewaySmbFileShare}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.StoragegatewaySmbFileShare> {
        /**
        ...
        private final imports.aws.StoragegatewaySmbFileShareConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.StoragegatewaySmbFileShareConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param invalidUserList This parameter is required.
         */
         ...
         */
        public Builder timeouts(final imports.aws.StoragegatewaySmbFileShareTimeouts timeouts) {
        ...
        /**
         * @return {@code this}
         * @param validUserList This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.StoragegatewaySmbFileShare}.
         */
        @Override
        public imports.aws.StoragegatewaySmbFileShare build() {
            return new imports.aws.StoragegatewaySmbFileShare(
                this.scope,
                this.id,
                this.config.build()
            );
