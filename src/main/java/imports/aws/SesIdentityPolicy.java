...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.SesIdentityPolicy")
public class SesIdentityPolicy extends com.hashicorp.cdktf.TerraformResource {
    ...
    public SesIdentityPolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.SesIdentityPolicyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.SesIdentityPolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.SesIdentityPolicy> {
        /**
        ...
        private final imports.aws.SesIdentityPolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.SesIdentityPolicyConfig.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.SesIdentityPolicy}.
         */
        @Override
        public imports.aws.SesIdentityPolicy build() {
            return new imports.aws.SesIdentityPolicy(
                this.scope,
                this.id,
                this.config.build()
            );
