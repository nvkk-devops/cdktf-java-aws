...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.DataAwsAlbTargetGroupStickiness")
public class DataAwsAlbTargetGroupStickiness extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataAwsAlbTargetGroupStickiness(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsAlbTargetGroupStickiness(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public DataAwsAlbTargetGroupStickiness(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String index) {
