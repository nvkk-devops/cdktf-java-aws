...
@javax.annotation.Generated(value = "jsii-pacmak/1.24.0 (build b722f66)", date = "2021-03-10T09:47:02.127Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "aws.CloudfrontPublicKey")
public class CloudfrontPublicKey extends com.hashicorp.cdktf.TerraformResource {
    ...
    public CloudfrontPublicKey(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.CloudfrontPublicKeyConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getEncodedKeyInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.CloudfrontPublicKey}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.CloudfrontPublicKey> {
        /**
        ...
        private final imports.aws.CloudfrontPublicKeyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.CloudfrontPublicKeyConfig.Builder();
        }
        ...
        /**
         * @return {@code this}
         * @param encodedKey This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.CloudfrontPublicKey}.
         */
        @Override
        public imports.aws.CloudfrontPublicKey build() {
            return new imports.aws.CloudfrontPublicKey(
                this.scope,
                this.id,
                this.config.build()
            );
